...
export const unit07: CourseUnit = {
    ...
    lines: [
      {
        speaker: "Vous",
        native: "きょうはあめですね。",
        romanization: "kyou wa ame desu ne.",
      ...
      },
      {
        speaker: "Vous",
        native: "はし、おねがいします。",
        romanization: "hashi, onegai shimasu.",
  ...
  vocabulary: [
    ...
    { term: "せんせい", reading: "せんせい", romanization: "sensei", pitch: 3, french: "Le professeur", english: "Teacher" },
    { term: "とうきょう", reading: "とうきょう", romanization: "toukyou", pitch: 0, french: "Tokyo", english: "Tokyo" },
    { term: "あめ", reading: "あめ", romanization: "ame", pitch: 1, french: "La pluie", english: "Rain" },
    { term: "はし", reading: "はし", romanization: "hashi", pitch: 1, french: "Les baguettes (pour manger)", english: "Chopsticks" },
    ...
    { term: "たまご", reading: "たまご", romanization: "tamago", pitch: 2, french: "L'œuf", english: "Egg" },
    { term: "みかん", reading: "みかん", romanization: "mikan", pitch: 1, french: "La mandarine", english: "Tangerine" },
    { term: "きって", reading: "きって", romanization: "kitte", pitch: 0, french: "Le timbre", english: "Postage stamp" },
    { term: "しんぶん", reading: "しんぶん", romanization: "shinbun", pitch: 0, french: "Le journal", english: "Newspaper" },
    { term: "こうえん", reading: "こうえん", romanization: "kouen", pitch: 0, french: "Le parc", english: "Park" },
    { term: "でんわ", reading: "でんわ", romanization: "denwa", pitch: 0, french: "Le téléphone", english: "Telephone" },
  ],
