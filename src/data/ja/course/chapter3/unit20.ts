...
export const unit20: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "きのう、六時に起きました。",
          romanization: "kinou, rokuji ni okimashita.",
        ...
        {
          type: "example",
          native: "あさごはんは食べませんでした。",
          romanization: "asagohan wa tabemasen deshita.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "このかばんは高かったです。",
          romanization: "kono kaban wa takakatta desu.",
        ...
        {
          type: "example",
          native: "あまりおいしくなかったです。",
          romanization: "amari oishikunakatta desu.",
        ...
        {
          type: "example",
          native: "きのうは雨でした。げんきじゃなかったです。",
          romanization: "kinou wa ame deshita. genki ja nakatta desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "まず、うちであさごはんを食べました。それから、駅に行きました。",
          romanization: "mazu, uchi de asagohan o tabemashita. sorekara, eki ni ikimashita.",
        ...
        {
          type: "example",
          native: "そのあと、友だちに会いました。さいごに、うちに帰りました。",
          romanization: "sono ato, tomodachi ni aimashita. saigo ni, uchi ni kaerimashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "きのうは雨でした。うちで本を読みました。あまりおもしろくなかったです。",
          romanization: "kinou wa ame deshita. uchi de hon o yomimashita. amari omoshirokunakatta desu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "田中",
        native: "山田さん、きのうは何をしましたか。",
        romanization: "Yamada-san, kinou wa nani o shimashita ka.",
      ...
      {
        speaker: "山田",
        native: "まず、友だちに会いました。それから、いっしょにレストランで食べました。",
        romanization: "mazu, tomodachi ni aimashita. sorekara, issho ni resutoran de tabemashita.",
      ...
      {
        speaker: "山田",
        native: "とてもおいしかったです。でも、少し高かったです。",
        romanization: "totemo oishikatta desu. demo, sukoshi takakatta desu.",
      ...
      },
      {
        speaker: "田中",
        native: "そのあとは？",
        romanization: "sono ato wa?",
        french: "Et après ?",
        note: "Phrase suspendue avec は : on relance sans reposer une question complète. Extrêmement courant à l'oral.",
      },
      {
        speaker: "山田",
        native: "そのあと、電車でうちに帰りました。楽しい一日でした。",
        romanization: "sono ato, densha de uchi ni kaerimashita. tanoshii ichinichi deshita.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["たかかったです", "たかいでした", "たかくでした", "たかいだったです"],
    ...
    },
    {
      ...
      optionsReading: ["あいました", "あいます", "あいませんでした", "あったです"],
      hint: "ます devient ました.",
    },
    {
      id: "unit-20-ex3",
    ...
    },
    {
      ...
      optionsReading: ["よかったです", "いいかったです", "いいでした", "よくなかったです"],
