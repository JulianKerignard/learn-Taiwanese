...
export const unit15: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "七時十五分です。",
          romanization: "shichiji juugofun desu.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "火曜日に来ます。",
          romanization: "kayoubi ni kimasu.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "三月三日です。",
          romanization: "sangatsu mikka desu.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "電車は九時十分に来ます。",
          romanization: "densha wa kuji juppun ni kimasu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "あなた",
        native: "すみません、今、何時ですか。",
        romanization: "sumimasen, ima, nanji desu ka.",
      ...
      },
      {
        speaker: "駅員",
        native: "四時十五分です。",
        romanization: "yoji juugofun desu.",
      ...
      },
      {
        speaker: "あなた",
        native: "電車は何時ですか。",
        romanization: "densha wa nanji desu ka.",
        french: "Le train est à quelle heure ?",
      },
      {
        speaker: "駅員",
        native: "四時二十三分です。",
        romanization: "yoji nijuusanpun desu.",
      ...
      },
      {
        speaker: "あなた",
        native: "日曜日も同じですか。",
        romanization: "nichiyoubi mo onaji desu ka.",
        french: "C'est pareil le dimanche ?",
        note: "も remplace は et signifie « aussi ». 同じ (おなじ) = le même.",
      },
      {
        speaker: "駅員",
        native: "いいえ、日曜日は午前十時からです。",
        romanization: "iie, nichiyoubi wa gozen juuji kara desu.",
      ...
      {
        speaker: "あなた",
        native: "わかりました。ありがとうございます。",
        romanization: "wakarimashita. arigatou gozaimasu.",
