...
export const unit18: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "地下鉄の駅はどこですか。",
          romanization: "chikatetsu no eki wa doko desu ka.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "バスで駅へ行きます。",
          romanization: "basu de eki e ikimasu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "すみません、改札はどこですか。",
          romanization: "sumimasen, kaisatsu wa doko desu ka.",
        ...
        },
        {
          type: "example",
          native: "浅草へ行きたいです。",
          romanization: "Asakusa e ikitai desu.",
        ...
        },
        {
          type: "example",
          native: "何番線ですか。",
          romanization: "nanbansen desu ka.",
        ...
        },
        {
          type: "example",
          native: "新宿で乗り換えです。",
          romanization: "Shinjuku de norikae desu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "Vous",
        native: "すみません、浅草へ行きたいです。",
        romanization: "sumimasen, Asakusa e ikitai desu.",
      ...
      },
      {
        speaker: "Employé",
        native: "銀座線ですね。地下鉄です。",
        romanization: "Ginza-sen desu ne. chikatetsu desu.",
      ...
      {
        speaker: "Employé",
        native: "二番線です。乗り換えはありません。",
        romanization: "nibansen desu. norikae wa arimasen.",
      ...
      },
      {
        speaker: "Vous",
        native: "浅草は三つ目の駅ですか。",
        romanization: "Asakusa wa mittsu me no eki desu ka.",
      ...
      {
        speaker: "Employé",
        native: "はい、そうです。ICカードもいいですよ。",
        romanization: "hai, sou desu. IC kaado mo ii desu yo.",
  ...
  vocabulary: [
    ...
    { term: "バス", reading: "バス", romanization: "basu", pitch: 1, french: "Le bus", english: "Bus" },
    {
      term: "タクシー",
      reading: "タクシー",
