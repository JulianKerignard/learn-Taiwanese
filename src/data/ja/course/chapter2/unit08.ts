...
export const unit08: CourseUnit = {
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "Vous",
        native: "おつかれさまです。また明日。",
        romanization: "otsukaresama desu. mata ashita.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["すみません", "おつかれさまです", "ありがとうございます", "こんばんは"],
    ...
    },
    {
      ...
      optionsReading: ["おつかれさまです", "さようなら", "おやすみなさい", "はじめまして"],
    ...
    },
    {
      ...
      optionsReading: ["またあした", "さようなら", "おやすみなさい", "おはようございます"],
