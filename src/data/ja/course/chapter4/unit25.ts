...
export const unit25: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "今年、京都へ行きたいです。",
          romanization: "kotoshi, Kyouto e ikitai desu.",
        ...
        {
          type: "example",
          native: "今日は何も食べたくないです。",
          romanization: "kyou wa nani mo tabetakunai desu.",
        ...
        },
        {
          type: "example",
          native: "つめたい水が飲みたいです。",
          romanization: "tsumetai mizu ga nomitai desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "新しいパソコンが欲しいです。",
          romanization: "atarashii pasokon ga hoshii desu.",
        ...
        },
        {
          type: "example",
          native: "田中さんに来てほしいです。",
          romanization: "Tanaka-san ni kite hoshii desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "今晩は早く寝ようと思います。",
          romanization: "konban wa hayaku neyou to omoimasu.",
        ...
        {
          type: "example",
          native: "来年、日本で働くつもりです。",
          romanization: "rainen, Nihon de hataraku tsumori desu.",
        ...
        {
          type: "example",
          native: "来週、大阪へ出張する予定です。",
          romanization: "raishuu, Oosaka e shucchou suru yotei desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "週末、いっしょに温泉に行きませんか。",
          romanization: "shuumatsu, issho ni onsen ni ikimasen ka.",
        ...
        },
        {
          type: "example",
          native: "コーヒーでもいかがですか。",
          romanization: "koohii demo ikaga desu ka.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "田中",
        native: "ソフィーさん、今週末、何かご予定がありますか。",
        romanization: "Sophie-san, konshuumatsu, nanika go-yotei ga arimasu ka.",
      ...
      {
        speaker: "ソフィー",
        native: "土曜日は何もありません。ゆっくり休みたいです。",
        romanization: "doyoubi wa nani mo arimasen. yukkuri yasumitai desu.",
      ...
      {
        speaker: "田中",
        native: "じゃあ、箱根の温泉に行きませんか。",
        romanization: "jaa, Hakone no onsen ni ikimasen ka.",
      ...
      {
        speaker: "ソフィー",
        native: "いいですね。ぜひ行きたいです。",
        romanization: "ii desu ne. zehi ikitai desu.",
      ...
      {
        speaker: "田中",
        native: "朝早く出発しようと思います。八時はどうですか。",
        romanization: "asa hayaku shuppatsu shiyou to omoimasu. hachiji wa dou desu ka.",
      ...
      {
        speaker: "ソフィー",
        native: "大丈夫です。旅館の予約は私がするつもりです。",
        romanization: "daijoubu desu. ryokan no yoyaku wa watashi ga suru tsumori desu.",
      ...
      {
        speaker: "田中",
        native: "助かります。じゃあ、来週の予定はこれで決まりですね。楽しみです。",
        romanization: "tasukarimasu. jaa, raishuu no yotei wa kore de kimari desu ne. tanoshimi desu.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romanization: "doyoubi wa yotei ga arimasen.",
    ...
    },
    {
      term: "つもり",
      reading: "つもり",
      romanization: "tsumori",
      french: "L'intention (de faire quelque chose)",
      english: "Intention",
      example: {
        sentence: "夏休みは京都に行くつもりです。",
        romanization: "natsuyasumi wa Kyouto ni iku tsumori desu.",
    ...
    },
    {
      ...
      example: {
        sentence: "温泉に入りたいです。",
        romanization: "onsen ni hairitai desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "resutoran o yoyaku shimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "onsen ryokan ni tomaritai desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "atarashii kaban ga hoshii desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "ashita wa ame ga furu to omoimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "tomodachi o ryokou ni sasoimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kin'youbi wa go-tsugou ga ii desu ka.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["はたらく", "はたらきます", "はたらきたい", "はたらいて"],
