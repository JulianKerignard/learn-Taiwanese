...
export const unit23: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "六畳の1K、家賃七万円。",
          romanization: "rokujou no wan kee, yachin nanaman en.",
        ...
        {
          type: "example",
          native: "2LDKのマンション、駅から徒歩八分。",
          romanization: "ni eru dii kee no manshon, eki kara toho happun.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "うちから駅まで、徒歩五分です。",
          romanization: "uchi kara eki made, toho gofun desu.",
        ...
        },
        {
          type: "example",
          native: "駅から近い部屋がいいです。",
          romanization: "eki kara chikai heya ga ii desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "音楽を聞きながら、部屋をそうじします。",
          romanization: "ongaku o kikinagara, heya o souji shimasu.",
        ...
        {
          type: "example",
          native: "働きながら日本語を習います。",
          romanization: "hatarakinagara nihongo o naraimasu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "店員",
        native: "いらっしゃいませ。どんな部屋がいいですか。",
        romanization: "irasshaimase. donna heya ga ii desu ka.",
      ...
      {
        speaker: "リサ",
        native: "駅から近い部屋がいいです。家賃は八万円までです。",
        romanization: "eki kara chikai heya ga ii desu. yachin wa hachiman en made desu.",
      ...
      {
        speaker: "店員",
        native: "こちらはいかがですか。六畳の1Kで、駅から徒歩五分です。",
        romanization: "kochira wa ikaga desu ka. rokujou no wan kee de, eki kara toho gofun desu.",
      ...
      {
        speaker: "リサ",
        native: "あまり狭くないですね。家賃はいくらですか。",
        romanization: "amari semakunai desu ne. yachin wa ikura desu ka.",
      ...
      {
        speaker: "店員",
        native: "七万五千円です。敷金は一か月、礼金も一か月です。",
        romanization: "nanaman gosen en desu. shikikin wa ikkagetsu, reikin mo ikkagetsu desu.",
      ...
      },
      {
        speaker: "リサ",
        native: "礼金はあとで返りますか。",
        romanization: "reikin wa ato de kaerimasu ka.",
      ...
      {
        speaker: "店員",
        native: "いいえ、礼金は返りません。敷金だけ、あとで返ります。",
        romanization: "iie, reikin wa kaerimasen. shikikin dake, ato de kaerimasu.",
      ...
      {
        speaker: "リサ",
        native: "保証人がいません。大丈夫ですか。",
        romanization: "hoshounin ga imasen. daijoubu desu ka.",
      ...
      {
        speaker: "店員",
        native: "保証会社を使いますから、大丈夫です。では、契約の説明をしましょう。",
        romanization: "hoshou gaisha o tsukaimasu kara, daijoubu desu. dewa, keiyaku no setsumei o shimashou.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "この部屋は明るいです。",
        romanization: "kono heya wa akarui desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "eki no chikaku no apaato ni sumimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "atarashii manshon wa yachin ga takai desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "yachin wa maitsuki nijuugonichi ni haraimasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "敷金は二か月分です。",
        romanization: "shikikin wa nikagetsubun desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kono apaato wa reikin ga arimasen.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "ekimae no fudousanya ni ikimasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "大家さんに電話します。",
        romanization: "ooyasan ni denwa shimasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "保証人が必要ですか。",
        romanization: "hoshounin ga hitsuyou desu ka.",
    ...
    },
    {
      ...
      example: {
        sentence: "あした契約をします。",
        romanization: "ashita keiyaku o shimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kaisha made toho juugofun desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "rokujou no heya wa yaku juu heibei desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "raigetsu, Toukyou ni hikkoshimasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "京都に住みたいです。",
        romanization: "Kyouto ni sumitai desu.",
    ...
    },
    {
      ...
      example: {
        sentence: "静かな部屋を探します。",
        romanization: "shizuka na heya o sagashimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kono heya wa amari hirokunai desu.",
    ...
    },
    {
      ...
      example: {
        sentence: "台所が狭いです。",
        romanization: "daidokoro ga semai desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "gomi wa asa hachiji made ni dashimasu.",
