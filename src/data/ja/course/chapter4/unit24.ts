...
export const unit24: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "書きます → 書く / 飲みます → 飲む / 待ちます → 待つ",
          romanization: "kakimasu → kaku / nomimasu → nomu / machimasu → matsu",
          translation: "écrire / boire / attendre",
          content:
            "La more finale glisse d'une ligne dans le tableau des reading: き→く, み→む, ち→つ. Le tableau des kana appris au chapitre 1 n'était donc pas un simple support de lecture : c'est l'outil de conjugaison du japonais. Un verbe du groupe 1 se conjugue en se déplaçant dans une colonne.",
        },
        {
          type: "warning",
          content:
        ...
        {
          type: "example",
          native: "見ます → 見る / 切ります → 切る",
          romanization: "mimasu → miru / kirimasu → kiru",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "私はピアノを弾くことができます。",
          romanization: "watashi wa piano o hiku koto ga dekimasu.",
        ...
        {
          type: "example",
          native: "ここで写真を撮ることができます。",
          romanization: "koko de shashin o toru koto ga dekimasu.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "日本語が話せます。",
          romanization: "nihongo ga hanasemasu.",
        ...
        },
        {
          type: "example",
          native: "六時までに帰れますか。",
          romanization: "rokuji made ni kaeremasu ka.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "日本に来る前に、日本語を勉強しました。",
          romanization: "nihon ni kuru mae ni, nihongo o benkyou shimashita.",
        ...
        {
          type: "example",
          native: "富士山に登ったことがあります。",
          romanization: "fujisan ni nobotta koto ga arimasu.",
    ...
    lines: [
      {
        speaker: "木村",
        native: "山田さんの趣味は何ですか。",
        romanization: "Yamada-san no shumi wa nan desu ka.",
      ...
      {
        speaker: "山田",
        native: "ギターです。学生のときに習いました。",
        romanization: "gitaa desu. gakusei no toki ni naraimashita.",
      ...
      {
        speaker: "山田",
        native: "いいえ、まだ下手です。でも、簡単な曲は弾けます。",
        romanization: "iie, mada heta desu. demo, kantan na kyoku wa hikemasu.",
      ...
      {
        speaker: "木村",
        native: "すごいですね。私は楽器が全然できません。",
        romanization: "sugoi desu ne. watashi wa gakki ga zenzen dekimasen.",
      ...
      {
        speaker: "山田",
        native: "木村さんはスポーツをしますか。",
        romanization: "Kimura-san wa supootsu o shimasu ka.",
      ...
      {
        speaker: "木村",
        native: "はい。泳ぐことができます。毎週プールに行きます。",
        romanization: "hai. oyogu koto ga dekimasu. maishuu puuru ni ikimasu.",
      ...
      {
        speaker: "山田",
        native: "私は泳げません。海に入ったことがありません。",
        romanization: "watashi wa oyogemasen. umi ni haitta koto ga arimasen.",
      ...
      {
        speaker: "木村",
        native: "今度、教えますよ。でも、泳ぐ前に、必ず準備運動をしましょう。",
        romanization: "kondo, oshiemasu yo. demo, oyogu mae ni, kanarazu junbi undou o shimashou.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romanization: "jisho de atarashii kotoba o shirabemasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "その経験はありません。",
        romanization: "sono keiken wa arimasen.",
    ...
    },
    {
      ...
      example: {
        sentence: "毎日三十分練習します。",
        romanization: "mainichi sanjuppun renshuu shimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "sensei ni nihongo o naraimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "umi de oyogu koto ga dekimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "yama ni noboru mae ni, tenki o mimasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "ギターが弾けますか。",
        romanization: "gitaa ga hikemasu ka.",
    ...
    },
    {
      ...
      example: {
        sentence: "妹はピアノが上手です。",
        romanization: "imouto wa piano ga jouzu desu.",
    ...
    },
    {
      ...
      example: {
        sentence: "ギターを習いたいです。",
        romanization: "gitaa o naraitai desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "nihon de unten ga dekimasu ka.",
    ...
    },
    {
      ...
      example: {
        sentence: "父は料理ができます。",
        romanization: "chichi wa ryouri ga dekimasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "日本語が上手ですね。",
        romanization: "nihongo ga jouzu desu ne.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "koko de kaado ga tsukaemasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "koko kara fujisan ga miemasu.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["かけます", "かきれます", "かきられます", "かけられます"],
