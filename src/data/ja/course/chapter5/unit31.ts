...
export const unit31: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "バスより電車のほうが速いです。",
          romanization: "basu yori densha no hou ga hayai desu.",
        ...
        {
          type: "example",
          native: "コーヒーとお茶と、どちらが好きですか。",
          romanization: "koohii to ocha to, dochira ga suki desu ka.",
        ...
        {
          type: "example",
          native: "この店はあの店と同じくらい安いです。",
          romanization: "kono mise wa ano mise to onaji kurai yasui desu.",
        ...
        {
          type: "example",
          native: "今日は昨日ほど暑くないです。",
          romanization: "kyou wa kinou hodo atsukunai desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "日本料理の中で、すしがいちばん好きです。",
          romanization: "nihon ryouri no naka de, sushi ga ichiban suki desu.",
        ...
        {
          type: "example",
          native: "クラスの中で、だれがいちばん速く走りますか。",
          romanization: "kurasu no naka de, dare ga ichiban hayaku hashirimasu ka.",
        ...
        {
          type: "example",
          native: "この言葉は全然分かりません。あまり使いませんから。",
          romanization: "kono kotoba wa zenzen wakarimasen. amari tsukaimasen kara.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "昨日、食べすぎました。",
          romanization: "kinou, tabesugimashita.",
        ...
        {
          type: "example",
          native: "このコートはちょっと高すぎます。",
          romanization: "kono kooto wa chotto takasugimasu.",
        ...
        {
          type: "example",
          native: "このアプリは使いやすいです。",
          romanization: "kono apuri wa tsukaiyasui desu.",
        ...
        },
        {
          type: "example",
          native: "この漢字は覚えにくいです。",
          romanization: "kono kanji wa oboenikui desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "明日、飲みに行きませんか。— 明日はちょっと…",
          romanization: "ashita, nomi ni ikimasen ka. — ashita wa chotto...",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "木村",
        native: "駅前のホテルと川の近くのホテルと、どちらがいいですか。",
        romanization: "ekimae no hoteru to kawa no chikaku no hoteru to, dochira ga ii desu ka.",
      ...
      {
        speaker: "佐藤",
        native: "駅前のほうが便利です。でも、ちょっと高すぎますね。",
        romanization: "ekimae no hou ga benri desu. demo, chotto takasugimasu ne.",
      ...
      {
        speaker: "木村",
        native: "川の近くのホテルは、値段が駅前ほど高くないです。そして、とても静かです。",
        romanization: "kawa no chikaku no hoteru wa, nedan ga ekimae hodo takakunai desu. soshite, totemo shizuka desu.",
      ...
      {
        speaker: "佐藤",
        native: "でも、駅から遠いですね。夜は帰りにくいです。",
        romanization: "demo, eki kara tooi desu ne. yoru wa kaerinikui desu.",
      ...
      {
        speaker: "木村",
        native: "バスがありますから、それほど不便じゃないですよ。",
        romanization: "basu ga arimasu kara, sorehodo fuben ja nai desu yo.",
      ...
      {
        speaker: "佐藤",
        native: "そうですか。じゃあ、静かなほうにしましょう。",
        romanization: "sou desu ka. jaa, shizuka na hou ni shimashou.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kono mise de kore ga ichiban yasui desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "watashi no kaban wa Tanaka-san no to onaji desu.",
    ...
    },
    {
      ...
      example: {
        sentence: "安いほうを選びました。",
        romanization: "yasui hou o erabimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "menyuu o mite, itsumo mayoimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kono kanji wa zenzen wakarimasen.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["おぼえにくいです", "おぼえやすいです", "おぼえすぎます", "おぼえました"],
    ...
    },
    {
      ...
      optionsReading: ["ちょっとたかすぎます。", "ちょっとたかいすぎます。", "ちょっとたかくすぎます。", "あまりたかすぎます。"],
