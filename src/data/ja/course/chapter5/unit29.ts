...
export const unit29: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "この本は多くの人に読まれています。",
          romanization: "kono hon wa ooku no hito ni yomarete imasu.",
        ...
        },
        {
          type: "example",
          native: "先生に褒められました。",
          romanization: "sensei ni homeraremashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "田中さんのパーティーに招待されました。",
          romanization: "Tanaka-san no paatii ni shoutai saremashita.",
        ...
        },
        {
          type: "example",
          native: "さっき部長に呼ばれました。",
          romanization: "sakki buchou ni yobaremashita.",
        ...
        {
          type: "example",
          native: "この学校は百年前に建てられました。",
          romanization: "kono gakkou wa hyakunen mae ni tateraremashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "帰る途中で雨に降られて、服が濡れました。",
          romanization: "kaeru tochuu de ame ni furarete, fuku ga nuremashita.",
        ...
        {
          type: "example",
          native: "ゆうべ子どもに泣かれて、よく寝られませんでした。",
          romanization: "yuube kodomo ni nakarete, yoku neraremasen deshita.",
        ...
        {
          type: "example",
          native: "隣の人に大きい声で話されて、ぜんぜん勉強できませんでした。",
          romanization: "tonari no hito ni ookii koe de hanasarete, zenzen benkyou dekimasen deshita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "電車で財布を盗まれました。犯人はまだ分かっていません。",
          romanization: "densha de saifu o nusumaremashita. hannin wa mada wakatte imasen.",
        ...
        {
          type: "example",
          native: "弟にケーキを食べられました。",
          romanization: "otouto ni keeki o taberaremashita.",
        ...
        {
          type: "example",
          native: "事故の原因はまだ発表されていません。",
          romanization: "jiko no gen'in wa mada happyou sarete imasen.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "田中",
        native: "マリーさん、大丈夫ですか。ずいぶん濡れていますね。",
        romanization: "Marii-san, daijoubu desu ka. zuibun nurete imasu ne.",
      ...
      {
        speaker: "マリー",
        native: "ええ…。駅から歩いているときに、雨に降られました。",
        romanization: "ee... eki kara aruite iru toki ni, ame ni furaremashita.",
      ...
      },
      {
        speaker: "田中",
        native: "それは大変でしたね。傘は？",
        romanization: "sore wa taihen deshita ne. kasa wa?",
        french: "Quelle poisse. Et votre parapluie ?",
      },
      {
        speaker: "マリー",
        native: "電車に忘れました。しかも、隣の人に足を踏まれて…。",
        romanization: "densha ni wasuremashita. shikamo, tonari no hito ni ashi o fumarete...",
      ...
      },
      {
        speaker: "田中",
        native: "今日はついていませんね。",
        romanization: "kyou wa tsuite imasen ne.",
        french: "Ce n'est vraiment pas votre jour.",
      },
      {
        speaker: "マリー",
        native: "ゆうべも子どもに泣かれて、ぜんぜん寝られませんでした。",
        romanization: "yuube mo kodomo ni nakarete, zenzen neraremasen deshita.",
      ...
      {
        speaker: "田中",
        native: "あ、マリーさん、さっき部長に呼ばれていましたよ。",
        romanization: "a, Marii-san, sakki buchou ni yobarete imashita yo.",
      ...
      {
        speaker: "マリー",
        native: "え、また叱られるんでしょうか。",
        romanization: "e, mata shikarareru n deshou ka.",
      ...
      {
        speaker: "田中",
        native: "いいえ、逆ですよ。先週の発表が部長にとても褒められていました。",
        romanization: "iie, gyaku desu yo. senshuu no happyou ga buchou ni totemo homerarete imashita.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romanization: "densha de saifu o nusumaremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "senshuu, dorobou ni hairaremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "hannin wa mada wakatte imasen.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kaeru tochuu de ame ni furaremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "fuku ga sukkari nuremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "mata sensei ni shikararemashita.",
    ...
    },
    {
      ...
      example: {
        sentence: "部長に褒められました。",
        romanization: "buchou ni homeraremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kekkonshiki ni shoutai saremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "shiken no kekka wa raishuu happyou saremasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "densha no naka de ashi o fumaremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "hatsuon o machigaete, minna ni warawaremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "yuube kodomo ni nakaremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "tonari no hito ni ookii koe de hanasaremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "gomeiwaku o okake shimashita.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["よまれる", "よめられる", "よまされる", "よめれる"],
    ...
    },
    {
      ...
      optionsReading: ["なかれて", "ないて", "なかせて", "なかれって"],
