...
export const unit33: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "部長はコーヒーを召し上がりました。",
          romanization: "buchou wa koohii o meshiagarimashita.",
        ...
        {
          type: "example",
          native: "私がコーヒーをいただきました。",
          romanization: "watashi ga koohii o itadakimashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "先生は教室にいらっしゃいます。",
          romanization: "sensei wa kyoushitsu ni irasshaimasu.",
        ...
        },
        {
          type: "example",
          native: "何になさいますか。",
          romanization: "nani ni nasaimasu ka.",
        ...
        {
          type: "example",
          native: "お名前は何とおっしゃいますか。",
          romanization: "onamae wa nan to osshaimasu ka.",
        ...
        {
          type: "example",
          native: "山田と申します。フランスから参りました。",
          romanization: "Yamada to moushimasu. Furansu kara mairimashita.",
        ...
        },
        {
          type: "example",
          native: "資料を拝見しました。",
          romanization: "shiryou o haiken shimashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "部長はもうお帰りになりました。",
          romanization: "buchou wa mou okaeri ni narimashita.",
        ...
        },
        {
          type: "example",
          native: "私がご説明いたします。",
          romanization: "watashi ga gosetsumei itashimasu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "社長の田中はただいま外出しております。",
          romanization: "shachou no Tanaka wa tadaima gaishutsu shite orimasu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "佐藤",
        native: "恐れ入ります。三時にお約束をいただいております、みどり商事の佐藤と申します。",
        romanization: "osore irimasu. sanji ni oyakusoku o itadaite orimasu, Midori-shouji no Satou to moushimasu.",
      ...
      {
        speaker: "受付",
        native: "佐藤様、いつもお世話になっております。少々お待ちくださいませ。",
        romanization: "Satou-sama, itsumo osewa ni natte orimasu. shoushou omachi kudasaimase.",
      ...
      {
        speaker: "受付",
        native: "山田部長、佐藤様がお見えになりました。",
        romanization: "Yamada-buchou, Satou-sama ga omie ni narimashita.",
      ...
      {
        speaker: "受付",
        native: "お待たせいたしました。山田はただいま参ります。",
        romanization: "omatase itashimashita. Yamada wa tadaima mairimasu.",
      ...
      {
        speaker: "山田",
        native: "お待たせして申し訳ございません。山田でございます。どうぞこちらへ。",
        romanization: "omatase shite moushiwake gozaimasen. Yamada de gozaimasu. douzo kochira e.",
      ...
      {
        speaker: "山田",
        native: "コーヒーを召し上がりますか。",
        romanization: "koohii o meshiagarimasu ka.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "douzo meshiagatte kudasai.",
    ...
    },
    {
      ...
      example: {
        sentence: "すぐに参ります。",
        romanization: "sugu ni mairimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "Midori-shouji no Yamada to moushimasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "私がご案内いたします。",
        romanization: "watashi ga goannai itashimasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "お茶をいただきました。",
        romanization: "ocha o itadakimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "hitotsu ukagatte mo yoroshii deshou ka.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["めしあがりました", "いただきました", "はいけんしました", "まいりました"],
    ...
    },
    {
      ...
      optionsReading: ["もうします", "おっしゃいます", "なさいます", "いらっしゃいます"],
    ...
    },
    {
      ...
      optionsReading: ["はいけんしました", "ごらんになりました", "おみせしました", "みられました"],
