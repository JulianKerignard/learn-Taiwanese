...
export const unit35: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "三日前から熱があります。",
          romanization: "mikka mae kara netsu ga arimasu.",
        ...
        },
        {
          type: "example",
          native: "今朝からめまいがします。",
          romanization: "kesa kara memai ga shimasu.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "雨が降りそうです。",
          romanization: "ame ga furisou desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "もう一度説明していただけませんか。",
          romanization: "mou ichido setsumei shite itadakemasen ka.",
        ...
        {
          type: "example",
          native: "この書類の書き方を教えていただけませんか。",
          romanization: "kono shorui no kakikata o oshiete itadakemasen ka.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "ここに印鑑をお願いします。",
          romanization: "koko ni inkan o onegai shimasu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "受付",
        native: "保険証はお持ちですか。初めての方はこちらの問診票にご記入ください。",
        romanization: "hokenshou wa o-mochi desu ka. hajimete no kata wa kochira no monshinhyou ni go-kinyuu kudasai.",
      ...
      {
        speaker: "マルタン",
        native: "はい。予約はしていないんですが、大丈夫でしょうか。",
        romanization: "hai. yoyaku wa shite inai n desu ga, daijoubu deshou ka.",
      ...
      {
        speaker: "マルタン",
        native: "三日前からのどが痛くて、熱もあります。今朝はめまいがしました。",
        romanization: "mikka mae kara nodo ga itakute, netsu mo arimasu. kesa wa memai ga shimashita.",
      ...
      {
        speaker: "医者",
        native: "風邪みたいですね。念のため、検査をしましょう。アレルギーはありますか。",
        romanization: "kaze mitai desu ne. nen no tame, kensa o shimashou. arerugii wa arimasu ka.",
      ...
      {
        speaker: "マルタン",
        native: "ありません。あの、薬の飲み方をもう一度説明していただけませんか。",
        romanization: "arimasen. ano, kusuri no nomikata o mou ichido setsumei shite itadakemasen ka.",
      ...
      {
        speaker: "医者",
        native: "一日三回、食後に飲んでください。処方箋を出しますので、隣の薬局へどうぞ。",
        romanization: "ichinichi sankai, shokugo ni nonde kudasai. shohousen o dashimasu node, tonari no yakkyoku e douzo.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "朝から熱があります。",
        romanization: "asa kara netsu ga arimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "itami ga dandan tsuyoku natte imasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kusuri o nonda ato, hakike ga shimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "shohousen wa chikaku no yakkyoku ni dashite kudasai.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kono kusuri wa shokugo sanjuppun inai ni nonde kudasai.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "uketsuke de hokenshou o dashite kudasai.",
    ...
    },
    {
      term: "国民健康保険",
      reading: "こくみんけんこうほけん",
      romanization: "kokumin kenkou hoken",
      segments: [
        { text: "国", reading: "こく" },
        { text: "民", reading: "みん" },
        { text: "健", reading: "けん" },
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "ginkou no tetsuzuki ni juuminhyou ga hitsuyou desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "zairyuu kaado wa itsumo motte ite kudasai.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "kono youshi ni juusho to namae o kinyuu shite kudasai.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["あたまがいたいです。", "あたまをいたいです。", "あたまがいたくあります。", "あたまにいたいです。"],
    ...
    },
    {
      ...
      optionsReading: ["しょくご", "しょっき", "しょくよく", "しょくどう"],
