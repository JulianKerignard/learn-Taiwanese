...
export const tonePairs: TonePair[] = [
  ...
  makePair(2, 3, [
    ...
    { chinese: "啤酒", pinyin: "píjiǔ", zhuyin: "ㄆㄧˊ ㄐㄧㄡˇ", french: "Biere", english: "Beer" },
  ]),
  makePair(2, 4, [
  ...
  makePair(3, 3, [
    ...
    { chinese: "幾點", pinyin: "jǐdiǎn", zhuyin: "ㄐㄧˇ ㄉㄧㄢˇ", french: "Quelle heure", english: "What time" },
  ],
  ...
  makePair(3, 4, [
    ...
    { chinese: "打算", pinyin: "dǎsuàn", zhuyin: "ㄉㄚˇ ㄙㄨㄢˋ", french: "Avoir l'intention de", english: "To plan" },
  ]),
  ...
  makePair(4, 2, [
    ...
    { chinese: "下來", pinyin: "xiàlái", zhuyin: "ㄒㄧㄚˋ ㄌㄞˊ", french: "Descendre", english: "Come down" },
  ]),
  makePair(4, 3, [
    { chinese: "自己", pinyin: "zìjǐ", zhuyin: "ㄗˋ ㄐㄧˇ", french: "Soi-meme", english: "Oneself" },
    { chinese: "報紙", pinyin: "bàozhǐ", zhuyin: "ㄅㄠˋ ㄓˇ", french: "Journal", english: "Newspaper" },
    { chinese: "汽水", pinyin: "qìshuǐ", zhuyin: "ㄑㄧˋ ㄕㄨㄟˇ", french: "Soda", english: "Soda" },
    { chinese: "電腦", pinyin: "diànnǎo", zhuyin: "ㄉㄧㄢˋ ㄋㄠˇ", french: "Ordinateur", english: "Computer" },
  ]),
  makePair(4, 4, [
