...
export const unit36: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "私はこの案がいいと思います。",
          romaji: "watashi wa kono an ga ii to omoimasu.",
        ...
        {
          type: "example",
          japanese: "田中さんは反対だと思っています。",
          romaji: "Tanaka-san wa hantai da to omotte imasu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "少し急ぎすぎているような気がします。",
          romaji: "sukoshi isogisugite iru you na ki ga shimasu.",
        ...
        {
          type: "example",
          japanese: "もう少し時間が必要なのではないでしょうか。",
          romaji: "mou sukoshi jikan ga hitsuyou na no de wa nai deshou ka.",
        ...
        },
        {
          ...
          romaji: "kirai na wake de wa arimasen.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "確かにコストは下がります。しかし、品質が心配です。",
          romaji: "tashika ni kosuto wa sagarimasu. shikashi, hinshitsu ga shinpai desu.",
        ...
        {
          type: "example",
          japanese: "コストは下がると思うんですけど…。",
          romaji: "kosuto wa sagaru to omou n desu kedo...",
        ...
        {
          type: "example",
          japanese: "引き受けたものの、時間が足りませんでした。",
          romaji: "hikiuketa mono no, jikan ga tarimasen deshita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "前向きに検討させていただきます。",
          romaji: "maemuki ni kentou sasete itadakimasu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "部長",
        japanese: "では、この件について、何かご意見はありますか。",
        romaji: "dewa, kono ken ni tsuite, nanika go-iken wa arimasu ka.",
      ...
      {
        speaker: "マルタン",
        japanese: "はい。納期を一週間早めたほうがいいのではないでしょうか。",
        romaji: "hai. nouki o isshuukan hayameta hou ga ii no de wa nai deshou ka.",
      ...
      {
        speaker: "田中",
        japanese: "確かにおっしゃる通りです。しかし、現場の負担を考えると、少し難しい気がします。",
        romaji: "tashika ni ossharu toori desu. shikashi, genba no futan o kangaeru to, sukoshi muzukashii ki ga shimasu.",
      ...
      {
        speaker: "部長",
        japanese: "そうですね……前向きに検討させていただきます。",
        romaji: "sou desu ne... maemuki ni kentou sasete itadakimasu.",
      ...
      {
        speaker: "田中",
        japanese: "マルタンさん、今のは、やんわり断られたんだと思いますよ。",
        romaji: "Marutan-san, ima no wa, yanwari kotowareta n da to omoimasu yo.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romaji: "go-iken o o-kikase kudasai.",
    ...
    },
    {
      ...
      example: {
        sentence: "一つ提案があります。",
        romaji: "hitotsu teian ga arimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "aite no tachiba mo kangaete mimashou.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "shanai de kentou shite kara, go-renraku shimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "setsumei o kiite nattoku shimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "hakkiri kotowaru no wa shitsurei da to kangaeru hito mo imasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "konkai wa enryo sasete itadakimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "tashika ni sono toori desu ga, mondai mo arimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "benri desu. ippou de, hiyou ga takaku narimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "dokoka de atta you na ki ga shimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "sono nittei wa chotto muzukashii desu ne.",
    ...
    },
    {
      ...
      example: {
        sentence: "前向きに考えてみます。",
        romaji: "maemuki ni kangaete mimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "henji ga aimai de, yoku wakarimasen deshita.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["のでは", "なのでは", "からでは", "ことでは"],
