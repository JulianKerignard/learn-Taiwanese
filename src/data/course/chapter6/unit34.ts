...
export const unit34: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "はい、みどり商事でございます。",
          romaji: "hai, Midori-shouji de gozaimasu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "田中はただいま席を外しております。",
          romaji: "Tanaka wa tadaima seki o hazushite orimasu.",
        ...
        {
          type: "example",
          japanese: "よろしければ、ご伝言を承ります。",
          romaji: "yoroshikereba, godengon o uketamawarimasu.",
        ...
        {
          type: "example",
          japanese: "申し訳ございません。電車が遅れておりまして、十五分ほど遅れます。",
          romaji: "moushiwake gozaimasen. densha ga okurete orimashite, juugofun hodo okuremasu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "件名：お打ち合わせ日程のご確認",
          romaji: "kenmei: ouchiawase nittei no gokakunin",
        ...
        {
          type: "example",
          japanese: "株式会社みどり商事　営業部　佐藤様",
          romaji: "kabushikigaisha Midori-shouji eigyoubu Satou-sama",
        ...
        {
          type: "example",
          japanese: "いつもお世話になっております。みどり商事の山田です。",
          romaji: "itsumo osewa ni natte orimasu. Midori-shouji no Yamada desu.",
        ...
        {
          type: "example",
          japanese: "恐れ入りますが、金曜日までにご確認いただけますでしょうか。",
          romaji: "osore irimasu ga, kinyoubi made ni gokakunin itadakemasu deshou ka.",
        ...
        },
        {
          ...
          romaji: "nanitozo yoroshiku onegai itashimasu.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "佐藤",
        japanese: "いつもお世話になっております。さくら電機の佐藤と申します。田中様はいらっしゃいますでしょうか。",
        romaji: "itsumo osewa ni natte orimasu. Sakura-denki no Satou to moushimasu. Tanaka-sama wa irasshaimasu deshou ka.",
      ...
      {
        speaker: "山田",
        japanese: "お世話になっております。恐れ入ります、田中はただいま席を外しております。",
        romaji: "osewa ni natte orimasu. osore irimasu, Tanaka wa tadaima seki o hazushite orimasu.",
      ...
      {
        speaker: "佐藤",
        japanese: "では、折り返しお電話をいただけますでしょうか。",
        romaji: "dewa, orikaeshi odenwa o itadakemasu deshou ka.",
      ...
      {
        speaker: "山田",
        japanese: "承知しました。田中が戻りましたら、折り返しご連絡いたします。",
        romaji: "shouchi shimashita. Tanaka ga modorimashitara, orikaeshi gorenraku itashimasu.",
      ...
      {
        speaker: "佐藤",
        japanese: "恐れ入りますが、明日の打ち合わせの資料の件とお伝えください。",
        romaji: "osore irimasu ga, ashita no uchiawase no shiryou no ken to otsutae kudasai.",
      ...
      {
        speaker: "山田",
        japanese: "かしこまりました。さくら電機の佐藤様ですね。田中に申し伝えます。",
        romaji: "kashikomarimashita. Sakura-denki no Satou-sama desu ne. Tanaka ni moushitsutaemasu.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romaji: "ashita no uchiawase wa juuji kara desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "shiryou o ookuri itashimasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "締め切りは金曜日です。",
        romaji: "shimekiri wa kinyoubi desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "gokakunin o onegai itashimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "ichido gosoudan sasete kudasai.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "densha no okure de chikoku itashimashita.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["しょうちしました。", "わかりました。", "りょうかいしました。", "しっています。"],
    ...
    },
    {
      ...
      optionsKana: ["ごかくにん", "おかくにん", "かくにんします", "ごかくにんになります"],
