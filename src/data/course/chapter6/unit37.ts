...
export const unit37: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "日本の人口は減少している。",
          romaji: "nihon no jinkou wa genshou shite iru.",
        ...
        },
        {
          ...
          romaji: "kore wa juuyou na mondai de aru.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "調査を行った。しかし、原因は分からなかった。",
          romaji: "chousa o okonatta. shikashi, gen'in wa wakaranakatta.",
        ...
        {
          type: "example",
          japanese: "料金が高い。また、手続きも複雑である。さらに、時間もかかる。",
          romaji: "ryoukin ga takai. mata, tetsuzuki mo fukuzatsu de aru. sara ni, jikan mo kakaru.",
          translation:
        ...
        {
          type: "example",
          japanese: "参加者が減少している。したがって、来年の開催は難しいだろう。",
          romaji: "sankasha ga genshou shite iru. shitagatte, rainen no kaisai wa muzukashii darou.",
          translation:
        ...
        {
          type: "example",
          japanese: "都市部の人口は増加している。一方、地方では減少が続いている。",
          romaji: "toshibu no jinkou wa zouka shite iru. ippou, chihou de wa genshou ga tsuzuite iru.",
          translation:
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "調査を開始する。／ 調査を始める。",
          romaji: "chousa o kaishi suru. / chousa o hajimeru.",
        ...
        {
          type: "example",
          japanese: "電車は九時に到着する。／ 電車は九時に着く。",
          romaji: "densha wa kuji ni touchaku suru. / densha wa kuji ni tsuku.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "先生",
        japanese: "レポート、読みました。内容はいいですが、文体が混ざっていますね。",
        romaji: "repooto, yomimashita. naiyou wa ii desu ga, buntai ga mazatte imasu ne.",
      ...
      },
      {
        speaker: "リュカ",
        japanese: "文体、ですか。",
        romaji: "buntai, desu ka.",
        french: "Le style ?",
      },
      {
        speaker: "先生",
        japanese: "ここは「です・ます」、次の段落は「である」になっています。どちらか一つに決めてください。",
        romaji: "koko wa 'desu-masu', tsugi no danraku wa 'de aru' ni natte imasu. dochira ka hitotsu ni kimete kudasai.",
      ...
      {
        speaker: "リュカ",
        japanese: "レポートなら、どちらがいいですか。",
        romaji: "repooto nara, dochira ga ii desu ka.",
      ...
      {
        speaker: "先生",
        japanese: "大学のレポートは「である体」が基本です。それに、「でも」は話し言葉ですよ。書くときは「しかし」です。",
        romaji: "daigaku no repooto wa 'de aru tai' ga kihon desu. sore ni, 'demo' wa hanashikotoba desu yo. kaku toki wa 'shikashi' desu.",
        french:
      ...
      {
        speaker: "リュカ",
        japanese: "なるほど。「だから」も直したほうがいいですか。",
        romaji: "naruhodo. 'dakara' mo naoshita hou ga ii desu ka.",
        french: "Je vois. Faut-il corriger だから aussi ?",
      },
      {
        speaker: "先生",
        japanese: "はい、「したがって」ですね。文法は正しいのに、話し言葉が混ざると評価が下がります。もったいないですよ。",
        romaji: "hai, 'shitagatte' desu ne. bunpou wa tadashii noni, hanashikotoba ga mazaru to hyouka ga sagarimasu. mottainai desu yo.",
        french:
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romaji: "kono bunshou wa wakariyasui.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "houkokusho wa kinyoubi made ni dashite kudasai.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kono zu wa deeta no henka o shimeshite iru.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kono keikou wa kongo mo tsuzuku darou.",
