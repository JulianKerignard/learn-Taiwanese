...
export const unit12: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "出口の となりに トイレが あります。",
          romaji: "deguchi no tonari ni toire ga arimasu.",
        ...
        {
          type: "example",
          japanese: "そとに ねこが います。",
          romaji: "soto ni neko ga imasu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "トイレは 中に あります。",
          romaji: "toire wa naka ni arimasu.",
        ...
        {
          type: "example",
          japanese: "この ちかくに コンビニは ありませんか。",
          romaji: "kono chikaku ni konbini wa arimasen ka.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "出口の 前に 人が います。",
          romaji: "deguchi no mae ni hito ga imasu.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "Employé",
        japanese: "あそこです。出口の となりに あります。",
        romaji: "asoko desu. deguchi no tonari ni arimasu.",
      ...
      {
        speaker: "Vous",
        japanese: "ありがとうございます。ここに コンビニも ありますか。",
        romaji: "arigatou gozaimasu. koko ni konbini mo arimasu ka.",
      ...
      {
        speaker: "Employé",
        japanese: "はい。あの 出口の 前に あります。",
        romaji: "hai. ano deguchi no mae ni arimasu.",
      ...
      {
        speaker: "Vous",
        japanese: "中に 人が たくさん いますね。",
        romaji: "naka ni hito ga takusan imasu ne.",
      ...
      {
        speaker: "Employé",
        japanese: "そうですね。じゃ、こちらへ どうぞ。",
        romaji: "sou desu ne. ja, kochira e douzo.",
  ...
  vocabulary: [
    { term: "あります", kana: "あります", romaji: "arimasu", french: "Il y a, se trouver (choses, plantes, lieux)", english: "There is (inanimate)" },
    { term: "います", kana: "います", romaji: "imasu", french: "Il y a, être là (personnes, animaux)", english: "There is (animate)" },
    { term: "上", kana: "うえ", romaji: "ue", segments: [{ text: "上", reading: "うえ" }], pitch: 0, french: "Le dessus, au-dessus", english: "Above, on top of" },
    { term: "下", kana: "した", romaji: "shita", segments: [{ text: "下", reading: "した" }], french: "Le dessous, sous", english: "Below, under" },
    { term: "中", kana: "なか", romaji: "naka", segments: [{ text: "中", reading: "なか" }], french: "L'intérieur, dans", english: "Inside, in" },
    { term: "外", kana: "そと", romaji: "soto", segments: [{ text: "外", reading: "そと" }], french: "L'extérieur, dehors", english: "Outside" },
    { term: "前", kana: "まえ", romaji: "mae", segments: [{ text: "前", reading: "まえ" }], french: "Le devant, devant", english: "Front, in front of" },
    { term: "後ろ", kana: "うしろ", romaji: "ushiro", segments: [{ text: "後", reading: "うし" }, { text: "ろ" }], french: "L'arrière, derrière", english: "Behind" },
    { term: "となり", kana: "となり", romaji: "tonari", french: "À côté (contigu, mitoyen)", english: "Next to, adjacent" },
    { term: "近く", kana: "ちかく", romaji: "chikaku", segments: [{ text: "近", reading: "ちか" }, { text: "く" }], french: "Les environs, près de", english: "Nearby, vicinity" },
    { term: "ここ", kana: "ここ", romaji: "koko", pitch: 0, french: "Ici (près de moi)", english: "Here" },
    { term: "そこ", kana: "そこ", romaji: "soko", french: "Là (près de vous)", english: "There, by you" },
    { term: "あそこ", kana: "あそこ", romaji: "asoko", french: "Là-bas (loin de nous deux)", english: "Over there" },
    { term: "どこ", kana: "どこ", romaji: "doko", pitch: 1, french: "Où", english: "Where" },
    { term: "ねこ", kana: "ねこ", romaji: "neko", pitch: 1, french: "Le chat", english: "Cat" },
    { term: "人", kana: "ひと", romaji: "hito", segments: [{ text: "人", reading: "ひと" }], french: "La personne, quelqu'un", english: "Person" },
    { term: "トイレ", kana: "トイレ", romaji: "toire", french: "Les toilettes", english: "Toilet, restroom" },
    { term: "出口", kana: "でぐち", romaji: "deguchi", segments: [{ text: "出", reading: "で" }, { text: "口", reading: "ぐち" }], french: "La sortie", english: "Exit" },
  ],
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["でぐちのとなり", "となりのでぐち", "でぐちにとなり", "となりでぐち"],
    ...
    },
    {
      ...
      optionsKana: ["でぐちはどこですか。", "でぐちをどこですか。", "どこはでぐちですか。", "でぐちにどこですか。"],
