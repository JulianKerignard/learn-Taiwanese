...
export const unit11: CourseUnit = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "どれが田中さんのかさですか。",
          romaji: "dore ga Tanaka-san no kasa desu ka.",
        ...
        },
        {
          type: "example",
          japanese: "どのかさが高いですか。",
          romaji: "dono kasa ga takai desu ka.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "Vendeuse",
        japanese: "それは日本のおかしです。",
        romaji: "sore wa Nihon no okashi desu.",
      ...
      },
      {
        speaker: "Vendeuse",
        japanese: "三千八百円です。",
        romaji: "sanzen happyaku en desu.",
        french: "3 800 yens.",
        note: "八百 devient はっぴゃく : révision directe de l'unité précédente.",
      },
      {
        speaker: "Vous",
        japanese: "じゃあ、あれをください。",
        romaji: "jaa, are o kudasai.",
  ...
  vocabulary: [
    { term: "これ", kana: "これ", romaji: "kore", french: "Ceci (dans ma sphère)", english: "This (near me)" },
    { term: "それ", kana: "それ", romaji: "sore", french: "Cela (dans votre sphère)", english: "That (near you)" },
    { term: "あれ", kana: "あれ", romaji: "are", french: "Cela là-bas (hors de nos deux sphères)", english: "That over there" },
    { term: "どれ", kana: "どれ", romaji: "dore", pitch: 1, french: "Lequel ? (parmi trois ou plus)", english: "Which one?" },
    { term: "この", kana: "この", romaji: "kono", french: "Ce...-ci (+ nom obligatoire)", english: "This (+ noun)" },
    { term: "その", kana: "その", romaji: "sono", french: "Ce...-là, près de vous (+ nom obligatoire)", english: "That (+ noun, near you)" },
    { term: "あの", kana: "あの", romaji: "ano", french: "Ce...-là-bas (+ nom obligatoire)", english: "That (+ noun, over there)" },
    { term: "どの", kana: "どの", romaji: "dono", french: "Quel... ? (+ nom obligatoire)", english: "Which (+ noun)" },
    { term: "何", kana: "なに", romaji: "nani", segments: [{ text: "何", reading: "なに" }], pitch: 1, french: "Quoi ? (se lit なん devant です)", english: "What?" },
    { term: "本", kana: "ほん", romaji: "hon", segments: [{ text: "本", reading: "ほん" }], pitch: 1, french: "Le livre", english: "Book" },
    { term: "かばん", kana: "かばん", romaji: "kaban", pitch: 0, french: "Le sac, le cartable", english: "Bag" },
    { term: "かさ", kana: "かさ", romaji: "kasa", pitch: 1, french: "Le parapluie (écrit 傘)", english: "Umbrella" },
    { term: "とけい", kana: "とけい", romaji: "tokei", pitch: 0, french: "La montre, l'horloge (écrit 時計)", english: "Watch, clock" },
    { term: "おみやげ", kana: "おみやげ", romaji: "omiyage", pitch: 0, french: "Le souvenir rapporté de voyage", english: "Souvenir gift" },
    { term: "店", kana: "みせ", romaji: "mise", segments: [{ text: "店", reading: "みせ" }], french: "Le magasin, la boutique", english: "Shop" },
    { term: "こちら", kana: "こちら", romaji: "kochira", french: "Par ici ; celui-ci (poli)", english: "This way; this one (polite)" },
  ],
