  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "text",
          content:
            "Taiwan a l'un des meilleurs systèmes de transport public d'Asie. Voici le guide complet :\n\n**捷運 MRT** (Metro) :\nDisponible à Taipei, Kaohsiung et Taoyuan (aéroport). Taipei est de loin le réseau le plus étendu avec 131 stations sur 6 lignes. Le MRT est climatisé à 26°C (parfait quand il fait 35°C dehors), propre (nettoyé plusieurs fois par jour), sûr (caméras partout), et ponctuel (trains toutes les 2-5 minutes en heure de pointe). Horaires : ~6h00 à minuit.\n\n**公車 Bus** :\nLe réseau de bus de Taipei est dense mais déroutant pour un étranger. Deux règles essentielles :\n1. Le paiement varie : certains bus, on paie en MONTANT (上車付費), d'autres en DESCENDANT (下車付費). Un panneau lumineux dans le bus indique quand payer. En cas de doute, demandez au chauffeur 上車刷嗎？(je bipe en montant ?)\n2. Pour demander l'arrêt : appuyez sur le bouton rouge 下車鈴 (sonnette de descente) AVANT votre arrêt. Les arrêts sont annoncés en mandarin, taiwanais, hakka et anglais.\n\n**計程車 Taxi** :\nLes taxis sont jaunes et partout. Le compteur démarre à 70 NT$ (pour les 1.25 premiers km), puis 5 NT$ par 200m. Supplément de nuit (23h-6h) : +20 NT$. Pas de pourboire. Les chauffeurs ne parlent généralement pas anglais — montrez l'adresse en caractères sur votre téléphone. Uber existe aussi (叫Uber).\n\n**高鐵 HSR (TGV taiwanais)** :\nLe High Speed Rail connecte Taipei à Kaohsiung (345 km) en 1h30 à 300 km/h. Arrêts : Taipei → Banqiao → Taoyuan → Hsinchu → Miaoli → Taichung → Changhua → Yunlin → Chiayi → Tainan → Zuoying (Kaohsiung). Billet Taipei-Kaohsiung : ~1,490 NT$ (standard), ~1,180 NT$ avec réduction early bird (-20%). Réservez sur le site web ou l'app.\n\n**台鐵 Train régional** :\nPlus lent que le 高鐵 mais dessert TOUTE l'île, y compris la côte est (Hualien, Taitung) que le HSR ne couvre pas. Idéal pour les excursions à Jiufen, Pingxi, ou faire le tour de l'île.",
        },
        {
          type: "tip",
          content:
