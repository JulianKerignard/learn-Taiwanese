...
export const unit28: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "この道をまっすぐ行くと、右に駅があります。",
          romaji: "kono michi o massugu iku to, migi ni eki ga arimasu.",
        ...
        {
          type: "example",
          japanese: "窓を開けると、海が見えた。",
          romaji: "mado o akeru to, umi ga mieta.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "早く予約すれば、安くなりますよ。",
          romaji: "hayaku yoyaku sureba, yasuku narimasu yo.",
        ...
        {
          type: "example",
          japanese: "お金があれば、日本に住みたい。",
          romaji: "okane ga areba, nihon ni sumitai.",
        ...
        {
          type: "example",
          japanese: "駅に行かなければ、切符は買えません。",
          romaji: "eki ni ikanakereba, kippu wa kaemasen.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "困ったら、いつでも連絡してください。",
          romaji: "komattara, itsudemo renraku shite kudasai.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "— 週末、京都へ行きます。— 京都なら、新幹線が便利ですよ。",
          romaji: "— shuumatsu, Kyouto e ikimasu. — Kyouto nara, shinkansen ga benri desu yo.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "マリー",
        japanese: "今度の週末、京都へ行きます。",
        romaji: "kondo no shuumatsu, Kyouto e ikimasu.",
      ...
      {
        speaker: "田中",
        japanese: "京都なら、新幹線が便利ですよ。",
        romaji: "Kyouto nara, shinkansen ga benri desu yo.",
      ...
      },
      {
        speaker: "マリー",
        japanese: "高くないですか。",
        romaji: "takaku nai desu ka.",
        french: "Ce n’est pas cher ?",
      },
      {
        speaker: "田中",
        japanese: "早く予約すれば、安くなります。",
        romaji: "hayaku yoyaku sureba, yasuku narimasu.",
      ...
      {
        speaker: "田中",
        japanese: "駅を出ると、すぐ前にバス乗り場があります。",
        romaji: "eki o deru to, sugu mae ni basu noriba ga arimasu.",
      ...
      {
        speaker: "マリー",
        japanese: "わかりました。京都に着いたら、連絡します。",
        romaji: "wakarimashita. Kyouto ni tsuitara, renraku shimasu.",
      ...
      {
        speaker: "田中",
        japanese: "はい。困ったら、いつでも電話してください。",
        romaji: "hai. komattara, itsudemo denwa shite kudasai.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "eki ni tsuitara, denwa shimasu.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["やすければ、かいます。", "やすいば、かいます。", "やすいければ、かいます。", "やすくば、かいます。"],
