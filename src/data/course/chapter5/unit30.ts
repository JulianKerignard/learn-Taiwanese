...
export const unit30: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "先生は学生に日本語で説明させました。",
          romaji: "sensei wa gakusei ni nihongo de setsumei sasemashita.",
        ...
        {
          type: "example",
          japanese: "部長は私を大阪に出張させました。",
          romaji: "buchou wa watashi o oosaka ni shucchou sasemashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "先生は子どもたちをプールで泳がせました。",
          romaji: "sensei wa kodomotachi o puuru de oyogasemashita.",
        ...
        {
          type: "example",
          japanese: "部長は私に重い荷物を持たせました。",
          romaji: "buchou wa watashi ni omoi nimotsu o motasemashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "部長は田中さんに残業させました。",
          romaji: "buchou wa Tanaka-san ni zangyou sasemashita.",
        ...
        {
          type: "example",
          japanese: "父は私に好きな大学を選ばせてくれました。",
          romaji: "chichi wa watashi ni sukina daigaku o erabasete kuremashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "きのう部長に二時間も待たされました。",
          romaji: "kinou buchou ni nijikan mo matasaremashita.",
        ...
        {
          type: "example",
          japanese: "子どものとき、毎日野菜を食べさせられました。",
          romaji: "kodomo no toki, mainichi yasai o tabesaseraremashita.",
        ...
        {
          type: "example",
          japanese: "すみません、今日は少し早く帰らせていただけませんか。",
          romaji: "sumimasen, kyou wa sukoshi hayaku kaerasete itadakemasen ka.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "マリー",
        japanese: "部長、すみません。今日は少し早く帰らせていただけませんか。",
        romaji: "buchou, sumimasen. kyou wa sukoshi hayaku kaerasete itadakemasen ka.",
      ...
      {
        speaker: "マリー",
        japanese: "息子が熱を出したので、病院に連れて行きたいんです。",
        romaji: "musuko ga netsu o dashita node, byouin ni tsurete ikitai n desu.",
      ...
      {
        speaker: "部長",
        japanese: "それは心配ですね。もちろん、帰ってください。",
        romaji: "sore wa shinpai desu ne. mochiron, kaette kudasai.",
      ...
      {
        speaker: "田中",
        japanese: "よかったですね。私はきのう、九時まで残業させられましたよ。",
        romaji: "yokatta desu ne. watashi wa kinou, kuji made zangyou saseraremashita yo.",
      ...
      },
      {
        speaker: "マリー",
        japanese: "え、部長にですか。",
        romaji: "e, buchou ni desu ka.",
        french: "Quoi, c'est le chef ?",
        note: "に marque l'agent de la contrainte, exactement comme au passif.",
      },
      {
        speaker: "田中",
        japanese: "ええ。しかも、会議の前に一時間も待たされました。",
        romaji: "ee. shikamo, kaigi no mae ni ichijikan mo matasaremashita.",
      ...
      {
        speaker: "マリー",
        japanese: "それは大変でしたね。今日は早く休ませてもらってください。",
        romaji: "sore wa taihen deshita ne. kyou wa hayaku yasumasete moratte kudasai.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romaji: "watashi ni mo tetsudawasete kudasai.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "ichijikan mo matasaremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kinou wa zangyou saseraremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "haha wa watashi ni heya o souji sasemashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "maiasa, inu o kouen de hashirasemasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kyou wa sukoshi yasumasete kudasai.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "mainichi piano o renshuu saseraremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "mou ichido setsumei sasete kudasai.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kaigi ni sanka sasete itadakimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "buchou no kyoka o moraimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "musuko ni wa jiyuu ni kimesasete imasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kodomo ni muri o sasenai de kudasai.",
  ...
  exercises: [
    {
      ...
      optionsKana: ["いかせる", "いかれる", "いかさせる", "いけさせる"],
    ...
    },
    {
      ...
      optionsKana: ["またされました", "またせました", "またれました", "まちました"],
