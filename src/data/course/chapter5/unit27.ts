...
export const unit27: CourseUnit = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "行く ／ 行かない ／ 行った ／ 行かなかった",
          romaji: "iku / ikanai / itta / ikanakatta",
        ...
        {
          type: "example",
          japanese: "高い ／ 高くない ／ 高かった ／ 高くなかった",
          romaji: "takai / takakunai / takakatta / takaku nakatta",
        ...
        {
          type: "example",
          japanese: "静かだ ／ 静かじゃない ／ 静かだった ／ 静かじゃなかった",
          romaji: "shizuka da / shizuka ja nai / shizuka datta / shizuka ja nakatta",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "これはわたしが読んだ本です。",
          romaji: "kore wa watashi ga yonda hon desu.",
        ...
        {
          type: "example",
          japanese: "時間があるとき、日記を書きます。",
          romaji: "jikan ga aru toki, nikki o kakimasu.",
        ...
        {
          type: "example",
          japanese: "田中さんは来ないと言いました。",
          romaji: "Tanaka-san wa konai to iimashita.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "けん",
        japanese: "ううん、忙しい。仕事がある。",
        romaji: "uun, isogashii. shigoto ga aru.",
      ...
      },
      {
        speaker: "けん",
        japanese: "来週は大丈夫だと思う。",
        romaji: "raishuu wa daijoubu da to omou.",
      ...
      {
        speaker: "けん",
        japanese: "もしもし、田中です。はい、その記事はもう読みました。とてもおもしろいと思います。",
        romaji: "moshimoshi, Tanaka desu. hai, sono kiji wa mou yomimashita. totemo omoshiroi to omoimasu.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "先輩には丁寧に話す。",
        romaji: "senpai ni wa teinei ni hanasu.",
    ...
    },
    {
      ...
      example: {
        sentence: "父は毎朝新聞を読む。",
        romaji: "chichi wa maiasa shinbun o yomu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "shitashii tomodachi ni wa futsuukei o tsukau.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kono baai, desu masu wa tsukawanai.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["たかくない", "たかいじゃない", "たかいない", "たかいだない"],
    ...
    },
    {
      ...
      optionsKana: ["じゃない", "くない", "だない", "じゃなかった"],
