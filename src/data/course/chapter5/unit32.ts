...
export const unit32: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          japanese: "日本語を教える先生",
          romaji: "nihongo o oshieru sensei",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "わたしが好きな店は駅の近くにあります。",
          romaji: "watashi ga suki na mise wa eki no chikaku ni arimasu.",
        ...
        {
          type: "example",
          japanese: "昨日友だちと行った店で食べた料理はとてもおいしかったです。",
          romaji: "kinou tomodachi to itta mise de tabeta ryouri wa totemo oishikatta desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "日本へ行くとき、空港でこの本を買いました。",
          romaji: "nihon e iku toki, kuukou de kono hon o kaimashita.",
        ...
        {
          type: "example",
          japanese: "日本へ行ったとき、京都でこの本を買いました。",
          romaji: "nihon e itta toki, Kyouto de kono hon o kaimashita.",
        ...
        {
          type: "example",
          japanese: "夏休みのあいだに、京都へ行きました。",
          romaji: "natsuyasumi no aida ni, Kyouto e ikimashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "友だちが歌うのを聞きました。",
          romaji: "tomodachi ga utau no o kikimashita.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "客",
        japanese: "すみません、昨日電車の中にかばんを忘れました。",
        romaji: "sumimasen, kinou densha no naka ni kaban o wasuremashita.",
      ...
      {
        speaker: "客",
        japanese: "黒くて小さいかばんです。去年、京都で買ったかばんです。",
        romaji: "kurokute chiisai kaban desu. kyonen, Kyouto de katta kaban desu.",
      ...
      },
      {
        speaker: "係員",
        japanese: "中に何がありますか。",
        romaji: "naka ni nani ga arimasu ka.",
        french: "Qu'est-ce qu'il y a dedans ?",
      },
      {
        speaker: "客",
        japanese: "財布と、日本語を勉強するときに使うノートがあります。",
        romaji: "saifu to, nihongo o benkyou suru toki ni tsukau nooto ga arimasu.",
      ...
      {
        speaker: "係員",
        japanese: "名前を書いたかばんが一つあります。これですか。",
        romaji: "namae o kaita kaban ga hitotsu arimasu. kore desu ka.",
      ...
      {
        speaker: "客",
        japanese: "あ、それです。ありがとうございます。",
        romaji: "a, sore desu. arigatou gozaimasu.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romaji: "kodomo no toki, yoku hon o yomimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kore wa chichi ga totta shashin desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "shizuka na basho de benkyou shimasu.",
