...
export const unit05: CourseUnit = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "サ シ ス セ ソ / タ チ ツ テ ト / ナ ニ ヌ ネ ノ",
          romaji: "sa shi su se so / ta chi tsu te to / na ni nu ne no",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "Vous",
        japanese: "コーヒーとケーキ、おねがいします。",
        romaji: "koohii to keeki, onegai shimasu.",
      ...
      },
      {
        speaker: "Serveur",
        japanese: "セットですか。",
        romaji: "setto desu ka.",
        french: "En formule ?",
        note: "セット désigne la formule boisson + plat, affichée sur presque tous les menus.",
      },
      {
        speaker: "Vous",
        japanese: "はい。カードでおねがいします。",
        romaji: "hai. kaado de onegai shimasu.",
  ...
  vocabulary: [
    { term: "コーヒー", kana: "コーヒー", romaji: "koohii", pitch: 3, french: "Le café (boisson)", english: "Coffee" },
    { term: "ケーキ", kana: "ケーキ", romaji: "keeki", pitch: 1, french: "Le gâteau", english: "Cake" },
    { term: "テスト", kana: "テスト", romaji: "tesuto", pitch: 1, french: "Le test, l'examen", english: "Test" },
    { term: "カメラ", kana: "カメラ", romaji: "kamera", pitch: 1, french: "L'appareil photo", english: "Camera" },
    { term: "ネクタイ", kana: "ネクタイ", romaji: "nekutai", french: "La cravate", english: "Necktie" },
    { term: "スーツ", kana: "スーツ", romaji: "suutsu", pitch: 1, french: "Le costume, le tailleur", english: "Suit" },
    ...
    { term: "カード", kana: "カード", romaji: "kaado", pitch: 1, french: "La carte (bancaire, de visite)", english: "Card" },
    { term: "テニス", kana: "テニス", romaji: "tenisu", pitch: 1, french: "Le tennis", english: "Tennis" },
    { term: "サッカー", kana: "サッカー", romaji: "sakkaa", pitch: 1, french: "Le football", english: "Football, soccer" },
    { term: "ニュース", kana: "ニュース", romaji: "nyuusu", pitch: 1, french: "Les informations, l'actualité", english: "News" },
    { term: "ナイフ", kana: "ナイフ", romaji: "naifu", pitch: 1, french: "Le couteau", english: "Knife" },
    { term: "コンビニ", kana: "コンビニ", romaji: "konbini", pitch: 0, french: "La supérette, le konbini", english: "Convenience store" },
    { term: "スーパー", kana: "スーパー", romaji: "suupaa", pitch: 1, french: "Le supermarché", english: "Supermarket" },
    { term: "セット", kana: "セット", romaji: "setto", pitch: 1, french: "La formule, l'ensemble", english: "Set, combo" },
  ],
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["タクシー", "タクツー", "タクシ", "タワシー"],
