...
export const unit42: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "現代社会において、情報の量は増加しつつある。",
          romaji: "gendai shakai ni oite, jouhou no ryou wa zouka shitsutsu aru.",
        ...
        {
          type: "example",
          japanese: "この問題に関して、専門家の意見を聞いた。",
          romaji: "kono mondai ni kanshite, senmonka no iken o kiita.",
        ...
        {
          type: "example",
          japanese: "政府はこの問題に対して、新しい対策を取った。",
          romaji: "seifu wa kono mondai ni taishite, atarashii taisaku o totta.",
    ...
    },
    {
      ...
      content: [
        {
          type: "example",
          japanese: "この報告書は専門家によって作成された。",
          romaji: "kono houkokusho wa senmonka ni yotte sakusei sareta.",
        ...
        {
          type: "example",
          japanese: "考え方は人によって異なる。",
          romaji: "kangaekata wa hito ni yotte kotonaru.",
        ...
        {
          type: "example",
          japanese: "彼は研究者として日本に来た。",
          romaji: "kare wa kenkyuusha to shite Nihon ni kita.",
        ...
        {
          type: "example",
          japanese: "留学生にとって、この制度は分かりにくい。",
          romaji: "ryuugakusei ni totte, kono seido wa wakarinikui.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "体に悪いと知りつつ、つい飲んでしまう。",
          romaji: "karada ni warui to shiritsutsu, tsui nonde shimau.",
        ...
        {
          type: "example",
          japanese: "収入は少ないながらも、生活は安定している。",
          romaji: "shuunyuu wa sukunai nagara mo, seikatsu wa antei shite iru.",
        ...
        {
          type: "example",
          japanese: "悪天候にもかかわらず、大勢の観客が集まった。",
          romaji: "akutenkou ni mo kakawarazu, oozei no kankyaku ga atsumatta.",
        ...
        {
          type: "example",
          japanese: "彼は謝るどころか、こちらのせいだと言い出した。",
          romaji: "kare wa ayamaru dokoro ka, kochira no sei da to iidashita.",
        ...
        {
          type: "example",
          japanese: "この制度は複雑なばかりか、費用も高い。",
          romaji: "kono seido wa fukuzatsu na bakari ka, hiyou mo takai.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "先生",
        japanese: "レポートの構成について、少しコメントしますね。",
        romaji: "repooto no kousei ni tsuite, sukoshi komento shimasu ne.",
      ...
      {
        speaker: "学生",
        japanese: "はい、お願いします。第二段落の主張が弱いでしょうか。",
        romaji: "hai, onegai shimasu. daini danraku no shuchou ga yowai deshou ka.",
        french: "Oui, je vous en prie. Est-ce que ma thèse du deuxième paragraphe est faible ?",
      },
      {
        speaker: "先生",
        japanese: "弱いというより、譲歩と主張の区別がつきにくいですね。「確かに」で始めた文が、そのまま結論のように読めてしまいます。",
        romaji: "yowai to iu yori, jouho to shuchou no kubetsu ga tsukinikui desu ne. tashika ni de hajimeta bun ga, sono mama ketsuron no you ni yomete shimaimasu.",
      ...
      {
        speaker: "学生",
        japanese: "なるほど。「にもかかわらず」を使えばいいでしょうか。",
        romaji: "naruhodo. ni mo kakawarazu o tsukaeba ii deshou ka.",
        french: "Je vois. Est-ce que je peux utiliser にもかかわらず ?",
      },
      {
        speaker: "先生",
        japanese: "いいですね。ただ、「にかかわらず」と書かないように。「も」が入るかどうかで意味が変わりますから。",
        romaji: "ii desu ne. tada, ni kakawarazu to kakanai you ni. mo ga hairu ka dou ka de imi ga kawarimasu kara.",
      ...
      {
        speaker: "学生",
        japanese: "もう一つ。「学生にとって」と「学生に対して」、どちらが正しいですか。",
        romaji: "mou hitotsu. gakusei ni totte to gakusei ni taishite, dochira ga tadashii desu ka.",
        french: "Encore une chose : faut-il écrire 学生にとって ou 学生に対して ?",
      },
      {
        speaker: "先生",
        japanese: "後ろに来るものを見てください。「負担が大きい」なら判断ですから「にとって」です。「説明する」のように行為なら「に対して」になります。",
        romaji: "ushiro ni kuru mono o mite kudasai. futan ga ookii nara handan desu kara ni totte desu. setsumei suru no you ni koui nara ni taishite ni narimasu.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "hissha no shuchou wa saigo no danraku ni aru.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "tashika ni wa jouho no aizu de aru.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "wakai sedai ni wa sono keikou ga tsuyoi.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "shitagatte, seido no minaoshi ga hitsuyou de aru.",
