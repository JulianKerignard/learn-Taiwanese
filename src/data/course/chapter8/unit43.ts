...
export const unit43: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "政府、来年度予算案を決定",
          romaji: "seifu, rainendo yosan-an o kettei",
        ...
        },
        {
          type: "example",
          japanese: "首相、来月訪米へ",
          romaji: "shushou, raigetsu houbei e",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          japanese: "感染拡大防止対策",
          romaji: "kansen kakudai boushi taisaku",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "紛失した場合は、直ちに窓口に届け出ること。",
          romaji: "funshitsu shita baai wa, tadachi ni madoguchi ni todokederu koto.",
        ...
        {
          type: "example",
          japanese: "申込みは、一人一回に限る。",
          romaji: "moushikomi wa, hitori ikkai ni kagiru.",
        ...
        {
          type: "example",
          japanese: "利用料金は、毎月末日までに支払うものとする。",
          romaji: "riyou ryoukin wa, maitsuki matsujitsu made ni shiharau mono to suru.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "記録的大雨、九州で6万人に避難指示",
          romaji: "kirokuteki ooame, kyuushuu de rokuman-nin ni hinan shiji",
        ...
        {
          type: "example",
          japanese: "気象庁は12日未明、九州北部に大雨特別警報を発表した。自治体は約6万人に避難指示を出した。",
          romaji:
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "中村",
        japanese: "今日の一面、見ましたか。「首相、来月訪米へ」ですよ。",
        romaji: "kyou no ichimen, mimashita ka. \"shushou, raigetsu houbei e\" desu yo.",
      ...
      {
        speaker: "デュボワ",
        japanese: "その「へ」は何ですか。動詞がありませんが。",
        romaji: "sono \"e\" wa nan desu ka. doushi ga arimasen ga.",
      ...
      {
        speaker: "中村",
        japanese: "見出しでは動詞を落とすんです。「訪米へ」で「訪米する予定だ」という意味になります。",
        romaji: "midashi de wa doushi o otosu n desu. \"houbei e\" de \"houbei suru yotei da\" to iu imi ni narimasu.",
      ...
      {
        speaker: "デュボワ",
        japanese: "下の記事には「増税か」とあります。これも予定ですか。",
        romaji: "shita no kiji ni wa \"zouzei ka\" to arimasu. kore mo yotei desu ka.",
      ...
      {
        speaker: "中村",
        japanese: "いいえ、「か」は推測です。まだ決まっていません。新聞が可能性を示しているだけです。",
        romaji: "iie, \"ka\" wa suisoku desu. mada kimatte imasen. shinbun ga kanousei o shimeshite iru dake desu.",
      ...
      {
        speaker: "デュボワ",
        japanese: "なるほど。ところで、人事から来たこの紙に「提出のこと」と書いてありますが、これは命令ですか。",
        romaji:
      ...
      {
        speaker: "中村",
        japanese: "事務的な指示です。「必ず提出してください」と同じ意味ですが、書き言葉ではこう書きます。",
        romaji: "jimuteki na shiji desu. \"kanarazu teishutsu shite kudasai\" to onaji imi desu ga, kakikotoba de wa kou kakimasu.",
      ...
      {
        speaker: "デュボワ",
        japanese: "「社員に限る」ともありました。対象の限定ですね。",
        romaji: "\"shain ni kagiru\" to mo arimashita. taishou no gentei desu ne.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romaji: "midashi dake yomeba, naiyou ga daitai wakarimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "seifu wa atarashii taisaku o happyou shita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "shi wa yaku rokuman-nin ni hinan shiji o dashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "raishuu kara kion ga agaru mikomi desu.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["にかぎる", "にかぎらない", "にわたる", "にかかわる"],
