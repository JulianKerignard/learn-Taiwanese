...
export const unit40: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "雨がざあざあ降っています。",
          romaji: "ame ga zaazaa futte imasu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "このサイズがぴったりです。",
          romaji: "kono saizu ga pittari desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "三日前から頭がずきずきします。",
          romaji: "mikka mae kara atama ga zukizuki shimasu.",
        ...
        },
        {
          type: "example",
          japanese: "のどがひりひりします。",
          romaji: "nodo ga hirihiri shimasu.",
        ...
        {
          type: "example",
          japanese: "この天ぷらはさくさくしていて、とてもおいしいです。",
          romaji: "kono tenpura wa sakusaku shite ite, totemo oishii desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "昨日はぐっすり寝ました。",
          romaji: "kinou wa gussuri nemashita.",
        ...
        {
          type: "example",
          japanese: "日曜日は一日中だらだらしていました。",
          romaji: "nichiyoubi wa ichinichijuu daradara shite imashita.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "患者",
        japanese: "三日前から頭が痛いんです。",
        romaji: "mikka mae kara atama ga itai n desu.",
      ...
      {
        speaker: "医者",
        japanese: "どんな痛みですか。ずきずきしますか、それともがんがんしますか。",
        romaji: "donna itami desu ka. zukizuki shimasu ka, soretomo gangan shimasu ka.",
      ...
      {
        speaker: "患者",
        japanese: "ずきずきします。それに、のどもひりひりします。",
        romaji: "zukizuki shimasu. sore ni, nodo mo hirihiri shimasu.",
      ...
      {
        speaker: "医者",
        japanese: "夜はぐっすり眠れていますか。",
        romaji: "yoru wa gussuri nemurete imasu ka.",
      ...
      {
        speaker: "患者",
        japanese: "いいえ。夜中に何度も目が覚めて、朝はだらだらしています。",
        romaji: "iie. yonaka ni nando mo me ga samete, asa wa daradara shite imasu.",
      ...
      {
        speaker: "医者",
        japanese: "風邪ですね。この薬を飲んで、ゆっくり休んでください。",
        romaji: "kaze desu ne. kono kusuri o nonde, yukkuri yasunde kudasai.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "ashita no ryokou ni wakuwaku shite imasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "mensetsu no mae wa dokidoki shimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "densha ga konakute, iraira shimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "setsumei o kiite mo, sappari wakarimasen deshita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kono tenpura wa sakusaku shite imasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "kono pan wa mochimochi shite imasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "shoujou o kuwashiku setsumei shite kudasai.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["ずきずき", "ひりひり", "ぺこぺこ", "きらきら"],
    ...
    },
    {
      ...
      optionsKana: ["ぺこぺこ", "わくわく", "どきどき", "だらだら"],
