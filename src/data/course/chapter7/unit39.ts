...
export const unit39: CourseUnit = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "電気が消えています。誰もいないようです。",
          romaji: "denki ga kiete imasu. daremo inai you desu.",
        ...
        {
          type: "example",
          japanese: "駅の前で事故があったらしいですよ。",
          romaji: "eki no mae de jiko ga atta rashii desu yo.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "九時の電車に乗ったから、もう着いているはずです。",
          romaji: "kuji no densha ni notta kara, mou tsuite iru hazu desu.",
        ...
        {
          type: "example",
          japanese: "三時に着くはずでしたが、電車が遅れました。",
          romaji: "sanji ni tsuku hazu deshita ga, densha ga okuremashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "田中さんは来月会社をやめるらしいですが、実はまだ確かではありません。",
          romaji: "Tanaka-san wa raigetsu kaisha o yameru rashii desu ga, jitsu wa mada tashika de wa arimasen.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "佐藤",
        japanese: "天気予報によると、明日は台風が来るそうですよ。",
        romaji: "tenki yohou ni yoru to, ashita wa taifuu ga kuru sou desu yo.",
      ...
      {
        speaker: "木村",
        japanese: "本当ですか。空を見ると、今にも降りそうですね。",
        romaji: "hontou desu ka. sora o miru to, ima ni mo furisou desu ne.",
      ...
      {
        speaker: "佐藤",
        japanese: "出張は中止になるらしいですよ。まだ正式な発表はありませんが。",
        romaji: "shucchou wa chuushi ni naru rashii desu yo. mada seishiki na happyou wa arimasen ga.",
      ...
      {
        speaker: "木村",
        japanese: "じゃあ、部長はもう知っているはずですね。",
        romaji: "jaa, buchou wa mou shitte iru hazu desu ne.",
      ...
      {
        speaker: "佐藤",
        japanese: "いや、まだのようです。さっき普通に準備していましたから。",
        romaji: "iya, mada no you desu. sakki futsuu ni junbi shite imashita kara.",
      ...
      {
        speaker: "木村",
        japanese: "それなら、私たちが伝えるべきですね。",
        romaji: "sore nara, watashitachi ga tsutaeru beki desu ne.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romaji: "sore wa tada no uwasa rashii desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "tenki yohou ni yoru to, shuumatsu wa hareru sou desu.",
    ...
    },
    {
      ...
      example: {
        sentence: "外の様子を見てきます。",
        romaji: "soto no yousu o mite kimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "sono hanashi wa tashika de wa arimasen.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "buchou ni tsutaeru beki da to omoimasu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "jiko ga atta rashii desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "densha ga okurete iru you desu.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "taifuu de shiai wa chuushi ni naru sou desu.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["おいしそう", "おいしいそう", "おいしそうな", "おいしいらしい"],
