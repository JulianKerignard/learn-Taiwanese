...
export const unit38: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "明日の会議のために、資料をコピーしておきます。",
          romaji: "ashita no kaigi no tame ni, shiryou o kopii shite okimasu.",
        ...
        {
          type: "example",
          japanese: "レストランはもう予約しておいた。",
          romaji: "resutoran wa mou yoyaku shite oita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "昨日、その本を全部読んでしまった。",
          romaji: "kinou, sono hon o zenbu yonde shimatta.",
        ...
        {
          type: "example",
          japanese: "電車の中で財布をなくしてしまいました。",
          romaji: "densha no naka de saifu o nakushite shimaimashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "机の上にメモが置いてある。",
          romaji: "tsukue no ue ni memo ga oite aru.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "明日の準備はしてある。資料も印刷しておいた。ただ、名前を書くのを忘れてしまった。",
          romaji: "ashita no junbi wa shite aru. shiryou mo insatsu shite oita. tada, namae o kaku no o wasurete shimatta.",
          translation:
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "先輩",
        japanese: "明日の会議の資料、もう印刷してある？",
        romaji: "ashita no kaigi no shiryou, mou insatsu shite aru?",
      ...
      {
        speaker: "後輩",
        japanese: "はい、昨日のうちに印刷しておきました。",
        romaji: "hai, kinou no uchi ni insatsu shite okimashita.",
      ...
      {
        speaker: "先輩",
        japanese: "助かる。会議室の予約は？",
        romaji: "tasukaru. kaigishitsu no yoyaku wa?",
      ...
      {
        speaker: "後輩",
        japanese: "あ……予約するのを忘れてしまいました。すみません。",
        romaji: "a...... yoyaku suru no o wasurete shimaimashita. sumimasen.",
      ...
      {
        speaker: "先輩",
        japanese: "大丈夫。今から取っとくよ。あと、エアコンはつけておいてね。",
        romaji: "daijoubu. ima kara tottoku yo. ato, eakon wa tsukete oite ne.",
      ...
      {
        speaker: "後輩",
        japanese: "はい。窓も開けておきますか。",
        romaji: "hai. mado mo akete okimasu ka.",
        french: "Entendu. Faut-il aussi laisser la fenêtre ouverte ?",
      },
      {
        speaker: "先輩",
        japanese: "いや、窓はもう開けてある。朝、誰かが開けてくれたみたいだ。",
        romaji: "iya, mado wa mou akete aru. asa, dareka ga akete kureta mitai da.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romaji: "hoteru wa mou yoyaku shite aru.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "ukkari kasa o wasurete shimatta.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["よやくしておきます", "よやくしてしまいます", "よやくしてあります", "よやくしています"],
    ...
    },
    {
      ...
      optionsKana: ["のんじゃった", "のんちゃった", "のんどいた", "のんである"],
    ...
    },
    {
      ...
      optionsKana: ["わすれてしまいました", "わすれておきました", "わすれてありました", "わすれています"],
