...
export const unit41: CourseUnit = {
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "さくら",
        japanese: "ねえ、明日の飲み会、行く？",
        romaji: "nee, ashita no nomikai, iku?",
      ...
      {
        speaker: "けん",
        japanese: "行きたいんだけど、まだ仕事が終わってないんだ。",
        romaji: "ikitai n da kedo, mada shigoto ga owattenai n da.",
      ...
      {
        speaker: "さくら",
        japanese: "そっか。じゃあ、先に始めとくね。",
        romaji: "sokka. jaa, saki ni hajimetoku ne.",
      ...
      {
        speaker: "けん",
        japanese: "うん。八時までには行けると思うよ。",
        romaji: "un. hachiji made ni wa ikeru to omou yo.",
      ...
      {
        speaker: "さくら",
        japanese: "あれ、店の名前、何だっけ？",
        romaji: "are, mise no namae, nan dakke?",
      ...
      {
        speaker: "けん",
        japanese: "駅前の居酒屋だよ。遅れると席なくなっちゃうから。",
        romaji: "ekimae no izakaya da yo. okureru to seki nakunacchau kara.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "aite ni yotte hanashikata o kaeru.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "senpai ni tameguchi wa yameta hou ga ii.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "machigai ni kizukanakatta.",
  ...
  exercises: [
    {
      ...
      optionsKana: ["たべちゃった", "たべじゃった", "たべとった", "たべてなきゃ"],
