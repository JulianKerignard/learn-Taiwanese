import type { Chapter, CourseUnitMeta, JLPTLevel } from "@/types/course";
...
export function getJLPTLevelForUnit(unit: CourseUnitMeta): JLPTLevel | undefined {
...
export function getJLPTLevelUnitMetas(level: JLPTLevel): CourseUnitMeta[] {
