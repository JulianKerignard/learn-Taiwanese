...
export const unit21: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "朝、起きて、ごはんを食べて、会社に行きます。",
          romaji: "asa, okite, gohan o tabete, kaisha ni ikimasu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "食べます → 食べて ／ 見ます → 見て ／ 起きます → 起きて",
          romaji: "tabemasu → tabete / mimasu → mite / okimasu → okite",
        ...
        {
          type: "example",
          japanese: "急ぎます → 急いで ／ 働きます → 働いて",
          romaji: "isogimasu → isoide / hatarakimasu → hataraite",
        ...
        {
          type: "example",
          japanese: "します → して ／ 来ます → 来て",
          romaji: "shimasu → shite / kimasu → kite",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "きのう、友だちに会って、映画を見て、うちに帰りました。",
          romaji: "kinou, tomodachi ni atte, eiga o mite, uchi ni kaerimashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "今、何をしていますか。— メールを書いています。",
          romaji: "ima, nani o shite imasu ka. — meeru o kaite imasu.",
        ...
        {
          type: "example",
          japanese: "田中さんは結婚しています。東京に住んでいます。",
          romaji: "Tanaka-san wa kekkon shite imasu. Toukyou ni sunde imasu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "田中",
        japanese: "山田さん、今、何をしていますか。",
        romaji: "Yamada-san, ima, nani o shite imasu ka.",
      ...
      {
        speaker: "山田",
        japanese: "昼ごはんを食べています。田中さんも座ってください。",
        romaji: "hirugohan o tabete imasu. Tanaka-san mo suwatte kudasai.",
      ...
      {
        speaker: "田中",
        japanese: "ありがとうございます。ちょっと待ってください、飲み物を持って来ます。",
        romaji: "arigatou gozaimasu. chotto matte kudasai, nomimono o motte kimasu.",
      ...
      {
        speaker: "田中",
        japanese: "山田さんはどこに住んでいますか。",
        romaji: "Yamada-san wa doko ni sunde imasu ka.",
      ...
      {
        speaker: "山田",
        japanese: "千葉に住んでいます。毎朝、一時間電車に乗って、会社に来ます。",
        romaji: "Chiba ni sunde imasu. maiasa, ichijikan densha ni notte, kaisha ni kimasu.",
      ...
      {
        speaker: "田中",
        japanese: "大変ですね。ご家族もいっしょに千葉ですか。",
        romaji: "taihen desu ne. go-kazoku mo issho ni Chiba desu ka.",
      ...
      {
        speaker: "山田",
        japanese: "はい。結婚しています。子どもが二人います。",
        romaji: "hai. kekkon shite imasu. kodomo ga futari imasu.",
      ...
      {
        speaker: "田中",
        japanese: "そうですか。あ、もう一時ですね。急いで食べましょう。",
        romaji: "sou desu ka. a, mou ichiji desu ne. isoide tabemashou.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["すわって", "すわりて", "すわんで", "すわいて"],
