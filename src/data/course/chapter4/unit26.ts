...
export const unit26: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "田中さんが花をくれました。",
          romaji: "Tanaka-san ga hana o kuremashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "友だちに宿題を手伝ってもらいました。",
          romaji: "tomodachi ni shukudai o tetsudatte moraimashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "部長が資料をくださいました。",
          romaji: "buchou ga shiryou o kudasaimashita.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "出張のお土産です。皆さんでどうぞ。",
          romaji: "shucchou no omiyage desu. minasan de douzo.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "ソフィー",
        japanese: "皆さん、京都のお土産です。どうぞ。",
        romaji: "minasan, Kyouto no omiyage desu. douzo.",
      ...
      {
        speaker: "田中",
        japanese: "わあ、ありがとうございます。いつもすみません。",
        romaji: "waa, arigatou gozaimasu. itsumo sumimasen.",
      ...
      {
        speaker: "ソフィー",
        japanese: "いいえ。先週は仕事を手伝ってくださって、ありがとうございました。",
        romaji: "iie. senshuu wa shigoto o tetsudatte kudasatte, arigatou gozaimashita.",
      ...
      {
        speaker: "田中",
        japanese: "いえいえ。ところで、部長にお歳暮を贈りますか。",
        romaji: "ieie. tokorode, buchou ni oseibo o okurimasu ka.",
      ...
      {
        speaker: "ソフィー",
        japanese: "お歳暮？何ですか、それは。",
        romaji: "oseibo? nan desu ka, sore wa.",
      ...
      {
        speaker: "田中",
        japanese: "十二月に、お世話になった人に贈る物です。ビールやお菓子が多いです。",
        romaji: "juunigatsu ni, osewa ni natta hito ni okuru mono desu. biiru ya okashi ga ooi desu.",
      ...
      {
        speaker: "ソフィー",
        japanese: "なるほど。じゃあ、私も何か贈るつもりです。お返しをいただいたら、どうしますか。",
        romaji: "naruhodo. jaa, watashi mo nanika okuru tsumori desu. okaeshi o itadaitara, dou shimasu ka.",
      ...
      {
        speaker: "田中",
        japanese: "お歳暮にお返しは必要ありません。お礼状だけで十分ですよ。",
        romaji: "oseibo ni okaeshi wa hitsuyou arimasen. oreijou dake de juubun desu yo.",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romaji: "Tanaka-san ni hana o agemashita.",
        translation: "J'ai offert des fleurs à M. Tanaka.",
      },
    },
    {
      ...
      example: {
        sentence: "父が時計をくれました。",
        romaji: "chichi ga tokei o kuremashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "tomodachi ni chokoreeto o moraimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "buchou ni omiyage o itadakimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "okaeshi ni, okashi o okurimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "hikkoshi o tetsudatte kuremasen ka.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "tomodachi ni jitensha o kashimashita.",
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "Tanaka-san wa totemo shinsetsu desu.",
