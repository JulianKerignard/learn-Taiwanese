...
export const unit22: CourseUnit = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "日曜日は会社に来なくてもいいです。",
          romaji: "nichiyoubi wa kaisha ni konakute mo ii desu.",
        ...
        {
          type: "example",
          japanese: "家賃は毎月二十五日に払わなければなりません。",
          romaji: "yachin wa maitsuki nijuugonichi ni harawanakereba narimasen.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "不動産屋",
        japanese: "どうぞ、入ってください。あ、ここで靴を脱がなければなりません。",
        romaji: "douzo, haitte kudasai. a, koko de kutsu o nuganakereba narimasen.",
      ...
      {
        speaker: "ジュリー",
        japanese: "静かな部屋ですね。ここでたばこを吸ってもいいですか。",
        romaji: "shizuka na heya desu ne. koko de tabako o sutte mo ii desu ka.",
      ...
      {
        speaker: "不動産屋",
        japanese: "いいえ、部屋の中では吸ってはいけません。ベランダで吸ってください。",
        romaji: "iie, heya no naka de wa sutte wa ikemasen. beranda de sutte kudasai.",
      ...
      {
        speaker: "ジュリー",
        japanese: "わかりました。ペットはどうですか。",
        romaji: "wakarimashita. petto wa dou desu ka.",
      ...
      {
        speaker: "不動産屋",
        japanese: "すみません、ペットはだめです。大家さんの規則ですから。",
        romaji: "sumimasen, petto wa dame desu. ooya san no kisoku desu kara.",
      ...
      {
        speaker: "ジュリー",
        japanese: "そうですか。家賃はいつ払わなければなりませんか。",
        romaji: "sou desu ka. yachin wa itsu harawanakereba narimasen ka.",
      ...
      {
        speaker: "不動産屋",
        japanese: "毎月二十五日です。おそくなる時は、必ず電話してください。",
        romaji: "maitsuki nijuugonichi desu. osoku naru toki wa, kanarazu denwa shite kudasai.",
      ...
      {
        speaker: "ジュリー",
        japanese: "夜、シャワーを使ってもいいですか。",
        romaji: "yoru, shawaa o tsukatte mo ii desu ka.",
      ...
      {
        speaker: "不動産屋",
        japanese: "はい。でも、十一時のあとは静かにしなければなりません。となりに人がいますから。",
        romaji: "hai. demo, juuichiji no ato wa shizuka ni shinakereba narimasen. tonari ni hito ga imasu kara.",
      ...
      {
        speaker: "ジュリー",
        japanese: "わかりました。規則を守ります。この部屋をお願いします。",
        romaji: "wakarimashita. kisoku o mamorimasu. kono heya o onegai shimasu.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        ...
        romaji: "yachin wa maitsuki harawanakereba narimasen.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["はいって", "はいいて", "はいりて", "はいんで"],
    ...
    },
    {
      ...
      optionsKana: ["こなくて", "こないで", "こなければ", "こなくては"],
