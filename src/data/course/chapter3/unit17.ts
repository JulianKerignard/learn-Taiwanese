...
export const unit17: CourseUnit = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "きっぷを二枚おねがいします。",
          romaji: "kippu o nimai onegai shimasu.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "Vous",
        japanese: "じゃあ、それを一枚ください。",
        romaji: "jaa, sore o ichimai kudasai.",
        french: "Alors je prends celui-là.",
        note: "枚 parce qu'un vêtement se compte comme un objet plat, plié.",
      },
      {
        speaker: "Vendeuse",
        japanese: "二千円になります。袋はいりますか。",
        romaji: "nisen en ni narimasu. fukuro wa irimasu ka.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["もっと", "おおきい", "の", "は", "ありますか"],
