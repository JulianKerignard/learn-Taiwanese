...
export const unit14: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "わたしは毎日コーヒーを飲みます。",
          romaji: "watashi wa mainichi koohii o nomimasu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "コーヒーを飲みますか。 — はい、飲みます。",
          romaji: "koohii o nomimasu ka. — hai, nomimasu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "田中",
        japanese: "マリーさん、コーヒーを飲みますか。",
        romaji: "Marii-san, koohii o nomimasu ka.",
        french: "Marie, vous prenez un café ?",
        note: "Le nom + さん remplace le pronom « vous ». Ajouter あなた ici serait déplacé.",
      },
      {
        speaker: "マリー",
        japanese: "はい、飲みます。ありがとうございます。",
        romaji: "hai, nomimasu. arigatou gozaimasu.",
        french: "Oui, volontiers. Merci beaucoup.",
        note: "La réponse courte reprend le verbe de la question : はい、飲みます。",
      },
      {
        speaker: "田中",
        japanese: "マリーさんは毎日日本語を話しますか。",
        romaji: "Marii-san wa mainichi nihongo o hanashimasu ka.",
        french: "Vous parlez japonais tous les jours ?",
      },
      {
        speaker: "マリー",
        japanese: "いいえ、あまり話しません。でも、毎日読みます。",
        romaji: "iie, amari hanashimasen. demo, mainichi yomimasu.",
      ...
      {
        speaker: "田中",
        japanese: "じゃあ、いっしょに日本語を話しませんか。",
        romaji: "jaa, issho ni nihongo o hanashimasen ka.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsKana: ["のみます", "のみません", "たべます", "かいます"],
    ...
    },
    {
      ...
      optionsKana: ["たべません", "たべます", "のみません", "かいません"],
