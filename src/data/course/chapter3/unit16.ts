  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "ラーメンをおねがいします。",
          romaji: "raamen o onegai shimasu.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        speaker: "Serveur",
        japanese: "今日は魚の定食です。",
        romaji: "kyou wa sakana no teishoku desu.",
      ...
      {
        speaker: "Vous",
        japanese: "じゃあ、それをおねがいします。お茶もおねがいします。",
        romaji: "jaa, sore o onegai shimasu. ocha mo onegai shimasu.",
      ...
      {
        speaker: "Vous",
        japanese: "ごちそうさまでした。おかいけいおねがいします。",
        romaji: "gochisousama deshita. okaikei onegai shimasu.",
