...
export const unit19: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "高いです → 高くないです → 高かったです",
          romaji: "takai desu → takaku nai desu → takakatta desu",
        ...
        {
          type: "example",
          japanese: "しずかです → しずかじゃないです → しずかでした",
          romaji: "shizuka desu → shizuka ja nai desu → shizuka deshita",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "しずかな部屋がいいです。",
          romaji: "shizuka na heya ga ii desu.",
        ...
        },
        {
          type: "example",
          japanese: "新しい部屋は便利です。",
          romaji: "atarashii heya wa benri desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "電車はバスより便利です。",
          romaji: "densha wa basu yori benri desu.",
        ...
        {
          type: "example",
          japanese: "この部屋はあの部屋より安いです。",
          romaji: "kono heya wa ano heya yori yasui desu.",
        ...
        {
          type: "example",
          japanese: "この店がいちばん有名です。",
          romaji: "kono mise ga ichiban yuumei desu.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          japanese: "この部屋は新しくてしずかです。",
          romaji: "kono heya wa atarashikute shizuka desu.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "Employé",
        japanese: "こちらは新しくて便利ですが、少し高いです。",
        romaji: "kochira wa atarashikute benri desu ga, sukoshi takai desu.",
      ...
      {
        speaker: "Vous",
        japanese: "もう一つの部屋はどうですか。",
        romaji: "mou hitotsu no heya wa dou desu ka.",
        french: "Et l'autre chambre ?",
        note: "もう一つ = « un de plus », donc « l'autre ». どうですか demande une appréciation générale.",
      },
      {
        speaker: "Employé",
        japanese: "古いですが、こちらより安いですよ。",
        romaji: "furui desu ga, kochira yori yasui desu yo.",
      ...
      },
      {
        speaker: "Vous",
        japanese: "どちらがしずかですか。",
        romaji: "dochira ga shizuka desu ka.",
      ...
      {
        speaker: "Employé",
        japanese: "古い部屋のほうがしずかです。",
        romaji: "furui heya no hou ga shizuka desu.",
  ...
  exercises: [
    {
      ...
      optionsKana: ["きれい", "おおきい", "いそがしい", "おいしい"],
