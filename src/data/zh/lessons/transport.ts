...
const sections: CourseSection[] = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        native: "我要坐紅線到淡水。",
        romanization: "Wǒ yào zuò hóng xiàn dào Dànshuǐ.",
      ...
      },
      {
        ...
        native: "松山站可以逛饒河夜市。",
        romanization: "Sōngshān zhàn kěyǐ guàng Ráohé yèshì.",
        translation:
      ...
      },
      {
        ...
        native: "請問，單程票多少錢？",
        romanization: "Qǐngwèn, dānchéng piào duōshǎo qián?",
      ...
      },
      {
        ...
        native: "請問，往淡水方向在哪邊？",
        romanization: "Qǐngwèn, wǎng Dànshuǐ fāngxiàng zài nǎ biān?",
        translation:
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        native: "上車請刷卡。",
        romanization: "Shàngchē qǐng shuā kǎ.",
      ...
      },
      {
        ...
        native: "師傅，我要到這個地方。",
        romanization: "Shīfù, wǒ yào dào zhè ge dìfāng.",
      ...
      },
      {
        ...
        native: "到台北101大概多少錢？",
        romanization: "Dào Táiběi yī líng yī dàgài duōshǎo qián?",
      ...
      },
      {
        ...
        native: "我要買一張到高雄的高鐵票。",
        romanization: "Wǒ yào mǎi yì zhāng dào Gāoxióng de gāotiě piào.",
      ...
      },
      {
        ...
        native: "請問，到花蓮的自強號幾點發車？",
        romanization: "Qǐngwèn, dào Huālián de zìqiáng hào jǐ diǎn fāchē?",
        translation:
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        native: "我要買一張悠遊卡，然後加值五百塊。",
        romanization: "Wǒ yào mǎi yì zhāng yōuyóu kǎ, ránhòu jiāzhí wǔbǎi kuài.",
        translation:
      ...
      },
      {
        ...
        native: "我要加值三百。",
        romanization: "Wǒ yào jiāzhí sānbǎi.",
      ...
      },
      {
        ...
        native: "這裡附近有YouBike的站嗎？",
        romanization: "Zhèlǐ fùjìn yǒu YouBike de zhàn ma?",
      ...
      },
      {
        ...
        native: "附近的YouBike站滿了，怎麼辦？",
        romanization: "Fùjìn de YouBike zhàn mǎn le, zěnme bàn?",
        translation:
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        native: "我想租一台機車，一個月多少錢？",
        romanization: "Wǒ xiǎng zū yì tái jīchē, yí ge yuè duōshǎo qián?",
        translation:
      ...
      },
      {
        ...
        native: "這個路口要兩段式左轉。",
        romanization: "Zhè ge lùkǒu yào liǎng duàn shì zuǒ zhuǎn.",
        translation:
      ...
      },
      {
        ...
        native: "請問有沒有雨衣？",
        romanization: "Qǐngwèn yǒu méiyǒu yǔyī?",
...
const transportLesson: Lesson = {
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romanization: "Wǒ yào zuò jiéyùn qù Táiběi yī líng yī.",
        translation: "Je vais prendre le MRT pour aller à Taipei 101.",
      },
    },
    {
      term: "公車",
      romanization: "gōngchē",
      reading: "ㄍㄨㄥ ㄔㄜ",
      french: "Bus",
      english: "Bus",
    },
    {
      term: "計程車",
      romanization: "jìchéngchē",
      reading: "ㄐㄧˋ ㄔㄥˊ ㄔㄜ",
      french: "Taxi",
      english: "Taxi",
      example: {
        sentence: "請幫我叫一台計程車。",
        romanization: "Qǐng bāng wǒ jiào yì tái jìchéngchē.",
        translation: "Appelez-moi un taxi, s'il vous plaît.",
      },
    },
    {
      term: "火車站",
      romanization: "huǒchē zhàn",
      reading: "ㄏㄨㄛˇ ㄔㄜ ㄓㄢˋ",
    ...
    {
      term: "悠遊卡",
      romanization: "yōuyóu kǎ",
      reading: "ㄧㄡ ㄧㄡˊ ㄎㄚˇ",
      french: "Carte EasyCard",
      english: "EasyCard",
      example: {
        sentence: "我要買一張悠遊卡。",
        romanization: "Wǒ yào mǎi yì zhāng yōuyóu kǎ.",
  ...
  phrases: [
    {
      native: "請問，到台北車站怎麼走？",
      romanization: "Qǐngwèn, dào Táiběi chēzhàn zěnme zǒu?",
      reading:
    ...
    },
    {
      native: "我要買一張悠遊卡。",
      romanization: "Wǒ yào mǎi yì zhāng yōuyóu kǎ.",
      reading: "ㄨㄛˇ ㄧㄠˋ ㄇㄞˇ ㄧˋ ㄓㄤ ㄧㄡ ㄧㄡˊ ㄎㄚˇ",
    ...
    {
      native: "請問這班車到九份嗎？",
      romanization: "Qǐngwèn zhè bān chē dào Jiǔfèn ma?",
      reading:
    ...
    {
      native: "我要到這個地址。",
      romanization: "Wǒ yào dào zhè ge dìzhǐ.",
      reading: "ㄨㄛˇ ㄧㄠˋ ㄉㄠˋ ㄓㄜˋ ㄍㄜˋ ㄉㄧˋ ㄓˇ",
    ...
    {
      native: "下一站是哪裡？",
      romanization: "Xià yí zhàn shì nǎlǐ?",
      reading: "ㄒㄧㄚˋ ㄧˊ ㄓㄢˋ ㄕˋ ㄋㄚˇ ㄌㄧˇ",
    ...
    },
    {
      ...
      reading: "ㄨㄛˇ ㄧㄠˋ ㄗㄞˋ ㄓㄜˋ ㄌㄧˇ ㄒㄧㄚˋ ㄔㄜ",
      french: "Je veux descendre ici.",
      english: "I want to get off here.",
    },
    {
      native: "悠遊卡可以加值嗎？",
      romanization: "Yōuyóu kǎ kěyǐ jiāzhí ma?",
      reading: "ㄧㄡ ㄧㄡˊ ㄎㄚˇ ㄎㄜˇ ㄧˇ ㄐㄧㄚ ㄓˊ ㄇㄚ˙",
    ...
    {
      native: "請問出口幾號？",
      romanization: "Qǐngwèn chūkǒu jǐ hào?",
      reading: "ㄑㄧㄥˇ ㄨㄣˋ ㄔㄨ ㄎㄡˇ ㄐㄧˇ ㄏㄠˋ",
