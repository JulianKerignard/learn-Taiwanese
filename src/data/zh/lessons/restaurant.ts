...
const sections: CourseSection[] = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        native: "老闆，我要這個，一份。",
        romanization: "Lǎobǎn, wǒ yào zhè ge, yí fèn.",
      ...
      },
      {
        ...
        native: "請問，有英文菜單嗎？",
        romanization: "Qǐngwèn, yǒu yīngwén càidān ma?",
      ...
      },
      {
        ...
        native: "要加熱嗎？— 好，謝謝。",
        romanization: "Yào jiārè ma? — Hǎo, xiè xiè.",
      ...
      },
      {
        ...
        native: "我們要鴛鴦鍋，一個麻辣，一個番茄。",
        romanization: "Wǒmen yào yuānyāng guō, yí ge málà, yí ge fānqié.",
        translation:
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        native: "老闆，一碗滷肉飯，加一個滷蛋。",
        romanization: "Lǎobǎn, yì wǎn lǔ ròu fàn, jiā yí ge lǔ dàn.",
      ...
      },
      {
        ...
        native: "我要一碗紅燒牛肉麵，大碗的。",
        romanization: "Wǒ yào yì wǎn hóngshāo niú ròu miàn, dà wǎn de.",
        translation:
      ...
      },
      {
        ...
        native: "我要一籠小籠包，十個的。",
        romanization: "Wǒ yào yì lóng xiǎo lóng bāo, shí ge de.",
        translation:
      ...
      },
      {
        ...
        native: "我要一杯珍珠奶茶，半糖少冰。",
        romanization: "Wǒ yào yì bēi zhēn zhū nǎi chá, bàn táng shǎo bīng.",
        translation:
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        native: "老闆，大雞排一份多少錢？",
        romanization: "Lǎobǎn, dà jī pái yí fèn duōshǎo qián?",
      ...
      },
      {
        ...
        native: "我要兩份，謝謝。不要辣。",
        romanization: "Wǒ yào liǎng fèn, xiè xiè. Bú yào là.",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        native: "我吃素。請問有素食的菜嗎？",
        romanization: "Wǒ chī sù. Qǐngwèn yǒu sùshí de cài ma?",
        translation:
      ...
      },
      {
        ...
        native: "我對花生過敏，這個有花生嗎？",
        romanization: "Wǒ duì huāshēng guòmǐn, zhège yǒu huāshēng ma?",
        translation:
      ...
      },
      {
        ...
        native: "我對海鮮過敏，請問這道菜有海鮮嗎？",
        romanization: "Wǒ duì hǎixiān guòmǐn, qǐngwèn zhè dào cài yǒu hǎixiān ma?",
        translation:
      ...
      },
      {
        ...
        native: "這個辣嗎？我不能吃辣的。",
        romanization: "Zhè ge là ma? Wǒ bù néng chī là de.",
...
const restaurantLesson: Lesson = {
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "我吃素，有素食嗎？",
        romanization: "Wǒ chī sù, yǒu sùshí ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "內用還是外帶？",
        romanization: "Nèiyòng háishì wàidài?",
  ...
  phrases: [
    {
      native: "我要一碗牛肉麵。",
      romanization: "Wǒ yào yì wǎn niúròu miàn.",
      reading: "ㄨㄛˇ ㄧㄠˋ ㄧˋ ㄨㄢˇ ㄋㄧㄡˊ ㄖㄡˋ ㄇㄧㄢˋ",
    ...
    {
      native: "請問，有素食的嗎？",
      romanization: "Qǐngwèn, yǒu sùshí de ma?",
      reading: "ㄑㄧㄥˇ ㄨㄣˋ ㄧㄡˇ ㄙㄨˋ ㄕˊ ㄉㄜ˙ ㄇㄚ˙",
    ...
    {
      native: "不要辣，謝謝。",
      romanization: "Bú yào là, xiè xiè.",
      reading: "ㄅㄨˊ ㄧㄠˋ ㄌㄚˋ ㄒㄧㄝˋ ㄒㄧㄝˋ",
      french: "Pas épicé, merci.",
      english: "Not spicy, thank you.",
    },
    {
      native: "買單，謝謝。",
      romanization: "Mǎidān, xiè xiè.",
      reading: "ㄇㄞˇ ㄉㄢ ㄒㄧㄝˋ ㄒㄧㄝˋ",
      french: "L'addition, s'il vous plaît.",
      english: "The bill, please.",
    },
    {
      native: "很好吃！",
      romanization: "Hěn hǎochī!",
      reading: "ㄏㄣˇ ㄏㄠˇ ㄔ",
    ...
    {
      native: "我要外帶。",
      romanization: "Wǒ yào wàidài.",
      reading: "ㄨㄛˇ ㄧㄠˋ ㄨㄞˋ ㄉㄞˋ",
      french: "Je voudrais à emporter.",
      english: "I'd like it to go.",
    },
    {
      native: "再來一杯，謝謝。",
      romanization: "Zài lái yì bēi, xiè xiè.",
      reading: "ㄗㄞˋ ㄌㄞˊ ㄧˋ ㄅㄟ ㄒㄧㄝˋ ㄒㄧㄝˋ",
      french: "Encore un verre, merci.",
      english: "One more glass, please.",
    },
    {
      native: "可以用信用卡嗎？",
      romanization: "Kěyǐ yòng xìnyòngkǎ ma?",
      reading: "ㄎㄜˇ ㄧˇ ㄩㄥˋ ㄒㄧㄣˋ ㄩㄥˋ ㄎㄚˇ ㄇㄚ˙",
