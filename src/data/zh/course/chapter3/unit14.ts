  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我喜歡台灣的食物",
          romanization: "wǒ xǐhuān Táiwān de shíwù",
        ...
        },
        {
          type: "example",
          native: "她不喜歡喝咖啡",
          romanization: "tā bù xǐhuān hē kāfēi",
        ...
        },
        {
          type: "example",
          native: "我想去夜市",
          romanization: "wǒ xiǎng qù yèshì",
        ...
        },
        {
          type: "example",
          native: "你想要什麼？",
          romanization: "nǐ xiǎng yào shénme?",
        ...
        },
        {
          type: "example",
          native: "我覺得台灣很漂亮",
          romanization: "wǒ juéde Táiwān hěn piàoliang",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "台北比高雄大",
          romanization: "Táiběi bǐ Gāoxióng dà",
        ...
        },
        {
          type: "example",
          native: "小籠包比水餃貴",
          romanization: "xiǎolóngbāo bǐ shuǐjiǎo guì",
        ...
        },
        {
          type: "example",
          native: "這家餐廳最好吃",
          romanization: "zhè jiā cāntīng zuì hǎochī",
        ...
        },
        {
          type: "example",
          native: "那家更便宜",
          romanization: "nà jiā gèng piányi",
        ...
        },
        {
          type: "example",
          native: "這個跟那個一樣好",
          romanization: "zhège gēn nàge yīyàng hǎo",
        ...
        },
        {
          type: "example",
          native: "這家比那家便宜一點",
          romanization: "zhè jiā bǐ nà jiā piányi yìdiǎn",
          translation: "Celui-ci est un peu moins cher que celui-la",
          content: "比 + adjectif + 一點 = un peu plus [adjectif] que.",
        },
        {
          type: "example",
          native: "台灣的水果比法國的好吃多了",
          romanization: "Táiwān de shuǐguǒ bǐ Fǎguó de hǎochī duō le",
        ...
        },
        {
          type: "example",
          native: "法國的夏天沒有台灣的熱",
          romanization: "Fǎguó de xiàtiān méiyǒu Táiwān de rè",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "那家餐廳怎麼樣？還好。",
          romanization: "nà jiā cāntīng zěnmeyàng? háihǎo.",
        ...
        },
        {
          type: "example",
          native: "這個蛋糕不錯！",
          romanization: "zhège dàngāo búcuò!",
        ...
        },
        {
          type: "example",
          native: "這個口味我不太習慣",
          romanization: "zhège kǒuwèi wǒ bú tài xíguàn",
        ...
        },
        {
          type: "example",
          native: "這個可能不太適合我",
          romanization: "zhège kěnéng bú tài shìhé wǒ",
    ...
    lines: [
      {
        speaker: "小明",
        native: "你覺得今天的午餐怎麼樣？",
        romanization: "nǐ juéde jīntiān de wǔcān zěnmeyàng?",
        french: "Tu as trouvé le déjeuner comment aujourd'hui ?",
      },
      {
        speaker: "你",
        native: "不錯！我覺得滷肉飯很好吃。你喜歡吃什麼？",
        romanization: "búcuò! wǒ juéde lǔròufàn hěn hǎochī. nǐ xǐhuān chī shénme?",
        french: "Pas mal ! Je trouve le braised pork rice très bon. Tu aimes manger quoi ?",
      },
      {
        speaker: "小明",
        native: "我最喜歡小籠包。鼎泰豐比其他的好吃。",
        romanization: "wǒ zuì xǐhuān xiǎolóngbāo. Dǐngtàifēng bǐ qítā de hǎochī.",
        french: "J'aime surtout les xiaolongbao. Din Tai Fung est meilleur que les autres.",
      },
      {
        speaker: "你",
        native: "可是鼎泰豐比較貴，對不對？",
        romanization: "kěshì Dǐngtàifēng bǐjiào guì, duì bú duì?",
        french: "Mais Din Tai Fung est assez cher, non ?",
      },
      {
        speaker: "小明",
        native: "還好啦。我覺得夜市的更便宜，也不錯。",
        romanization: "háihǎo la. wǒ juéde yèshì de gèng piányi, yě búcuò.",
      ...
      {
        speaker: "你",
        native: "好，我想去夜市！你覺得哪個夜市最有意思？",
        romanization: "hǎo, wǒ xiǎng qù yèshì! nǐ juéde nǎge yèshì zuì yǒu yìsi?",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我喜歡台灣的水果。",
        romanization: "wǒ xǐhuān Táiwān de shuǐguǒ.",
    ...
    },
    {
      ...
      example: {
        sentence: "我想吃小籠包。",
        romanization: "wǒ xiǎng chī xiǎolóngbāo.",
        translation: "Je veux manger des xiaolongbao.",
      },
    },
    {
      term: "漂亮",
      romanization: "piàoliang",
      reading: "ㄆㄧㄠˋ ˙ㄌㄧㄤ",
      french: "Joli, beau",
      english: "Pretty, beautiful",
      example: {
        sentence: "台灣的山很漂亮。",
        romanization: "Táiwān de shān hěn piàoliang.",
    ...
    },
    {
      ...
      example: {
        sentence: "這部電影很好看。",
        romanization: "zhè bù diànyǐng hěn hǎokàn.",
        translation: "Ce film est très bien.",
      },
    },
    {
      term: "有意思",
      romanization: "yǒu yìsi",
      reading: "ㄧㄡˇ ㄧˋ ㄙ",
      french: "Intéressant",
      english: "Interesting",
      example: {
        sentence: "這本書很有意思。",
        romanization: "zhè běn shū hěn yǒu yìsi.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個節目很無聊。",
        romanization: "zhège jiémù hěn wúliáo.",
    ...
    },
    {
      ...
      example: {
        sentence: "今天比昨天熱。",
        romanization: "jīntiān bǐ zuótiān rè.",
    ...
    },
    {
      ...
      example: {
        sentence: "這家更便宜。",
        romanization: "zhè jiā gèng piányi.",
    ...
    },
    {
      ...
      example: {
        sentence: "你最喜歡什麼？",
        romanization: "nǐ zuì xǐhuān shénme?",
    ...
    },
    {
      ...
      example: {
        sentence: "味道怎麼樣？還好。",
        romanization: "wèidào zěnmeyàng? háihǎo.",
    ...
    },
    {
      ...
      example: {
        sentence: "這家餐廳不錯！",
        romanization: "zhè jiā cāntīng búcuò!",
    ...
    },
    {
      ...
      example: {
        sentence: "臭豆腐很特別。",
        romanization: "chòudòufu hěn tèbié.",
    ...
    },
    {
      ...
      example: {
        sentence: "我們的想法一樣。",
        romanization: "wǒmen de xiǎngfǎ yīyàng.",
    ...
    },
    {
      ...
      example: {
        sentence: "每個夜市都不同。",
        romanization: "měige yèshì dōu bùtóng.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "zhōngwén hěn nán, dànshì hěn yǒu yìsi.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個很容易，你試試看。",
        romanization: "zhège hěn róngyì, nǐ shìshì kàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "你想喝茶或者咖啡？",
        romanization: "nǐ xiǎng hē chá huòzhě kāfēi?",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄐㄩㄝˊ ㄉㄜ", "ㄒㄧˇ ㄏㄨㄢ", "ㄒㄧㄤˇ", "ㄅㄧˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄊㄞˊ ㄅㄟˇ ㄅㄧˇ ㄍㄠ ㄒㄩㄥˊ ㄉㄚˋ", "ㄊㄞˊ ㄅㄟˇ ㄏㄣˇ ㄍㄠ ㄒㄩㄥˊ ㄉㄚˋ", "ㄊㄞˊ ㄅㄟˇ ㄗㄨㄟˋ ㄍㄠ ㄒㄩㄥˊ ㄉㄚˋ", "ㄊㄞˊ ㄅㄟˇ ㄍㄣ ㄍㄠ ㄒㄩㄥˊ ㄉㄚˋ"],
    },
    {
      id: "unit-14-ex3",
      type: "comprehension",
