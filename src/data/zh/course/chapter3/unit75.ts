  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "手機被偷了。",
          romanization: "shǒujī bèi tōu le.",
        ...
        },
        {
          type: "example",
          native: "蛋糕被弟弟吃掉了。",
          romanization: "dàngāo bèi dìdi chī diào le.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "老闆叫我加班。",
          romanization: "lǎobǎn jiào wǒ jiābān.",
        ...
        },
        {
          type: "example",
          native: "老師不讓我們用手機。",
          romanization: "lǎoshī bú ràng wǒmen yòng shǒujī.",
        ...
        },
        {
          type: "example",
          native: "她叫我早一點來。",
          romanization: "tā jiào wǒ zǎo yìdiǎn lái.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "把衣服洗乾淨。",
          romanization: "bǎ yīfú xǐ gānjìng.",
        ...
        },
        {
          type: "example",
          native: "你把功課寫完了嗎？",
          romanization: "nǐ bǎ gōngkè xiě wán le ma?",
    ...
    lines: [
      {
        speaker: "Collegue",
        native: "你怎麼了？看起來不開心。",
        romanization: "nǐ zěnme le? kàn qǐlái bù kāixīn.",
        french: "Qu'est-ce qui t'arrive ? Tu n'as pas l'air content.",
      },
      {
        speaker: "Julian",
        native: "我的腳踏車被偷了！",
        romanization: "wǒ de jiǎotàchē bèi tōu le!",
        french: "Mon velo a ete vole !",
      },
      {
        speaker: "Collegue",
        native: "真的嗎？太糟糕了。老闆又叫你加班嗎？",
        romanization: "zhēn de ma? tài zāogāo le. lǎobǎn yòu jiào nǐ jiābān ma?",
        french: "Vraiment ? Trop nul. Et le patron t'a encore fait faire des heures sup ?",
      },
      {
        speaker: "Julian",
        native: "對，他不讓我早走。然後我把手機摔壞了。",
        romanization: "duì, tā bú ràng wǒ zǎo zǒu. ránhòu wǒ bǎ shǒujī shuāi huài le.",
        french: "Oui, il ne m'a pas laisse partir tot. Et j'ai casse mon telephone en le faisant tomber.",
      },
      {
        speaker: "Collegue",
        native: "把手機拿去修吧。我讓我弟弟幫你看看。",
        romanization: "bǎ shǒujī ná qù xiū ba. wǒ ràng wǒ dìdi bāng nǐ kànkan.",
        french: "Apporte ton telephone a reparer. Je vais demander a mon frere de t'aider.",
      },
      {
        speaker: "Julian",
        native: "謝謝！今天被這些事搞得很累。",
        romanization: "xièxie! jīntiān bèi zhèxiē shì gǎo de hěn lèi.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我被雨淋濕了。",
        romanization: "wǒ bèi yǔ lín shī le.",
    ...
    },
    {
      ...
      example: {
        sentence: "讓我想想。",
        romanization: "ràng wǒ xiǎngxiǎng.",
    ...
    },
    {
      ...
      example: {
        sentence: "他叫我等一下。",
        romanization: "tā jiào wǒ děng yíxià.",
    ...
    },
    {
      ...
      example: {
        sentence: "這件事使我很生氣。",
        romanization: "zhè jiàn shì shǐ wǒ hěn shēngqì.",
    ...
    },
    {
      ...
      example: {
        sentence: "公司派我去日本。",
        romanization: "gōngsī pài wǒ qù Rìběn.",
        translation: "L'entreprise m'envoie au Japon.",
      },
    },
    {
      term: "命令",
      romanization: "mìnglìng",
      reading: "ㄇㄧㄥˋ ㄌㄧㄥˋ",
      french: "ordonner, ordre",
      english: "to order, command",
      example: {
        sentence: "軍官命令士兵前進。",
        romanization: "jūnguān mìnglìng shìbīng qiánjìn.",
    ...
    },
    {
      ...
      example: {
        sentence: "這裡不允許抽煙。",
        romanization: "zhèlǐ bù yǔnxǔ chōuyān.",
    ...
    },
    {
      ...
      example: {
        sentence: "老師要求我們每天練習。",
        romanization: "lǎoshī yāoqiú wǒmen měi tiān liànxí.",
    ...
    },
    {
      ...
      example: {
        sentence: "我建議你去看醫生。",
        romanization: "wǒ jiànyì nǐ qù kàn yīshēng.",
    ...
    },
    {
      ...
      example: {
        sentence: "提醒我明天開會。",
        romanization: "tíxǐng wǒ míngtiān kāihuì.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄅㄟˋ", "ㄅㄚˇ", "ㄖㄤˋ", "ㄍㄟˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄐㄧㄠˋ", "ㄖㄤˋ", "ㄅㄟˋ", "ㄕˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄅㄚˇ", "ㄅㄟˋ", "ㄖㄤˋ", "ㄍㄟˇ"],
