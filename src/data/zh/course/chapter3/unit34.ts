  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我早上吃了飯。",
          romanization: "wǒ zǎoshang chī le fàn.",
        ...
        },
        {
          type: "example",
          native: "明天會下雨。",
          romanization: "míngtiān huì xiàyǔ.",
        ...
        },
        {
          type: "example",
          native: "我沒吃過臭豆腐。",
          romanization: "wǒ méi chī guò chòudòufu.",
        ...
        },
        {
          type: "example",
          native: "她昨天買了一本書。",
          romanization: "tā zuótiān mǎi le yì běn shū.",
        ...
        },
        {
          type: "example",
          native: "我不會游泳。",
          romanization: "wǒ bú huì yóuyǒng.",
        ...
        },
        {
          type: "example",
          native: "你去過日本嗎？",
          romanization: "nǐ qù guò Rìběn ma?",
        ...
        },
        {
          type: "example",
          native: "下個月我會去台灣。",
          romanization: "xià ge yuè wǒ huì qù Táiwān.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我覺得台灣比法國漂亮。",
          romanization: "wǒ juéde Táiwān bǐ Fǎguó piàoliang.",
        ...
        },
        {
          type: "example",
          native: "珍珠奶茶最好喝。",
          romanization: "zhēnzhū nǎichá zuì hǎohē.",
        ...
        },
        {
          type: "example",
          native: "這家餐廳更便宜。",
          romanization: "zhè jiā cāntīng gèng piányí.",
        ...
        {
          type: "example",
          native: "台北的捷運比巴黎的地鐵乾淨。",
          romanization: "Táiběi de jiéyùn bǐ Bālí de dìtiě gānjìng.",
        ...
        },
        {
          type: "example",
          native: "我覺得牛肉麵最好吃。",
          romanization: "wǒ juéde niúròu miàn zuì hǎochī.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "因為下雨，所以我不出門。",
          romanization: "yīnwèi xiàyǔ, suǒyǐ wǒ bù chūmén.",
        ...
        },
        {
          type: "example",
          native: "我想去，可是我沒有錢。",
          romanization: "wǒ xiǎng qù, kěshì wǒ méiyǒu qián.",
        ...
        {
          type: "example",
          native: "因為我學了中文，所以我會說一點。",
          romanization: "yīnwèi wǒ xué le Zhōngwén, suǒyǐ wǒ huì shuō yìdiǎn.",
        ...
        {
          type: "example",
          native: "台灣很好玩，可是天氣太熱了。",
          romanization: "Táiwān hěn hǎowán, kěshì tiānqì tài rè le.",
        ...
        {
          type: "example",
          native: "先去便利商店買水，再去捷運站。",
          romanization: "xiān qù biànlì shāngdiàn mǎi shuǐ, zài qù jiéyùn zhàn.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "請用這個詞造句。",
        romanization: "qǐng yòng zhège cí zàojù.",
        translation: "Construisez une phrase avec ce mot.",
      },
    },
    {
      term: "乾淨",
      romanization: "gānjìng",
      reading: "ㄍㄢ ㄐㄧㄥˋ",
      french: "Propre",
      english: "Clean",
      example: {
        sentence: "台北的捷運很乾淨。",
        romanization: "Táiběi de jiéyùn hěn gānjìng.",
    ...
    },
    {
      ...
      example: {
        sentence: "下雨了，不想出門。",
        romanization: "xiàyǔ le, bù xiǎng chūmén.",
    ...
    },
    {
      ...
      example: {
        sentence: "我們去看電影吧。",
        romanization: "wǒmen qù kàn diànyǐng ba.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄑㄩˋ ㄍㄨㄛˋ ㄊㄞˊ ㄅㄟˇ.", "ㄨㄛˇ ㄑㄩˋ ㄌㄜ ㄊㄞˊ ㄅㄟˇ.", "ㄨㄛˇ ㄏㄨㄟˋ ㄑㄩˋ ㄊㄞˊ ㄅㄟˇ.", "ㄨㄛˇ ㄧㄠˋ ㄑㄩˋ ㄊㄞˊ ㄅㄟˇ."],
    },
    {
      id: "unit-34-ex2",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄗㄠˇ ㄕㄤ ㄔ ㄌㄜ ㄈㄢˋ.", "ㄨㄛˇ ㄗㄠˇ ㄕㄤ ㄔ ㄍㄨㄛˋ ㄈㄢˋ.", "ㄨㄛˇ ㄗㄠˇ ㄕㄤ ㄏㄨㄟˋ ㄔ ㄈㄢˋ.", "ㄨㄛˇ ㄔ ㄌㄜ ㄗㄠˇ ㄕㄤ ㄉㄜ ㄈㄢˋ."],
    },
    {
      id: "unit-34-ex3",
      type: "translate",
      ...
      optionsReading: ["ㄇㄧㄥˊ ㄊㄧㄢ ㄏㄨㄟˋ ㄒㄧㄚˋ ㄩˇ.", "ㄇㄧㄥˊ ㄊㄧㄢ ㄒㄧㄚˋ ㄌㄜ ㄩˇ.", "ㄇㄧㄥˊ ㄊㄧㄢ ㄒㄧㄚˋ ㄍㄨㄛˋ ㄩˇ.", "ㄇㄧㄥˊ ㄊㄧㄢ ㄧㄠˋ ㄒㄧㄚˋ ㄩˇ ㄌㄜ."],
    },
    {
      id: "unit-34-ex4",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄇㄟˊ ㄔ ㄍㄨㄛˋ ㄔㄡˋ ㄉㄡˋ ㄈㄨ.", "ㄨㄛˇ ㄇㄟˊ ㄔ ㄌㄜ ㄔㄡˋ ㄉㄡˋ ㄈㄨ.", "ㄨㄛˇ ㄅㄨˋ ㄔ ㄔㄡˋ ㄉㄡˋ ㄈㄨ.", "ㄨㄛˇ ㄅㄨˊ ㄏㄨㄟˋ ㄔ ㄔㄡˋ ㄉㄡˋ ㄈㄨ."],
    },
    {
      id: "unit-34-ex5",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄐㄩㄝˊ ㄉㄜ ㄊㄞˊ ㄨㄢ ㄅㄧˇ ㄈㄚˇ ㄍㄨㄛˊ ㄆㄧㄠˋ ㄌㄧㄤ.", "ㄊㄞˊ ㄨㄢ ㄅㄧˇ ㄈㄚˇ ㄍㄨㄛˊ ㄍㄥˋ ㄆㄧㄠˋ ㄌㄧㄤ.", "ㄨㄛˇ ㄐㄩㄝˊ ㄉㄜ ㄊㄞˊ ㄨㄢ ㄗㄨㄟˋ ㄆㄧㄠˋ ㄌㄧㄤ.", "ㄊㄞˊ ㄨㄢ ㄏㄜˊ ㄈㄚˇ ㄍㄨㄛˊ ㄧ ㄧㄤˋ ㄆㄧㄠˋ ㄌㄧㄤ."],
    },
    {
      id: "unit-34-ex6",
      type: "translate",
      ...
      optionsReading: ["ㄓㄣ ㄓㄨ ㄋㄞˇ ㄔㄚˊ ㄗㄨㄟˋ ㄏㄠˇ ㄏㄜ.", "ㄓㄣ ㄓㄨ ㄋㄞˇ ㄔㄚˊ ㄏㄣˇ ㄏㄠˇ ㄏㄜ.", "ㄓㄣ ㄓㄨ ㄋㄞˇ ㄔㄚˊ ㄅㄧˇ ㄐㄧㄠˋ ㄏㄠˇ ㄏㄜ.", "ㄓㄣ ㄓㄨ ㄋㄞˇ ㄔㄚˊ ㄍㄥˋ ㄏㄠˇ ㄏㄜ."],
    },
    {
      id: "unit-34-ex7",
      type: "translate",
      ...
      optionsReading: ["ㄓㄜˋ ㄐㄧㄚ ㄘㄢ ㄊㄧㄥ ㄍㄥˋ ㄆㄧㄢˊ ㄧ.", "ㄓㄜˋ ㄐㄧㄚ ㄘㄢ ㄊㄧㄥ ㄗㄨㄟˋ ㄆㄧㄢˊ ㄧ.", "ㄓㄜˋ ㄐㄧㄚ ㄘㄢ ㄊㄧㄥ ㄅㄧˇ ㄐㄧㄠˋ ㄆㄧㄢˊ ㄧ.", "ㄓㄜˋ ㄐㄧㄚ ㄘㄢ ㄊㄧㄥ ㄏㄣˇ ㄆㄧㄢˊ ㄧ."],
    },
    {
      id: "unit-34-ex8",
      type: "translate",
      ...
      optionsReading: ["ㄧㄣ ㄨㄟˋ ㄒㄧㄚˋ ㄩˇ, ㄙㄨㄛˇ ㄧˇ ㄨㄛˇ ㄅㄨˋ ㄔㄨ ㄇㄣˊ.", "ㄒㄧㄚˋ ㄩˇ ㄌㄜ, ㄨㄛˇ ㄅㄨˋ ㄔㄨ ㄇㄣˊ.", "ㄧㄣ ㄨㄟˋ ㄒㄧㄚˋ ㄩˇ ㄨㄛˇ ㄅㄨˋ ㄔㄨ ㄇㄣˊ.", "ㄙㄨㄛˇ ㄧˇ ㄒㄧㄚˋ ㄩˇ, ㄧㄣ ㄨㄟˋ ㄅㄨˋ ㄔㄨ ㄇㄣˊ."],
    },
    {
      id: "unit-34-ex9",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄒㄧㄤˇ ㄑㄩˋ, ㄎㄜˇ ㄕˋ ㄨㄛˇ ㄇㄟˊ ㄧㄡˇ ㄑㄧㄢˊ.", "ㄨㄛˇ ㄒㄧㄤˇ ㄑㄩˋ, ㄧㄣ ㄨㄟˋ ㄇㄟˊ ㄧㄡˇ ㄑㄧㄢˊ.", "ㄨㄛˇ ㄇㄟˊ ㄧㄡˇ ㄑㄧㄢˊ ㄒㄧㄤˇ ㄑㄩˋ.", "ㄎㄜˇ ㄕˋ ㄨㄛˇ ㄒㄧㄤˇ ㄑㄩˋ, ㄇㄟˊ ㄧㄡˇ ㄑㄧㄢˊ."],
    },
    {
      id: "unit-34-ex10",
      type: "translate",
      ...
      optionsReading: ["ㄒㄧㄢ ㄔ ㄈㄢˋ, ㄖㄢˊ ㄏㄡˋ ㄑㄩˋ ㄎㄢˋ ㄉㄧㄢˋ ㄧㄥˇ.", "ㄔ ㄈㄢˋ ㄧˇ ㄏㄡˋ ㄎㄢˋ ㄉㄧㄢˋ ㄧㄥˇ.", "ㄒㄧㄢ ㄎㄢˋ ㄉㄧㄢˋ ㄧㄥˇ, ㄖㄢˊ ㄏㄡˋ ㄔ ㄈㄢˋ.", "ㄔ ㄈㄢˋ ㄏㄜˊ ㄎㄢˋ ㄉㄧㄢˋ ㄧㄥˇ."],
    },
    {
      id: "unit-34-ex11",
      type: "reorder",
      ...
      hintReading: "Structure : Sujet + 覺得 + A + 比 + B + Adjectif",
    },
    {
      id: "unit-34-ex12",
      type: "reorder",
      ...
      hintReading: "Structure : 先 + Action 1，然後 + Action 2",
    },
    {
      id: "unit-34-ex13",
      type: "fill-blank",
    ...
    },
    {
      ...
      optionsReading: ["ㄎㄜˇ ㄕˋ", "ㄙㄨㄛˇ ㄧˇ", "ㄖㄢˊ ㄏㄡˋ", "ㄧㄣ ㄨㄟˋ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄗㄨㄟˋ", "ㄍㄥˋ", "ㄅㄧˇ", "ㄏㄣˇ"],
