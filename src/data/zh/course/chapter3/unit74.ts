  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "從台北到高雄",
          romanization: "cóng Táiběi dào Gāoxióng",
        ...
        {
          type: "example",
          native: "從台北到高雄坐高鐵要一個半小時。",
          romanization: "cóng Táiběi dào Gāoxióng zuò gāotiě yào yí ge bàn xiǎoshí.",
        ...
        },
        {
          type: "example",
          native: "從明天開始",
          romanization: "cóng míngtiān kāishǐ",
    ...
    lines: [
      {
        speaker: "Julian",
        native: "從台北到台南要多久？",
        romanization: "cóng Táiběi dào Táinán yào duō jiǔ?",
        french: "De Taipei a Tainan, ca prend combien de temps ?",
      },
      {
        speaker: "Amie",
        native: "坐高鐵大概一個半小時。離台北不遠。",
        romanization: "zuò gāotiě dàgài yí ge bàn xiǎoshí. lí Táiběi bù yuǎn.",
        french: "En TGV environ 1h30. C'est pas loin de Taipei.",
      },
      {
        speaker: "Julian",
        native: "好！你可以跟我一起去嗎？",
        romanization: "hǎo! nǐ kěyǐ gēn wǒ yìqǐ qù ma?",
        french: "Super ! Tu peux venir avec moi ?",
      },
      {
        speaker: "Amie",
        native: "我那天要上班。我替你買票吧。",
        romanization: "wǒ nà tiān yào shàngbān. wǒ tì nǐ mǎi piào ba.",
        french: "Ce jour-la je travaille. Je t'achete les billets.",
      },
      {
        speaker: "Julian",
        native: "謝謝！到了台南以後往哪裡走？",
        romanization: "xièxie! dào le Táinán yǐhòu wǎng nǎlǐ zǒu?",
        french: "Merci ! Une fois a Tainan, je vais dans quelle direction ?",
      },
      {
        speaker: "Amie",
        native: "出站以後往右轉，對面就是老街。",
        romanization: "chū zhàn yǐhòu wǎng yòu zhuǎn, duìmiàn jiù shì lǎojiē.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我從法國來。",
        romanization: "wǒ cóng Fǎguó lái.",
    ...
    },
    {
      ...
      example: {
        sentence: "我跟你一起去。",
        romanization: "wǒ gēn nǐ yìqǐ qù.",
    ...
    },
    {
      ...
      example: {
        sentence: "他對我很好。",
        romanization: "tā duì wǒ hěn hǎo.",
    ...
    },
    {
      ...
      example: {
        sentence: "我給你看照片。",
        romanization: "wǒ gěi nǐ kàn zhàopiàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "我為你高興。",
        romanization: "wǒ wèi nǐ gāoxìng.",
    ...
    },
    {
      ...
      example: {
        sentence: "按照老師說的做。",
        romanization: "ànzhào lǎoshī shuō de zuò.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "gēnjù tiānqì yùbào, míngtiān huì xiàyǔ.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄘㄨㄥˊ...ㄉㄠˋ", "ㄌㄧˊ...ㄉㄠˋ", "ㄗㄞˋ...ㄉㄠˋ", "ㄍㄣ...ㄉㄠˋ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄤˇ...ㄨㄤˇ", "ㄉㄨㄟˋ...ㄉㄨㄟˋ", "ㄘㄨㄥˊ...ㄘㄨㄥˊ", "ㄒㄧㄤˋ...ㄌㄧˊ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄉㄨㄟˋ", "ㄍㄟˇ", "ㄍㄣ", "ㄊㄧˋ"],
