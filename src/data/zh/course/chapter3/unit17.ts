...
export const unit17: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "房租包水電嗎？",
          romanization: "fángzū bāo shuǐdiàn ma?",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "這個房間有陽台",
          romanization: "zhège fángjiān yǒu yángtái",
        ...
        },
        {
          type: "example",
          native: "房間裡有床和桌子",
          romanization: "fángjiān lǐ yǒu chuáng hé zhuōzi",
        ...
        },
        {
          type: "example",
          native: "我住在五樓，有電梯",
          romanization: "wǒ zhù zài wǔ lóu, yǒu diàntī",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我想找一間套房，在台北",
          romanization: "wǒ xiǎng zhǎo yì jiān tàofáng, zài Táiběi",
        ...
        {
          type: "example",
          native: "這間套房在捷運站旁邊，很方便",
          romanization: "zhè jiān tàofáng zài jiéyùn zhàn pángbiān, hěn fāngbiàn",
        ...
        },
        {
          type: "example",
          native: "電費怎麼算？一度多少錢？",
          romanization: "diànfèi zěnme suàn? yì dù duōshǎo qián?",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "你",
        native: "王先生，請問房租一個月多少錢？",
        romanization: "Wáng xiānshēng, qǐngwèn fángzū yí ge yuè duōshǎo qián?",
        french: "M. Wang, combien coûte le loyer par mois ?",
      },
      {
        speaker: "王先生",
        native: "一個月一萬二，包水費和網路。",
        romanization: "yí ge yuè yí wàn èr, bāo shuǐfèi hé wǎnglù.",
      ...
      {
        speaker: "王先生",
        native: "有，每個房間都有冷氣，電費自己付。",
        romanization: "yǒu, měige fángjiān dōu yǒu lěngqì, diànfèi zìjǐ fù.",
      ...
      {
        speaker: "你",
        native: "押金多少？可以看一下廁所嗎？",
        romanization: "yājīn duōshǎo? kěyǐ kàn yíxià cèsuǒ ma?",
        french: "Le dépôt c'est combien ? Je peux voir les toilettes ?",
      },
      {
        speaker: "王先生",
        native: "押金兩個月。來，廁所在這邊，有洗衣機。",
        romanization: "yājīn liǎng ge yuè. lái, cèsuǒ zài zhèbiān, yǒu xǐyījī.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "陽台可以晾衣服。",
        romanization: "yángtái kěyǐ liàng yīfu.",
    ...
    },
    {
      ...
      example: {
        sentence: "押金要兩個月。",
        romanization: "yājīn yào liǎng ge yuè.",
    ...
    },
    {
      ...
      example: {
        sentence: "房間有家具嗎？",
        romanization: "fángjiān yǒu jiājù ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "台灣夏天一定要有冷氣。",
        romanization: "Táiwān xiàtiān yídìng yào yǒu lěngqì.",
    ...
    },
    {
      ...
      example: {
        sentence: "洗衣機在浴室裡面。",
        romanization: "xǐyījī zài yùshì lǐmiàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "我住在三樓。",
        romanization: "wǒ zhù zài sān lóu.",
    ...
    },
    {
      ...
      example: {
        sentence: "合約是一年。",
        romanization: "héyuē shì yì nián.",
    ...
    },
    {
      ...
      example: {
        sentence: "我下個月搬家。",
        romanization: "wǒ xià ge yuè bānjiā.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄧㄡˇ", "ㄕˋ", "ㄗㄞˋ", "ㄎㄜˇ ㄧˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄎㄜˇ ㄧˇ ㄎㄢˋ ㄈㄤˊ ㄇㄚ?", "ㄧㄡˇ ㄎㄢˋ ㄈㄤˊ ㄇㄚ?", "ㄧㄠˋ ㄎㄢˋ ㄈㄤˊ ㄇㄚ?", "ㄒㄧㄤˇ ㄎㄢˋ ㄈㄤˊ ㄇㄚ?"],
    },
    {
      id: "unit-17-ex3",
      type: "comprehension",
