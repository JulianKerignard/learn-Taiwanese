...
export const unit73: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "進來 vs 進去",
          romanization: "jìn lái vs jìn qù",
        ...
        },
        {
          type: "example",
          native: "出來 vs 出去",
          romanization: "chū lái vs chū qù",
        ...
        },
        {
          type: "example",
          native: "上來 vs 上去",
          romanization: "shàng lái vs shàng qù",
        ...
        },
        {
          type: "example",
          native: "下來 vs 下去",
          romanization: "xià lái vs xià qù",
        ...
        },
        {
          type: "example",
          native: "回來 vs 回去",
          romanization: "huí lái vs huí qù",
        ...
        },
        {
          type: "example",
          native: "過來 vs 過去",
          romanization: "guò lái vs guò qù",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "Ami",
        native: "這個箱子，搬上去還是搬下來？",
        romanization: "zhège xiāngzi, bān shàng qù háishì bān xià lái?",
        french: "Cette boite, on la monte ou on la descend ?",
      },
      {
        speaker: "Julian",
        native: "搬上去，放在二樓的房間。",
        romanization: "bān shàng qù, fàng zài èr lóu de fángjiān.",
        french: "Monte-la, pose-la dans la chambre au deuxieme etage.",
      },
      {
        speaker: "Ami",
        native: "好。你的貓跑出去了！",
        romanization: "hǎo. nǐ de māo pǎo chū qù le!",
        french: "OK. Ton chat s'est enfui dehors !",
      },
      {
        speaker: "Julian",
        native: "啊！你可以把牠帶回來嗎？",
        romanization: "a! nǐ kěyǐ bǎ tā dài huí lái ma?",
        french: "Ah ! Tu peux le ramener ?",
      },
      {
        speaker: "Ami",
        native: "牠跑進去隔壁的院子了。我過去看看。",
        romanization: "tā pǎo jìn qù gébì de yuànzi le. wǒ guò qù kànkan.",
        french: "Il a couru dans le jardin du voisin. J'y vais voir.",
      },
      {
        speaker: "Julian",
        native: "我想起來了，牠喜歡那邊的花園！",
        romanization: "wǒ xiǎng qǐ lái le, tā xǐhuān nàbiān de huāyuán!",
  ...
  vocabulary: [
    {
      term: "進來",
      romanization: "jìn lái",
      reading: "ㄐㄧㄣˋ ㄌㄞˊ",
      french: "entrer (vers ici)",
      english: "to come in",
      example: {
        sentence: "請進來！",
        romanization: "qǐng jìn lái!",
    ...
    },
    {
      ...
      example: {
        sentence: "我想出去走走。",
        romanization: "wǒ xiǎng chū qù zǒuzou.",
        translation: "Je voudrais sortir me promener.",
      },
    },
    {
      term: "上來",
      romanization: "shàng lái",
      reading: "ㄕㄤˋ ㄌㄞˊ",
      french: "monter (vers ici)",
      english: "to come up",
      example: {
        sentence: "你上來吧！",
        romanization: "nǐ shàng lái ba!",
        translation: "Monte !",
      },
    },
    {
      ...
      example: {
        sentence: "請說下去。",
        romanization: "qǐng shuō xià qù.",
        translation: "Continue, s'il te plait.",
      },
    },
    {
      term: "回來",
      romanization: "huí lái",
      reading: "ㄏㄨㄟˊ ㄌㄞˊ",
      french: "revenir (vers ici)",
      english: "to come back",
      example: {
        sentence: "你什麼時候回來？",
        romanization: "nǐ shénme shíhòu huí lái?",
    ...
    },
    {
      ...
      example: {
        sentence: "我要回去了。",
        romanization: "wǒ yào huí qù le.",
        translation: "Je dois rentrer.",
      },
    },
    {
      term: "出來",
      romanization: "chū lái",
      reading: "ㄔㄨ ㄌㄞˊ",
      french: "sortir (vers ici) / apparaitre",
      english: "to come out",
      example: {
        sentence: "太陽出來了！",
        romanization: "tàiyáng chū lái le!",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄐㄧㄣˋ ㄌㄞˊ", "ㄐㄧㄣˋ ㄑㄩˋ", "ㄔㄨ ㄌㄞˊ", "ㄔㄨ ㄑㄩˋ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄑㄧˇ ㄌㄞˊ", "ㄔㄨ ㄌㄞˊ", "ㄒㄧㄚˋ ㄑㄩˋ", "ㄏㄨㄟˊ ㄌㄞˊ"],
