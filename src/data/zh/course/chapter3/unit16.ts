  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我吃過臭豆腐",
          romanization: "wǒ chī guò chòudòufu",
        ...
        },
        {
          type: "example",
          native: "你吃過小籠包嗎？",
          romanization: "nǐ chī guò xiǎolóngbāo ma?",
        ...
        },
        {
          type: "example",
          native: "我吃了臭豆腐",
          romanization: "wǒ chī le chòudòufu",
        ...
        },
        {
          type: "example",
          native: "我去了日本（上個月）",
          romanization: "wǒ qù le Rìběn (shàng ge yuè)",
        ...
        },
        {
          type: "example",
          native: "我去過日本（在我的人生中）",
          romanization: "wǒ qù guò Rìběn (zài wǒ de rénshēng zhōng)",
          translation: "Je suis déjà allé au Japon (dans ma vie)",
          content: "過 = expérience de vie, le moment exact n'est pas pertinent.",
        },
        {
          type: "example",
          native: "他看了那部電影 vs 他看過那部電影",
          romanization: "tā kàn le nà bù diànyǐng vs tā kàn guò nà bù diànyǐng",
          translation:
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我會說中文",
          romanization: "wǒ huì shuō Zhōngwén",
        ...
        },
        {
          type: "example",
          native: "我不會說日語",
          romanization: "wǒ bú huì shuō Rìyǔ",
        ...
        },
        {
          type: "example",
          native: "明天不會下雨",
          romanization: "míngtiān bú huì xiàyǔ",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "因為下雨了，所以我沒出門",
          romanization: "yīnwèi xiàyǔ le, suǒyǐ wǒ méi chūmén",
        ...
        {
          type: "example",
          native: "我吃過臭豆腐，但是我不喜歡",
          romanization: "wǒ chī guò chòudòufu, dànshì wǒ bù xǐhuān",
        ...
        },
        {
          type: "example",
          native: "我先吃了飯，然後去了學校",
          romanization: "wǒ xiān chī le fàn, ránhòu qù le xuéxiào",
        ...
        },
        {
          type: "example",
          native: "先寫完功課，再出去玩",
          romanization: "xiān xiě wán gōngkè, zài chūqù wán",
        ...
        },
        {
          type: "example",
          native: "先吃了飯再說",
          romanization: "xiān chī le fàn zài shuō",
    ...
    lines: [
      {
        speaker: "大衛",
        native: "小美，你去過日本嗎？",
        romanization: "Xiǎo Měi, nǐ qù guò Rìběn ma?",
      ...
      },
      {
        speaker: "小美",
        native: "去過，我去了兩次。你呢？",
        romanization: "qù guò, wǒ qù le liǎng cì. nǐ ne?",
        french: "Oui, j'y suis allée deux fois. Et toi ?",
        note: "去過 = oui (expérience). 去了兩次 = 了 pour le fait spécifique de deux visites.",
      },
      {
        speaker: "大衛",
        native: "我沒去過，可是我會說一點日語。",
        romanization: "wǒ méi qù guò, kěshì wǒ huì shuō yìdiǎn Rìyǔ.",
      ...
      {
        speaker: "小美",
        native: "那你以後會去嗎？日本的拉麵很好吃，你一定要吃過！",
        romanization:
      ...
      {
        speaker: "大衛",
        native: "會啊！因為我學了日語，所以我想去練習。",
        romanization: "huì a! yīnwèi wǒ xué le Rìyǔ, suǒyǐ wǒ xiǎng qù liànxí.",
        french:
      ...
      {
        speaker: "小美",
        native: "好，我們先存錢，然後一起去！",
        romanization: "hǎo, wǒmen xiān cún qián, ránhòu yìqǐ qù!",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "你去過台灣嗎？",
        romanization: "nǐ qù guò Táiwān ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "這是很好的經驗。",
        romanization: "zhè shì hěn hǎo de jīngyàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "我從來沒去過。",
        romanization: "wǒ cónglái méi qù guò.",
    ...
    },
    {
      ...
      example: {
        sentence: "以後我會去日本。",
        romanization: "yǐhòu wǒ huì qù Rìběn.",
    ...
    },
    {
      ...
      example: {
        sentence: "以前我住在法國。",
        romanization: "yǐqián wǒ zhù zài Fǎguó.",
    ...
    },
    {
      ...
      example: {
        sentence: "我先吃飯，然後去學校。",
        romanization: "wǒ xiān chīfàn, ránhòu qù xuéxiào.",
    ...
    },
    {
      ...
      example: {
        sentence: "因為下雨，我沒出門。",
        romanization: "yīnwèi xiàyǔ, wǒ méi chūmén.",
    ...
    },
    {
      ...
      example: {
        sentence: "我很累，所以想休息。",
        romanization: "wǒ hěn lèi, suǒyǐ xiǎng xiūxi.",
    ...
    },
    {
      ...
      example: {
        sentence: "我想去，可是沒有時間。",
        romanization: "wǒ xiǎng qù, kěshì méiyǒu shíjiān.",
    ...
    },
    {
      ...
      example: {
        sentence: "先休息，再工作。",
        romanization: "xiān xiūxi, zài gōngzuò.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄍㄨㄛˋ", "ㄌㄜ", "ㄏㄨㄟˋ", "ㄗㄞˋ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄏㄨㄟˋ", "ㄌㄜ", "ㄍㄨㄛˋ", "ㄎㄜˇ ㄧˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄇㄟˊ ㄔ ㄍㄨㄛˋ ㄒㄧㄠˇ ㄌㄨㄥˊ ㄅㄠ", "ㄨㄛˇ ㄇㄟˊ ㄔ ㄌㄜ ㄒㄧㄠˇ ㄌㄨㄥˊ ㄅㄠ", "ㄨㄛˇ ㄅㄨˋ ㄔ ㄍㄨㄛˋ ㄒㄧㄠˇ ㄌㄨㄥˊ ㄅㄠ", "ㄨㄛˇ ㄅㄨˊ ㄏㄨㄟˋ ㄔ ㄒㄧㄠˇ ㄌㄨㄥˊ ㄅㄠ"],
    },
    {
      id: "unit-16-ex5",
      type: "fill-blank",
      ...
      optionsReading: ["ㄏㄨㄟˋ", "ㄌㄜ", "ㄍㄨㄛˋ", "ㄧㄠˋ"],
    ...
    },
    {
      ...
      hintReading: "Structure : Sujet + Verbe + 過 + Complément + 嗎",
    },
    {
      id: "unit-16-ex10",
      type: "reorder",
      ...
      hintReading: "Structure : Sujet + 覺得 + Temps + 不會 + Verbe",
    },
  ],
