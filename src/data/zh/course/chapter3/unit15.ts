...
export const unit15: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "你吃了飯再去",
          romanization: "nǐ chī le fàn zài qù",
        ...
        },
        {
          type: "example",
          native: "明天到了台北，打電話給我",
          romanization: "míngtiān dào le Táiběi, dǎ diànhuà gěi wǒ",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我吃了三碗飯",
          romanization: "wǒ chī le sān wǎn fàn",
        ...
        },
        {
          type: "example",
          native: "我買了一本書",
          romanization: "wǒ mǎi le yì běn shū",
        ...
        },
        {
          type: "example",
          native: "她喝了兩杯咖啡",
          romanization: "tā hē le liǎng bēi kāfēi",
        ...
        },
        {
          type: "example",
          native: "我們看了一部電影",
          romanization: "wǒmen kàn le yí bù diànyǐng",
        ...
        },
        {
          type: "example",
          native: "我們見了面",
          romanization: "wǒmen jiàn le miàn",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我每天吃早餐",
          romanization: "wǒ měitiān chī zǎocān",
        ...
        },
        {
          type: "example",
          native: "他常常去圖書館",
          romanization: "tā chángcháng qù túshūguǎn",
        ...
        },
        {
          type: "example",
          native: "我沒吃早餐",
          romanization: "wǒ méi chī zǎocān",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "昨天我去了夜市 ✓ / 我每天去夜市 ✓",
          romanization: "zuótiān wǒ qù le yèshì / wǒ měitiān qù yèshì",
          translation:
        ...
        {
          type: "example",
          native: "我寫了三封信 ✓ / 我是學生 ✓ (pas de 了)",
          romanization: "wǒ xiě le sān fēng xìn / wǒ shì xuéshēng",
          translation:
        ...
        },
        {
          type: "example",
          native: "他們吃了很多小籠包",
          romanization: "tāmen chī le hěn duō xiǎolóngbāo",
    ...
    lines: [
      {
        speaker: "大衛",
        native: "小美，你昨天做了什麼？",
        romanization: "Xiǎo Měi, nǐ zuótiān zuò le shénme?",
        french: "Xiao Mei, qu'est-ce que tu as fait hier ?",
        note: "做了什麼 = structure pour demander ce qui a été fait.",
      },
      {
        speaker: "小美",
        native: "我早上去了市場，買了很多水果。",
        romanization: "wǒ zǎoshang qù le shìchǎng, mǎi le hěn duō shuǐguǒ.",
      ...
      },
      {
        speaker: "大衛",
        native: "然後呢？你吃了午飯嗎？",
        romanization: "ránhòu ne? nǐ chī le wǔfàn ma?",
        french: "Et ensuite ? Tu as déjeuné ?",
      },
      {
        speaker: "小美",
        native: "吃了，我跟朋友吃了小籠包，很好吃！",
        romanization: "chī le, wǒ gēn péngyǒu chī le xiǎolóngbāo, hěn hǎochī!",
      ...
      },
      {
        speaker: "大衛",
        native: "下午呢？你看了電影嗎？",
        romanization: "xiàwǔ ne? nǐ kàn le diànyǐng ma?",
        french: "Et l'après-midi ? Tu as regardé un film ?",
      },
      {
        speaker: "小美",
        native: "沒有，我回家寫了功課，然後休息了。",
        romanization: "méiyǒu, wǒ huíjiā xiě le gōngkè, ránhòu xiūxi le.",
        french:
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "她買了一件衣服。",
        romanization: "tā mǎi le yí jiàn yīfu.",
    ...
    },
    {
      ...
      example: {
        sentence: "我寫了一封信。",
        romanization: "wǒ xiě le yì fēng xìn.",
    ...
    },
    {
      ...
      example: {
        sentence: "我學了兩年中文。",
        romanization: "wǒ xué le liǎng nián Zhōngwén.",
    ...
    },
    {
      ...
      example: {
        sentence: "剛才下雨了。",
        romanization: "gāngcái xiàyǔ le.",
        translation: "Il a plu tout à l'heure.",
      },
    },
    {
      term: "昨天",
      romanization: "zuótiān",
      reading: "ㄗㄨㄛˊ ㄊㄧㄢ",
      french: "Hier",
      english: "Yesterday",
      example: {
        sentence: "昨天你去了哪裡？",
        romanization: "zuótiān nǐ qù le nǎlǐ?",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄔ", "ㄔ ㄌㄜ", "ㄌㄜ ㄔ", "ㄔ ㄍㄨㄛˋ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄇㄟˊ ㄔ", "ㄨㄛˇ ㄅㄨˋ ㄔ ㄌㄜ", "ㄨㄛˇ ㄇㄟˊ ㄔ ㄌㄜ", "ㄨㄛˇ ㄅㄨˋ ㄌㄜ ㄔ"],
    },
    {
      id: "unit-15-ex5",
      type: "comprehension",
      ...
      optionsReading: ["ㄨㄛˇ ㄇㄟˊ ㄑㄩˋ ㄌㄜ ㄒㄩㄝˊ ㄒㄧㄠˋ", "ㄨㄛˇ ㄑㄩˋ ㄌㄜ ㄒㄩㄝˊ ㄒㄧㄠˋ", "ㄨㄛˇ ㄇㄟˊ ㄑㄩˋ ㄒㄩㄝˊ ㄒㄧㄠˋ", "ㄨㄛˇ ㄧˇ ㄐㄧㄥ ㄑㄩˋ ㄌㄜ ㄒㄩㄝˊ ㄒㄧㄠˋ"],
      hint: "沒 et 了 peuvent-ils coexister dans une négation du passé ?",
      hintReading: "沒 et 了 peuvent-ils coexister dans une négation du passé ?",
    },
    {
      id: "unit-15-ex6",
      type: "fill-blank",
    ...
    },
    {
      ...
      hintReading: "Structure : Sujet + Verbe + 了 + Quantité + Nom",
    },
    {
      id: "unit-15-ex9",
      type: "reorder",
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄔ ㄌㄜ", "ㄨㄛˇ ㄔ ㄍㄨㄛˋ", "ㄨㄛˇ ㄗㄞˋ ㄔ", "ㄨㄛˇ ㄔ"],
    },
    {
      id: "unit-15-ex11",
      type: "translate",
      ...
      optionsReading: ["ㄊㄚ ㄗㄡˇ ㄌㄜ", "ㄊㄚ ㄗㄡˇ ㄍㄨㄛˋ", "ㄊㄚ ㄗㄞˋ ㄗㄡˇ", "ㄊㄚ ㄇㄟˊ ㄗㄡˇ ㄌㄜ"],
    },
    {
      id: "unit-15-ex12",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄇㄣ ㄇㄞˇ ㄌㄜ ㄌㄧㄤˇ ㄓㄤ ㄆㄧㄠˋ", "ㄨㄛˇ ㄇㄣ ㄇㄞˇ ㄌㄧㄤˇ ㄓㄤ ㄆㄧㄠˋ ㄌㄜ", "ㄨㄛˇ ㄇㄣ ㄇㄟˊ ㄇㄞˇ ㄌㄜ ㄆㄧㄠˋ", "ㄨㄛˇ ㄇㄣ ㄗㄞˋ ㄇㄞˇ ㄌㄧㄤˇ ㄓㄤ ㄆㄧㄠˋ"],
    },
    {
      id: "unit-15-ex13",
      type: "comprehension",
