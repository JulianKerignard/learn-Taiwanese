...
export const unit72: CourseUnit = {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "看得到 vs 看不到",
          romanization: "kàn de dào vs kàn bú dào",
        ...
        },
        {
          type: "example",
          native: "聽得懂 vs 聽不懂",
          romanization: "tīng de dǒng vs tīng bù dǒng",
        ...
        },
        {
          type: "example",
          native: "做得完 vs 做不完",
          romanization: "zuò de wán vs zuò bù wán",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我找不到公車站。",
          romanization: "wǒ zhǎo bú dào gōngchē zhàn.",
        ...
        },
        {
          type: "example",
          native: "那個演唱會的票買不到了。",
          romanization: "nà ge yǎnchànghuì de piào mǎi bú dào le.",
        ...
        },
        {
          type: "example",
          native: "你看得到那個招牌嗎？",
          romanization: "nǐ kàn de dào nà ge zhāopái ma?",
        ...
        },
        {
          type: "example",
          native: "這本書我看不懂。",
          romanization: "zhè běn shū wǒ kàn bù dǒng.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "Julian",
        native: "不好意思，我找不到這家餐廳。",
        romanization: "bù hǎo yìsi, wǒ zhǎo bú dào zhè jiā cāntīng.",
        french: "Excusez-moi, je n'arrive pas a trouver ce restaurant.",
      },
      {
        speaker: "Passant",
        native: "你看得到那個紅色的招牌嗎？",
        romanization: "nǐ kàn de dào nà ge hóngsè de zhāopái ma?",
        french: "Tu vois l'enseigne rouge la-bas ?",
      },
      {
        speaker: "Julian",
        native: "看到了！謝謝。他們的菜單我看不懂。",
        romanization: "kàn dào le! xièxie. tāmen de càidān wǒ kàn bù dǒng.",
        french: "Je la vois ! Merci. Leur menu, je ne le comprends pas.",
      },
      {
        speaker: "Passant",
        native: "沒關係，你可以看照片。你聽得懂中文嗎？",
        romanization: "méi guānxì, nǐ kěyǐ kàn zhàopiàn. nǐ tīng de dǒng zhōngwén ma?",
        french: "Pas grave, tu peux regarder les photos. Tu comprends le chinois ?",
      },
      {
        speaker: "Julian",
        native: "說慢一點的話，聽得懂一點點。",
        romanization: "shuō màn yìdiǎn de huà, tīng de dǒng yìdiǎndiǎn.",
        french: "Si on parle lentement, je comprends un petit peu.",
      },
      {
        speaker: "Passant",
        native: "你的中文學得很好！加油！",
        romanization: "nǐ de zhōngwén xué de hěn hǎo! jiāyóu!",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "你聽懂了嗎？",
        romanization: "nǐ tīng dǒng le ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "作業做完了嗎？",
        romanization: "zuòyè zuò wán le ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "你找到了嗎？",
        romanization: "nǐ zhǎo dào le ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "我學會騎腳踏車了。",
        romanization: "wǒ xué huì qí jiǎotàchē le.",
    ...
    },
    {
      ...
      example: {
        sentence: "我拿到簽證了。",
        romanization: "wǒ ná dào qiānzhèng le.",
        translation: "J'ai obtenu mon visa.",
      },
    },
    {
      term: "睡著",
      romanization: "shuì zháo",
      reading: "ㄕㄨㄟˋ ㄓㄠˊ",
      french: "s'endormir",
      english: "to fall asleep",
      example: {
        sentence: "小孩睡著了。",
        romanization: "xiǎohái shuì zháo le.",
        translation: "L'enfant s'est endormi.",
      },
    },
    {
      term: "看清楚",
      romanization: "kàn qīngchǔ",
      reading: "ㄎㄢˋ ㄑㄧㄥ ㄔㄨˇ",
      french: "voir clairement",
      english: "to see clearly",
      example: {
        sentence: "你看清楚了嗎？",
        romanization: "nǐ kàn qīngchǔ le ma?",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄎㄢˋ ㄉㄠˋ", "ㄎㄢˋ ㄐㄧㄢˋ", "ㄓㄠˇ ㄉㄠˋ", "ㄊㄧㄥ ㄉㄠˋ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄢˊ", "ㄉㄠˋ", "ㄏㄠˇ", "ㄉㄨㄥˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄏㄨㄟˋ", "ㄨㄢˊ", "ㄉㄠˋ", "ㄏㄠˇ"],
