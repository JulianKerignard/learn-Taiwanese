  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "A: 你好，請問捷運站怎麼走？B: 往前走，到紅綠燈左轉，大概五分鐘就到了。A: 謝謝！",
          romanization: "A: nǐ hǎo, qǐngwèn jiéyùn zhàn zěnme zǒu? B: wǎng qián zǒu, dào hónglǜdēng zuǒ zhuǎn, dàgài wǔ fēnzhōng jiù dào le. A: xièxie!",
          translation:
        ...
        {
          type: "example",
          native: "A: 明天天氣怎麼樣？B: 明天會下雨，你要帶雨傘。A: 好，謝謝你告訴我。",
          romanization: "A: míngtiān tiānqì zěnmeyàng? B: míngtiān huì xiàyǔ, nǐ yào dài yǔsǎn. A: hǎo, xièxie nǐ gàosù wǒ.",
          translation:
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "我叫小美，今年二十歲，是大學生。我住在台北，每天坐捷運去學校。我喜歡吃台灣的小吃，最喜歡珍珠奶茶和滷肉飯。週末的時候，我常常和朋友去夜市。",
          romanization: "wǒ jiào Xiǎoměi, jīnnián èrshí suì, shì dàxuéshēng. wǒ zhù zài Táiběi, měitiān zuò jiéyùn qù xuéxiào. wǒ xǐhuān chī Táiwān de xiǎochī, zuì xǐhuān zhēnzhū nǎichá hé lǔròufàn. zhōumò de shíhòu, wǒ chángcháng hé péngyǒu qù yèshì.",
          translation:
        ...
        {
          type: "example",
          native: "這是我的房間。房間裡有一張床、一張桌子和一把椅子。桌子上面有很多書和一台電腦。窗戶旁邊有一隻貓，牠很喜歡在那裡睡覺。",
          romanization: "zhè shì wǒ de fángjiān. fángjiān lǐ yǒu yì zhāng chuáng, yì zhāng zhuōzi hé yì bǎ yǐzi. zhuōzi shàngmiàn yǒu hěn duō shū hé yì tái diànnǎo. chuānghù pángbiān yǒu yì zhī māo, tā hěn xǐhuān zài nàlǐ shuìjiào.",
          translation:
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "A: 你好，我要一杯珍珠奶茶。B: 好的，大杯還是小杯？A: 大杯，少糖少冰。B: 一共六十塊。",
          romanization: "A: nǐ hǎo, wǒ yào yì bēi zhēnzhū nǎichá. B: hǎo de, dà bēi háishì xiǎo bēi? A: dà bēi, shǎo táng shǎo bīng. B: yígòng liùshí kuài.",
          translation:
        ...
        {
          type: "example",
          native: "A: 明天下午三點，我們在捷運站見面，好不好？B: 好啊！我先吃完午餐，然後就過去。",
          romanization: "A: míngtiān xiàwǔ sān diǎn, wǒmen zài jiéyùn zhàn jiànmiàn, hǎo bù hǎo? B: hǎo a! wǒ xiān chī wán wǔcān, ránhòu jiù guòqù.",
          translation:
