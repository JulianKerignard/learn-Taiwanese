...
export const unit10: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "太貴了！可以便宜一點嗎？",
          romanization: "tài guì le! kěyǐ piányí yìdiǎn ma?",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "現金還是刷卡？",
          romanization: "xiànjīn háishì shuākǎ?",
        ...
        },
        {
          type: "example",
          native: "可以用悠遊卡嗎？",
          romanization: "kěyǐ yòng Yōuyóu kǎ ma?",
        ...
        },
        {
          type: "example",
          native: "不用袋子，謝謝",
          romanization: "bùyòng dàizi, xièxiè",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "可以幫我加熱嗎？",
          romanization: "kěyǐ bāng wǒ jiārè ma?",
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        speaker: "Vendeur",
        native: "三百五十塊。",
        romanization: "sān bǎi wǔshí kuài.",
        french: "350 dollars.",
      },
      {
        speaker: "Vous",
        native: "太貴了！便宜一點可以嗎？",
        romanization: "tài guì le! piányí yìdiǎn kěyǐ ma?",
        french: "Trop cher ! Un peu moins cher, c'est possible ?",
      },
      {
        speaker: "Vendeur",
        native: "好吧，三百塊。",
        romanization: "hǎo ba, sān bǎi kuài.",
      ...
      },
      {
        speaker: "Vous",
        native: "好，可以刷卡嗎？",
        romanization: "hǎo, kěyǐ shuākǎ ma?",
        french: "D'accord, je peux payer par carte ?",
      },
      {
        speaker: "Vendeur",
        native: "不好意思，只收現金。",
        romanization: "bù hǎoyìsi, zhǐ shōu xiànjīn.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "夜市的東西很便宜。",
        romanization: "yèshì de dōngxi hěn piányí.",
    ...
    },
    {
      ...
      example: {
        sentence: "要大的還是小的？",
        romanization: "yào dà de háishì xiǎo de?",
    ...
    },
    {
      ...
      example: {
        sentence: "不要袋子，謝謝。",
        romanization: "bú yào dàizi, xièxiè.",
    ...
    },
    {
      ...
      example: {
        sentence: "便宜一點可以嗎？",
        romanization: "piányí yìdiǎn kěyǐ ma?",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄉㄨㄛ ㄕㄠˇ ㄑㄧㄢˊ?", "ㄗㄣˇ ㄇㄜ ㄇㄞˋ?", "ㄊㄞˋ ㄍㄨㄟˋ ㄌㄜ?", "ㄐㄧˇ ㄎㄨㄞˋ ㄑㄧㄢˊ?"],
    },
    {
      id: "unit-10-ex2",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄍㄨㄟˋ", "ㄆㄧㄢˊ ㄧ", "ㄉㄚˋ", "ㄏㄠˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄆㄧㄢˊ ㄧ", "ㄍㄨㄟˋ", "ㄉㄚˋ", "ㄏㄠˇ"],
