...
export const unit70: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "他是我的老師，他在學校，他有很多學生。",
          romanization: "tā shì wǒ de lǎoshī, tā zài xuéxiào, tā yǒu hěn duō xuéshēng.",
          translation:
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "超商在學校的旁邊，銀行在超商的對面。",
          romanization: "chāoshāng zài xuéxiào de pángbiān, yínháng zài chāoshāng de duìmiàn.",
          translation:
        ...
        {
          type: "example",
          native: "我每天早上七點起床，先吃早餐，然後坐捷運去上班。",
          romanization: "wǒ měitiān zǎoshang qī diǎn qǐchuáng, xiān chī zǎocān, ránhòu zuò jiéyùn qù shàngbān.",
          translation:
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄇㄟˊ", "ㄅㄨˋ", "ㄇㄟˊ ㄧㄡˇ", "ㄅㄨˊ ㄕˋ"],
