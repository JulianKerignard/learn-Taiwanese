...
export const unit11: CourseUnit = {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我要去台北車站",
          romanization: "wǒ yào qù Táiběi chēzhàn",
        ...
        },
        {
          type: "example",
          native: "坐到台北車站",
          romanization: "zuò dào Táiběi chēzhàn",
        ...
        },
        {
          type: "example",
          native: "在忠孝復興站轉藍線",
          romanization: "zài Zhōngxiào Fùxīng zhàn zhuǎn lán xiàn",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "可以加值五百嗎？",
          romanization: "kěyǐ jiāzhí wǔbǎi ma?",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "Vous",
        native: "請問，去台北一零一要坐哪一線？",
        romanization: "qǐngwèn, qù Táiběi yī líng yī yào zuò nǎ yī xiàn?",
        french: "Excusez-moi, pour aller à Taipei 101, quelle ligne je prends ?",
      },
      {
        speaker: "Passant",
        native: "你坐紅線到台北一零一站。",
        romanization: "nǐ zuò hóng xiàn dào Táiběi yī líng yī zhàn.",
        french: "Tu prends la ligne rouge jusqu'à la station Taipei 101.",
      },
      {
        speaker: "Vous",
        native: "要轉線嗎？",
        romanization: "yào zhuǎn xiàn ma?",
        french: "Il faut changer de ligne ?",
      },
      {
        speaker: "Passant",
        native: "不用，直接到。三站就到了。",
        romanization: "bùyòng, zhíjiē dào. sān zhàn jiù dào le.",
        french: "Non, c'est direct. Trois stations et tu y es.",
        note: "不用 (bùyòng) = pas besoin. 直接 (zhíjiē) = directement.",
      },
      {
        speaker: "Vous",
        native: "謝謝！（後來坐計程車）師傅，我要去西門町。",
        romanization: "xièxiè! (hòulái zuò jìchéngchē) shīfu, wǒ yào qù Xīméndīng.",
      ...
      },
      {
        speaker: "Chauffeur",
        native: "好，大概十五分鐘到。",
        romanization: "hǎo, dàgài shíwǔ fēnzhōng dào.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我坐捷運上班。",
        romanization: "wǒ zuò jiéyùn shàngbān.",
    ...
    },
    {
      ...
      example: {
        sentence: "我們坐計程車去吧。",
        romanization: "wǒmen zuò jìchéngchē qù ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "坐高鐵去高雄。",
        romanization: "zuò gāotiě qù Gāoxióng.",
    ...
    },
    {
      ...
      example: {
        sentence: "坐捷運比較快。",
        romanization: "zuò jiéyùn bǐjiào kuài.",
    ...
    },
    {
      ...
      example: {
        sentence: "下一站下車。",
        romanization: "xià yí zhàn xià chē.",
    ...
    },
    {
      ...
      example: {
        sentence: "在這裡轉藍線。",
        romanization: "zài zhèlǐ zhuǎn lán xiàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "用悠遊卡比較便宜。",
        romanization: "yòng Yōuyóu kǎ bǐjiào piányí.",
    ...
    },
    {
      ...
      example: {
        sentence: "我要加值兩百。",
        romanization: "wǒ yào jiāzhí liǎng bǎi.",
    ...
    },
    {
      ...
      example: {
        sentence: "高鐵票多少錢？",
        romanization: "gāotiě piào duōshǎo qián?",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄧㄠˋ ㄑㄩˋ ㄊㄞˊ ㄅㄟˇ ㄔㄜ ㄓㄢˋ", "ㄨㄛˇ ㄗㄞˋ ㄊㄞˊ ㄅㄟˇ ㄔㄜ ㄓㄢˋ", "ㄊㄞˊ ㄅㄟˇ ㄔㄜ ㄓㄢˋ ㄗㄞˋ ㄋㄚˇ ㄌㄧˇ", "ㄨㄛˇ ㄗㄨㄛˋ ㄊㄞˊ ㄅㄟˇ ㄔㄜ ㄓㄢˋ"],
    },
    {
      id: "unit-11-ex2",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄗㄨㄛˋ", "ㄑㄩˋ", "ㄉㄠˋ", "ㄗㄡˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄉㄠˋ", "ㄑㄩˋ", "ㄗㄨㄛˋ", "ㄗㄡˇ"],
