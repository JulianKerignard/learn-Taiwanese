...
export const unit62: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "今天是晴天，沒有雲。",
          romanization: "jīntiān shì qíngtiān, méiyǒu yún.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "今天很熱，溫度三十五度。",
          romanization: "jīntiān hěn rè, wēndù sānshíwǔ dù.",
        ...
        },
        {
          type: "example",
          native: "下午不會下雨。",
          romanization: "xiàwǔ bú huì xiàyǔ.",
        ...
        },
        {
          type: "example",
          native: "天氣越來越熱了。",
          romanization: "tiānqì yuè lái yuè rè le.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "颱風要來了，你要小心！",
          romanization: "táifēng yào lái le, nǐ yào xiǎoxīn!",
        ...
        },
        {
          type: "example",
          native: "梅雨季節快到了。",
          romanization: "méiyǔ jìjié kuài dào le.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "小美",
        native: "今天是晴天，但是很熱。溫度三十三度。",
        romanization: "jīntiān shì qíngtiān, dànshì hěn rè. wēndù sānshísān dù.",
        french:
      ...
      },
      {
        speaker: "Thomas",
        native: "明天會下雨嗎？",
        romanization: "míngtiān huì xiàyǔ ma?",
        french: "Est-ce qu'il va pleuvoir demain ?",
      },
      {
        speaker: "小美",
        native: "新聞說明天下午會下雨，你要帶傘。",
        romanization: "xīnwén shuō míngtiān xiàwǔ huì xiàyǔ, nǐ yào dài sǎn.",
        french:
      ...
      },
      {
        speaker: "Thomas",
        native: "天氣越來越熱了，是不是？",
        romanization: "tiānqì yuè lái yuè rè le, shì bú shì?",
        french: "Il fait de plus en plus chaud, n'est-ce pas ?",
        note: "是不是 en fin de phrase sert de question de confirmation.",
      },
      {
        speaker: "小美",
        native: "對啊，而且這個星期可能有颱風。",
        romanization: "duì a, érqiě zhège xīngqī kěnéng yǒu táifēng.",
      ...
      },
      {
        speaker: "Thomas",
        native: "颱風？那會很冷嗎？",
        romanization: "táifēng? nà huì hěn lěng ma?",
        french: "Un typhon ? Alors il fera froid ?",
      },
      {
        speaker: "小美",
        native: "不會冷，但是風很大，雨也很大。颱風天要待在家裡！",
        romanization:
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "太陽很大，要戴帽子。",
        romanization: "tàiyáng hěn dà, yào dài màozi.",
    ...
    },
    {
      ...
      example: {
        sentence: "颱風快來了！",
        romanization: "táifēng kuài lái le!",
    ...
    },
    {
      ...
      example: {
        sentence: "冬天有時候很冷。",
        romanization: "dōngtiān yǒu shíhòu hěn lěng.",
    ...
    },
    {
      ...
      example: {
        sentence: "秋天的天氣很涼快。",
        romanization: "qiūtiān de tiānqì hěn liángkuài.",
    ...
    },
    {
      ...
      example: {
        sentence: "今天風很大。",
        romanization: "jīntiān fēng hěn dà.",
    ...
    },
    {
      ...
      example: {
        sentence: "天上有很多雲。",
        romanization: "tiānshàng yǒu hěn duō yún.",
    ...
    },
    {
      ...
      example: {
        sentence: "山上在下雪。",
        romanization: "shānshàng zài xiàxuě.",
    ...
    },
    {
      ...
      example: {
        sentence: "外面在打雷。",
        romanization: "wàimiàn zài dǎléi.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄏㄨㄟˋ", "ㄗㄞˋ", "ㄏㄣˇ", "ㄌㄜ˙"],
