...
export const unit08: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "銀行在左邊",
          romanization: "yínháng zài zuǒbiān",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "捷運站在前面",
          romanization: "jiéyùn zhàn zài qiánmiàn",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "請問，出口三在哪裡？",
          romanization: "qǐngwèn, chūkǒu sān zài nǎlǐ?",
        ...
        },
        {
          type: "example",
          native: "我要在下一站下車",
          romanization: "wǒ yào zài xià yí zhàn xià chē",
    ...
    lines: [
      {
        speaker: "A",
        native: "請問，台北車站在哪裡？",
        romanization: "qǐngwèn, Táiběi chēzhàn zài nǎlǐ?",
        french: "Excusez-moi, où est la gare de Taipei ?",
      },
      {
        speaker: "B",
        native: "台北車站在前面，直走大概五分鐘。",
        romanization: "Táiběi chēzhàn zài qiánmiàn, zhí zǒu dàgài wǔ fēnzhōng.",
      ...
      },
      {
        speaker: "A",
        native: "捷運站也在那裡嗎？",
        romanization: "jiéyùn zhàn yě zài nàlǐ ma?",
        french: "La station de MRT est aussi là-bas ?",
      },
      {
        speaker: "B",
        native: "對，在車站的下面。你從出口一進去。",
        romanization: "duì, zài chēzhàn de xiàmiàn. nǐ cóng chūkǒu yī jìnqù.",
        french: "Oui, en dessous de la gare. Tu entres par la sortie 1.",
      },
      {
        speaker: "A",
        native: "好的，往前走，出口一，謝謝！",
        romanization: "hǎo de, wǎng qián zǒu, chūkǒu yī, xièxiè!",
        french: "D'accord, tout droit, sortie 1, merci !",
      },
      {
        speaker: "B",
        native: "不客氣！直走就到了。",
        romanization: "bú kèqì! zhí zǒu jiù dào le.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "車站在前面。",
        romanization: "chēzhàn zài qiánmiàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "廁所在後面。",
        romanization: "cèsuǒ zài hòumiàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "直走五分鐘就到了。",
        romanization: "zhí zǒu wǔ fēnzhōng jiù dào le.",
    ...
    },
    {
      ...
      example: {
        sentence: "捷運站在那裡。",
        romanization: "jiéyùn zhàn zài nàlǐ.",
    ...
    },
    {
      ...
      example: {
        sentence: "出口在左邊。",
        romanization: "chūkǒu zài zuǒbiān.",
    ...
    },
    {
      ...
      example: {
        sentence: "下一站是台北車站。",
        romanization: "xià yí zhàn shì Táiběi chēzhàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "銀行在對面。",
        romanization: "yínháng zài duìmiàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "廁所在旁邊。",
        romanization: "cèsuǒ zài pángbiān.",
    ...
    },
    {
      ...
      example: {
        sentence: "捷運站很遠嗎？",
        romanization: "jiéyùn zhàn hěn yuǎn ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "超市很近，走路五分鐘。",
        romanization: "chāoshì hěn jìn, zǒulù wǔ fēnzhōng.",
    ...
    },
    {
      ...
      example: {
        sentence: "我在找捷運站。",
        romanization: "wǒ zài zhǎo jiéyùn zhàn.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄐㄧㄝˊ ㄩㄣˋ ㄓㄢˋ ㄗㄞˋ ㄋㄚˇ ㄌㄧˇ?", "ㄋㄚˇ ㄌㄧˇ ㄗㄞˋ ㄐㄧㄝˊ ㄩㄣˋ ㄓㄢˋ?", "ㄐㄧㄝˊ ㄩㄣˋ ㄓㄢˋ ㄑㄩˋ ㄋㄚˇ ㄌㄧˇ?", "ㄗㄞˋ ㄐㄧㄝˊ ㄩㄣˋ ㄓㄢˋ ㄋㄚˇ ㄌㄧˇ?"],
    },
    {
      id: "unit-08-ex2",
      type: "fill-blank",
      ...
      optionsReading: ["ㄗㄨㄛˇ", "ㄧㄡˋ", "ㄑㄧㄢˊ", "ㄏㄡˋ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄑㄧㄢˊ", "ㄏㄡˋ", "ㄗㄨㄛˇ", "ㄕㄤˋ"],
