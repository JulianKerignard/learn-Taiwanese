...
export const unit66: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "吃早餐、出門",
          romanization: "chī zǎocān, chūmén",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我先刷牙，然後洗臉。",
          romanization: "wǒ xiān shuā yá, ránhòu xǐ liǎn.",
        ...
        },
        {
          type: "example",
          native: "我先吃早餐，然後出門上班。",
          romanization: "wǒ xiān chī zǎocān, ránhòu chūmén shàngbān.",
        ...
        },
        {
          type: "example",
          native: "我每天六點半起床。",
          romanization: "wǒ měitiān liù diǎn bàn qǐchuáng.",
        ...
        },
        {
          type: "example",
          native: "我每個星期運動三次。",
          romanization: "wǒ měi gè xīngqī yùndòng sān cì.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我早上七點去早餐店吃早餐。",
          romanization: "wǒ zǎoshàng qī diǎn qù zǎocān diàn chī zǎocān.",
        ...
        },
        {
          type: "example",
          native: "我們晚上八點才吃晚餐。",
          romanization: "wǒmen wǎnshàng bā diǎn cái chī wǎncān.",
        ...
        },
        {
          type: "example",
          native: "下班以後，我去夜市吃東西。",
          romanization: "xiàbān yǐhòu, wǒ qù yèshì chī dōngxī.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "Marc",
        native: "你去外面吃早餐嗎？在法國，我們都在家裡吃。",
        romanization: "nǐ qù wàimiàn chī zǎocān ma? zài fàguó, wǒmen dōu zài jiālǐ chī.",
        french:
          "Tu vas manger le petit-déjeuner dehors ? En France, on mange tous à la maison.",
      },
      {
        speaker: "小美",
        native: "對啊，台灣人很多都去早餐店。又快又便宜！你幾點上班？",
        romanization:
      ...
      },
      {
        speaker: "小美",
        native: "哈哈！你下班以後做什麼？",
        romanization: "hāhā! nǐ xiàbān yǐhòu zuò shénme?",
        french: "Haha ! Qu'est-ce que tu fais après le travail ?",
      },
      {
        speaker: "Marc",
        native: "我先回家洗澡，然後去夜市吃晚餐。我每天都去散步。",
        romanization:
      ...
      {
        speaker: "小美",
        native: "很好！台灣的生活很舒服吧。你幾點睡覺？",
        romanization: "hěn hǎo! táiwān de shēnghuó hěn shūfú ba. nǐ jǐ diǎn shuìjiào?",
        french:
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "我在早餐店吃早餐。",
        romanization: "wǒ zài zǎocān diàn chī zǎocān.",
    ...
    },
    {
      ...
      example: {
        sentence: "我八點出門。",
        romanization: "wǒ bā diǎn chūmén.",
    ...
    },
    {
      ...
      example: {
        sentence: "你每天幾點上班？",
        romanization: "nǐ měitiān jǐ diǎn shàngbān?",
    ...
    },
    {
      ...
      example: {
        sentence: "午休的時候我會睡一下。",
        romanization: "wǔxiū de shíhòu wǒ huì shuì yíxià.",
    ...
    },
    {
      ...
      example: {
        sentence: "我六點下班。",
        romanization: "wǒ liù diǎn xiàbān.",
    ...
    },
    {
      ...
      example: {
        sentence: "下班以後我就回家。",
        romanization: "xiàbān yǐhòu wǒ jiù huíjiā.",
    ...
    },
    {
      ...
      example: {
        sentence: "我晚上洗澡。",
        romanization: "wǒ wǎnshàng xǐzǎo.",
    ...
    {
      term: "準時",
      romanization: "zhǔnshí",
      reading: "ㄓㄨㄣˇ ㄕˊ",
      french: "Ponctuel / à l'heure",
      english: "On time / punctual",
      example: {
        sentence: "他每天都很準時。",
        romanization: "tā měitiān dōu hěn zhǔnshí.",
    ...
    },
    {
      ...
      example: {
        sentence: "你累了，休息一下吧。",
        romanization: "nǐ lèi le, xiūxí yíxià ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "我喜歡晚上去散步。",
        romanization: "wǒ xǐhuān wǎnshàng qù sànbù.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄇㄟˇ ㄊㄧㄢ", "ㄇㄟˇ ㄍㄜˋ", "ㄔㄤˊ ㄔㄤˊ", "ㄉㄡ ㄕˋ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄘˋ", "ㄍㄜˋ", "ㄊㄧㄢ", "ㄏㄨㄟˊ"],
