...
export const unit45: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "哥哥、姐姐、弟弟、妹妹",
          romanization: "gēge, jiějie, dìdi, mèimei",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我有兩個哥哥。",
          romanization: "wǒ yǒu liǎng gè gēge.",
        ...
        },
        {
          type: "example",
          native: "你有沒有弟弟？",
          romanization: "nǐ yǒu méiyǒu dìdi?",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我們全家一起住。",
          romanization: "wǒmen quánjiā yìqǐ zhù.",
        ...
        },
        {
          type: "example",
          native: "家人最重要。",
          romanization: "jiārén zuì zhòngyào.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        speaker: "Paul",
        native: "你哥哥做什麼工作？",
        romanization: "nǐ gēge zuò shénme gōngzuò?",
        french: "Ton grand frère fait quoi comme travail ?",
      },
      {
        speaker: "小明",
        native: "他是老師。他在大學教書。你呢？你有沒有兄弟姐妹？",
        romanization:
      ...
      },
      {
        speaker: "Paul",
        native: "我有一個姐姐。她是學生。",
        romanization: "wǒ yǒu yí gè jiějie. tā shì xuéshēng.",
        french: "J'ai une grande sœur. Elle est étudiante.",
      },
      {
        speaker: "小明",
        native: "你的爸爸媽媽住在法國嗎？",
        romanization: "nǐ de bàba māma zhù zài fàguó ma?",
        french: "Tes parents habitent en France ?",
      },
      {
        speaker: "Paul",
        native: "對，他們住在巴黎。我很想他們。",
        romanization: "duì, tāmen zhù zài bālí. wǒ hěn xiǎng tāmen.",
        french: "Oui, ils habitent à Paris. Ils me manquent beaucoup.",
        note: "想 (xiǎng) ici signifie « penser à / manquer ».",
      },
      {
        speaker: "小明",
        native: "家人最重要。你可以常常打電話給他們啊！",
        romanization:
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我爸爸是醫生。",
        romanization: "wǒ bàba shì yīshēng.",
    ...
    },
    {
      ...
      example: {
        sentence: "姐姐在台北工作。",
        romanization: "jiějie zài táiběi gōngzuò.",
    ...
    },
    {
      ...
      example: {
        sentence: "弟弟還在上學。",
        romanization: "dìdi hái zài shàngxué.",
    ...
    },
    {
      ...
      example: {
        sentence: "我妹妹很可愛。",
        romanization: "wǒ mèimei hěn kě'ài.",
    ...
    },
    {
      ...
      example: {
        sentence: "他的兒子三歲了。",
        romanization: "tā de érzi sān suì le.",
    ...
    },
    {
      ...
      example: {
        sentence: "她的女兒很聰明。",
        romanization: "tā de nǚ'ér hěn cōngmíng.",
        translation: "Sa fille est très intelligente.",
      },
    },
    {
      term: "先生",
      romanization: "xiānshēng",
      reading: "ㄒㄧㄢ ㄕㄥ",
      french: "Mari / Monsieur",
      english: "Husband / Mr.",
      example: {
        sentence: "我先生是法國人。",
        romanization: "wǒ xiānshēng shì fàguó rén.",
    ...
    },
    {
      ...
      example: {
        sentence: "他太太是台灣人。",
        romanization: "tā tàitai shì táiwān rén.",
    ...
    },
    {
      ...
      example: {
        sentence: "老師教我們中文。",
        romanization: "lǎoshī jiāo wǒmen zhōngwén.",
    ...
    },
    {
      ...
      example: {
        sentence: "我是大學生。",
        romanization: "wǒ shì dàxuéshēng.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄇㄟˊ ㄧㄡˇ", "ㄅㄨˋ", "ㄇㄟˊ", "ㄅㄨˋ ㄧㄡˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄍㄜˋ", "ㄨㄟˋ", "ㄎㄡˇ", "ㄒㄧㄝ"],
