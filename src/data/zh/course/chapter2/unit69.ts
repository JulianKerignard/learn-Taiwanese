  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "今天很熱，我想喝冰的飲料。",
          romanization: "jīntiān hěn rè, wǒ xiǎng hē bīng de yǐnliào.",
        ...
        },
        {
          type: "example",
          native: "我吃太多了，頭很痛。",
          romanization: "wǒ chī tài duō le, tóu hěn tòng.",
        ...
        },
        {
          type: "example",
          native: "下雨了，我沒帶外套。",
          romanization: "xià yǔ le, wǒ méi dài wàitào.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "有沒有大一點的？我要藍色的。",
          romanization: "yǒu méiyǒu dà yìdiǎn de? wǒ yào lán sè de.",
        ...
        {
          type: "example",
          native: "這家比較便宜，可是那家比較好吃。",
          romanization: "zhè jiā bǐjiào piányi, kěshì nà jiā bǐjiào hǎochī.",
        ...
        },
        {
          type: "example",
          native: "他穿紅色的衣服，很高。",
          romanization: "tā chuān hóngsè de yīfu, hěn gāo.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "叔叔阿姨好，我是小明的朋友，我叫Pierre。",
          romanization: "shūshu āyí hǎo, wǒ shì Xiǎo Míng de péngyǒu, wǒ jiào Pierre.",
        ...
        {
          type: "example",
          native: "我家有四個人：爸爸、媽媽、姊姊和我。",
          romanization: "wǒ jiā yǒu sì ge rén: bàba, māma, jiějie hé wǒ.",
        ...
        {
          type: "example",
          native: "謝謝你們的招待，我先走了，下次再見！",
          romanization: "xièxie nǐmen de zhāodài, wǒ xiān zǒu le, xià cì zàijiàn!",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄅㄧㄥ", "ㄖㄜˋ", "ㄊㄧㄢˊ", "ㄉㄚˋ"],
    ...
    },
    {
      ...
      hintReading: "Structure : A + 比較 + Adj1 + 可是 + B + 比較 + Adj2",
    },
    {
      id: "unit-69-ex6",
      type: "fill-blank",
      ...
      optionsReading: ["ㄔㄨㄢ", "ㄉㄞˋ", "ㄇㄞˇ", "ㄎㄢˋ"],
    ...
    },
    {
      ...
      hintReading: "Structure : Remerciement + Complément + Sujet + 先走了",
    },
    {
      id: "unit-69-ex10",
      type: "listen",
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄞˋ ㄊㄠˋ", "ㄇㄠˋ ˙ㄗ", "ㄒㄧㄝˊ ˙ㄗ", "ㄕㄡˇ ㄐㄧ"],
