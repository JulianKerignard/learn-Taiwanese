...
export const unit46: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "今天是三月二十六號。",
          romanization: "jīntiān shì sān yuè èrshíliù hào.",
        ...
        },
        {
          type: "example",
          native: "你的生日是幾月幾號？",
          romanization: "nǐ de shēngrì shì jǐ yuè jǐ hào?",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我們明天下午見面。",
          romanization: "wǒmen míngtiān xiàwǔ jiànmiàn.",
        ...
        },
        {
          type: "example",
          native: "你明天早上有沒有空？",
          romanization: "nǐ míngtiān zǎoshang yǒu méiyǒu kòng?",
        ...
        },
        {
          type: "example",
          native: "我們約星期六，好不好？",
          romanization: "wǒmen yuē xīngqīliù, hǎo bù hǎo?",
        ...
        },
        {
          type: "example",
          native: "等一下！我還沒準備好。",
          romanization: "děng yíxià! wǒ hái méi zhǔnbèi hǎo.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "不好意思，我會晚一點到。",
          romanization: "bù hǎo yìsi, wǒ huì wǎn yìdiǎn dào.",
        ...
        },
        {
          type: "example",
          native: "今天晚上要不要一起吃飯？",
          romanization: "jīntiān wǎnshàng yào bú yào yìqǐ chīfàn?",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "小華",
        native: "小芳，你這個星期六有沒有空？",
        romanization: "xiǎo fāng, nǐ zhège xīngqīliù yǒu méiyǒu kòng?",
        french: "Xiao Fang, tu es libre ce samedi ?",
        note: "有沒有空 pour demander la disponibilité.",
      },
      {
        speaker: "小芳",
        native: "星期六早上我有課，下午就有空了。怎麼了？",
        romanization:
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "昨天我很忙。",
        romanization: "zuótiān wǒ hěn máng.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個星期你忙嗎？",
        romanization: "zhège xīngqī nǐ máng ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "現在是三月。",
        romanization: "xiànzài shì sān yuè.",
    ...
    },
    {
      ...
      example: {
        sentence: "我們約明天見面。",
        romanization: "wǒmen yuē míngtiān jiànmiàn.",
        translation: "On se donne rendez-vous demain.",
      },
    },
    {
      term: "時間",
      romanization: "shíjiān",
      reading: "ㄕˊ ㄐㄧㄢ",
      french: "Temps / Heure",
      english: "Time",
      example: {
    ...
    },
    {
      ...
      example: {
        sentence: "下午我要去上課。",
        romanization: "xiàwǔ wǒ yào qù shàngkè.",
        translation: "Cet après-midi je vais en cours.",
      },
    },
    {
      term: "晚上",
      romanization: "wǎnshàng",
      reading: "ㄨㄢˇ ㄕㄤˋ",
      french: "Soir",
      english: "Evening",
      example: {
        sentence: "晚上要不要一起吃飯？",
        romanization: "wǎnshàng yào bú yào yìqǐ chīfàn?",
        translation: "Ce soir on mange ensemble ?",
      },
    },
    {
      term: "等一下",
      romanization: "děng yíxià",
      reading: "ㄉㄥˇ ㄧˊ ㄒㄧㄚˋ",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄒㄧㄥ ㄑㄧ", "ㄌㄧˇ ㄅㄞˋ", "ㄩㄝˋ", "ㄏㄠˋ"],
