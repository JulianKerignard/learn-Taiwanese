...
export const unit65: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "上面、下面",
          romanization: "shàngmiàn, xiàmiàn",
        ...
        },
        {
          type: "example",
          native: "旁邊、對面、中間",
          romanization: "pángbiān, duìmiàn, zhōngjiān",
        ...
        },
        {
          type: "example",
          native: "附近有沒有銀行？",
          romanization: "fùjìn yǒu méiyǒu yínháng?",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "郵局在銀行旁邊。",
          romanization: "yóujú zài yínháng pángbiān.",
        ...
        },
        {
          type: "example",
          native: "超市離這裡很近。",
          romanization: "chāoshì lí zhèlǐ hěn jìn.",
        ...
        },
        {
          type: "example",
          native: "公園離車站很遠嗎？",
          romanization: "gōngyuán lí chēzhàn hěn yuǎn ma?",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "台北市大安區忠孝東路三段100巷5弄12號3樓",
          romanization: "táiběi shì dà'ān qū zhōngxiào dōng lù sān duàn yī bǎi xiàng wǔ nòng shí'èr hào sān lóu",
        ...
        },
        {
          type: "example",
          native: "你住幾巷幾號？",
          romanization: "nǐ zhù jǐ xiàng jǐ hào?",
        ...
        {
          type: "example",
          native: "這附近有便利商店嗎？—— 前面那個巷子裡面有一家7-11。",
          romanization: "zhè fùjìn yǒu biànlì shāngdiàn ma? —— qiánmiàn nàge xiàngzi lǐmiàn yǒu yì jiā qī-shíyī.",
    ...
    lines: [
      {
        speaker: "Sophie",
        native: "不好意思，請問郵局在哪裡？",
        romanization: "bù hǎoyìsi, qǐngwèn yóujú zài nǎlǐ?",
        french: "Excusez-moi, où est la poste ?",
        note: "不好意思 + 請問 est la combinaison la plus polie pour aborder un inconnu.",
      },
      {
        speaker: "路人",
        native: "郵局啊？離這裡不遠。你往前走，大概五分鐘。",
        romanization: "yóujú a? lí zhèlǐ bù yuǎn. nǐ wǎng qián zǒu, dàgài wǔ fēnzhōng.",
        french:
      ...
      },
      {
        speaker: "Sophie",
        native: "往前走就可以看到嗎？",
        romanization: "wǎng qián zǒu jiù kěyǐ kàndào ma?",
        french: "En marchant tout droit, je la verrai ?",
      },
      {
        speaker: "路人",
        native: "不是直走。你先往前走到路口，然後右轉。郵局在銀行旁邊，7-11的對面。",
        romanization: "bú shì zhí zǒu. nǐ xiān wǎng qián zǒu dào lùkǒu, ránhòu yòu zhuǎn. yóujú zài yínháng pángbiān, qī-shíyī de duìmiàn.",
        french:
      ...
      {
        speaker: "Sophie",
        native: "好的。從這裡到那裡大概要多久？",
        romanization: "hǎo de. cóng zhèlǐ dào nàlǐ dàgài yào duōjiǔ?",
      ...
      {
        speaker: "路人",
        native: "走路大概五分鐘。郵局在一條小巷子裡面，不要走過頭了。",
        romanization: "zǒulù dàgài wǔ fēnzhōng. yóujú zài yì tiáo xiǎo xiàngzi lǐmiàn, bú yào zǒu guòtóu le.",
        french:
      ...
      },
      {
        speaker: "Sophie",
        native: "我知道了！非常感謝！",
        romanization: "wǒ zhīdào le! fēicháng gǎnxiè!",
        french: "J'ai compris ! Merci beaucoup !",
      },
      {
        speaker: "路人",
        native: "不客氣！慢走啊！",
        romanization: "bú kèqì! mànzǒu a!",
  ...
  vocabulary: [
    {
      term: "上面",
      romanization: "shàngmiàn",
      reading: "ㄕㄤˋ ㄇㄧㄢˋ",
      french: "Au-dessus / Dessus",
      english: "Above / On top",
      example: {
        sentence: "書在桌子上面。",
        romanization: "shū zài zhuōzi shàngmiàn.",
        translation: "Le livre est sur la table.",
      },
    },
    {
      term: "下面",
      romanization: "xiàmiàn",
      reading: "ㄒㄧㄚˋ ㄇㄧㄢˋ",
      french: "En dessous / Dessous",
      english: "Below / Under",
      example: {
        sentence: "貓在椅子下面。",
        romanization: "māo zài yǐzi xiàmiàn.",
    ...
    {
      term: "對面",
      romanization: "duìmiàn",
      reading: "ㄉㄨㄟˋ ㄇㄧㄢˋ",
      french: "En face",
      english: "Opposite / Across",
      example: {
        sentence: "超市在學校對面。",
        romanization: "chāoshì zài xuéxiào duìmiàn.",
        translation: "Le supermarché est en face de l'école.",
      },
    },
    {
      term: "中間",
      romanization: "zhōngjiān",
      reading: "ㄓㄨㄥ ㄐㄧㄢ",
      french: "Au milieu / Entre",
      english: "Middle / Between",
      example: {
        sentence: "公園在銀行和郵局中間。",
        romanization: "gōngyuán zài yínháng hé yóujú zhōngjiān.",
    ...
    },
    {
      ...
      example: {
        sentence: "附近有沒有餐廳？",
        romanization: "fùjìn yǒu méiyǒu cāntīng?",
        translation: "Y a-t-il un restaurant dans le coin ?",
      },
    },
    {
      term: "公園",
      romanization: "gōngyuán",
      reading: "ㄍㄨㄥ ㄩㄢˊ",
      french: "Parc",
      english: "Park",
      example: {
        sentence: "我們去公園散步吧。",
        romanization: "wǒmen qù gōngyuán sànbù ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "我要去銀行換錢。",
        romanization: "wǒ yào qù yínháng huàn qián.",
    ...
    },
    {
      ...
      example: {
        sentence: "郵局幾點開門？",
        romanization: "yóujú jǐ diǎn kāimén?",
        translation: "À quelle heure ouvre la poste ?",
      },
    },
    {
      term: "超市",
      romanization: "chāoshì",
      reading: "ㄔㄠ ㄕˋ",
      french: "Supermarché",
      english: "Supermarket",
      example: {
        sentence: "我去超市買東西。",
        romanization: "wǒ qù chāoshì mǎi dōngxī.",
        translation: "Je vais au supermarché faire des courses.",
      },
    },
    {
      term: "教堂",
      romanization: "jiàotáng",
      reading: "ㄐㄧㄠˋ ㄊㄤˊ",
      french: "Église",
      english: "Church",
      example: {
        sentence: "那座教堂很漂亮。",
        romanization: "nà zuò jiàotáng hěn piàoliang.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄆㄤˊ ㄅㄧㄢ", "ㄕㄤˋ ㄇㄧㄢˋ", "ㄌㄧˇ ㄇㄧㄢˋ", "ㄒㄧㄚˋ ㄇㄧㄢˋ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄘㄨㄥˊ…ㄉㄠˋ…", "ㄗㄞˋ…ㄌㄧˇ…", "ㄌㄧˊ…ㄏㄣˇ…", "ㄧㄡˇ…ㄇㄟˊ…"],
