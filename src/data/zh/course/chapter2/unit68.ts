...
export const unit68: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "請問，你們有菜單嗎？",
          romanization: "qǐngwèn, nǐmen yǒu càidān ma?",
        ...
        },
        {
          type: "example",
          native: "我要一個炒飯和一碗湯。",
          romanization: "wǒ yào yí ge chǎofàn hé yì wǎn tāng.",
        ...
        },
        {
          type: "example",
          native: "我吃素，這個有肉嗎？",
          romanization: "wǒ chī sù, zhège yǒu ròu ma?",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "不好意思，請問赤崁樓怎麼走？",
          romanization: "bùhǎoyìsi, qǐngwèn Chìkǎn Lóu zěnme zǒu?",
        ...
        },
        {
          type: "example",
          native: "司機先生，我要去火車站。",
          romanization: "sījī xiānshēng, wǒ yào qù huǒchēzhàn.",
        ...
        },
        {
          type: "example",
          native: "這個芒果怎麼賣？",
          romanization: "zhège mángguǒ zěnme mài?",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "你好，我想訂位，明天晚上兩個人。",
          romanization: "nǐ hǎo, wǒ xiǎng dìngwèi, míngtiān wǎnshàng liǎng ge rén.",
        ...
        {
          type: "example",
          native: "喂，你在忙嗎？我們今天下午去喝咖啡好不好？",
          romanization: "wéi, nǐ zài máng ma? wǒmen jīntiān xiàwǔ qù hē kāfēi hǎo bù hǎo?",
        ...
        {
          type: "example",
          native: "嗨，是我。你方便的時候回我電話，謝謝。",
          romanization: "hāi, shì wǒ. nǐ fāngbiàn de shíhòu huí wǒ diànhuà, xièxie.",
  ...
  exercises: [
    ...
    },
    {
      ...
      hintReading: "Structure : Politesse + 請問 + Lieu + 怎麼走",
    },
    {
      id: "unit-68-ex6",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄉㄧㄥˋ", "ㄗㄨㄛˋ", "ㄓㄠˇ", "ㄇㄞˇ"],
    ...
    },
    {
      ...
      hintReading: "Structure : Sujet + Condition temporelle + Verbe + Complément",
    },
    {
      id: "unit-68-ex11",
      type: "listen",
