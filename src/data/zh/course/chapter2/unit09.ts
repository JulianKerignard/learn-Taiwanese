  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我要一碗滷肉飯",
          romanization: "wǒ yào yì wǎn lǔròu fàn",
        ...
        },
        {
          type: "example",
          native: "請給我一杯珍珠奶茶",
          romanization: "qǐng gěi wǒ yì bēi zhēnzhū nǎichá",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          romanization: "Wǒ yào yì bēi zhēnzhū nǎichá, bàn táng shǎo bīng.",
          translation:
        ...
        },
        {
          type: "example",
          native: "可以不要辣嗎？",
          romanization: "kěyǐ bú yào là ma?",
    ...
    lines: [
      {
        speaker: "Vendeur",
        native: "你好！要吃什麼？",
        romanization: "nǐ hǎo! yào chī shénme?",
        french: "Bonjour ! Qu'est-ce que vous voulez manger ?",
      },
      {
        speaker: "Vous",
        native: "我要一碗滷肉飯，還有一杯珍珠奶茶。",
        romanization: "wǒ yào yì wǎn lǔròu fàn, háiyǒu yì bēi zhēnzhū nǎichá.",
      ...
      },
      {
        speaker: "Vendeur",
        native: "要辣嗎？",
        romanization: "yào là ma?",
        french: "Vous voulez piquant ?",
      },
      {
        speaker: "Vous",
        native: "不要辣，謝謝。",
        romanization: "bú yào là, xièxiè.",
        french: "Pas piquant, merci.",
      },
      {
        speaker: "Vendeur",
        native: "好，一共八十五塊。",
        romanization: "hǎo, yígòng bāshíwǔ kuài.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我要一碗麵。",
        romanization: "wǒ yào yì wǎn miàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "牛肉麵很好吃。",
        romanization: "niúròu miàn hěn hǎochī.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄧㄠˋ ㄧˋ ㄨㄢˇ ㄋㄧㄡˊ ㄖㄡˋ ㄇㄧㄢˋ", "ㄍㄟˇ ㄨㄛˇ ㄧˋ ㄨㄢˇ ㄌㄨˇ ㄖㄡˋ ㄈㄢˋ", "ㄨㄛˇ ㄔ ㄋㄧㄡˊ ㄖㄡˋ ㄇㄧㄢˋ", "ㄨㄛˇ ㄧㄠˋ ㄧˋ ㄅㄟ ㄋㄧㄡˊ ㄖㄡˋ ㄇㄧㄢˋ"],
    },
    {
      id: "unit-09-ex2",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄏㄠˇ ㄔ", "ㄏㄠˇ ㄏㄜ", "ㄏㄠˇ ㄎㄢˋ", "ㄏㄠˇ ㄨㄢˊ"],
      hint: "好 + quel verbe pour « manger » ?",
      hintReading: "好 + quel verbe pour « manger » ?",
    },
    {
      id: "unit-09-ex4",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄌㄚˋ", "ㄊㄧㄢˊ", "ㄒㄧㄢˊ", "ㄙㄨㄢ"],
