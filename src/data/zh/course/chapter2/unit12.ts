...
export const unit12: CourseUnit = {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "有感冒藥嗎？",
          romanization: "yǒu gǎnmào yào ma?",
        ...
        },
        {
          type: "example",
          native: "一天吃幾次？",
          romanization: "yì tiān chī jǐ cì?",
    ...
    lines: [
      {
        speaker: "Vous",
        native: "你好，我感冒了。",
        romanization: "nǐ hǎo, wǒ gǎnmào le.",
        french: "Bonjour, j'ai un rhume.",
      },
      {
        speaker: "Pharmacien",
        native: "有什麼症狀？頭痛嗎？發燒嗎？",
        romanization: "yǒu shénme zhèngzhuàng? tóu tòng ma? fāshāo ma?",
      ...
      },
      {
        speaker: "Vous",
        native: "頭痛，還有一點發燒。",
        romanization: "tóu tòng, háiyǒu yìdiǎn fāshāo.",
        french: "Mal de tête, et un peu de fièvre.",
      },
      {
        speaker: "Pharmacien",
        native: "好，這個感冒藥很有效。一天吃三次，飯後吃。",
        romanization: "hǎo, zhège gǎnmào yào hěn yǒuxiào. yì tiān chī sān cì, fànhòu chī.",
      ...
      },
      {
        speaker: "Vous",
        native: "好的，多少錢？",
        romanization: "hǎo de, duōshǎo qián?",
        french: "D'accord, c'est combien ?",
      },
      {
        speaker: "Pharmacien",
        native: "一百五十塊。多喝水，好好休息！",
        romanization: "yì bǎi wǔshí kuài. duō hē shuǐ, hǎohǎo xiūxi!",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "附近有藥局嗎？",
        romanization: "fùjìn yǒu yàojú ma?",
    ...
    {
      term: "肚子痛",
      romanization: "dùzi tòng",
      reading: "ㄉㄨˋ ㄗ˙ ㄊㄨㄥˋ",
      french: "Mal au ventre",
      english: "Stomachache",
      example: {
        sentence: "我肚子痛，吃太多了。",
        romanization: "wǒ dùzi tòng, chī tài duō le.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個藥一天吃三次。",
        romanization: "zhège yào yì tiān chī sān cì.",
    ...
    },
    {
      ...
      example: {
        sentence: "救命！有人嗎？",
        romanization: "jiùmìng! yǒu rén ma?",
    ...
    {
      term: "花生",
      romanization: "huāshēng",
      reading: "ㄏㄨㄚ ㄕㄥ",
      french: "Cacahuète",
      english: "Peanut",
      example: {
        sentence: "這個有花生嗎？",
        romanization: "zhège yǒu huāshēng ma?",
        translation: "Est-ce qu'il y a des cacahuètes ?",
      },
    },
    {
      term: "海鮮",
      romanization: "hǎixiān",
      reading: "ㄏㄞˇ ㄒㄧㄢ",
      french: "Fruits de mer",
      english: "Seafood",
      example: {
        sentence: "我對海鮮過敏。",
        romanization: "wǒ duì hǎixiān guòmǐn.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄊㄡˊ ㄊㄨㄥˋ", "ㄨㄛˇ ㄉㄨˋ ㄗ ㄊㄨㄥˋ", "ㄨㄛˇ ㄅㄨˋ ㄕㄨ ㄈㄨ", "ㄨㄛˇ ㄍㄢˇ ㄇㄠˋ ㄌㄜ"],
    },
    {
      id: "unit-12-ex3",
      type: "fill-blank",
      ...
      optionsReading: ["ㄍㄢˇ ㄇㄠˋ", "ㄈㄚ ㄕㄠ", "ㄊㄡˊ ㄊㄨㄥˋ", "ㄅㄨˋ ㄕㄨ ㄈㄨ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄧ ㄕㄥ", "ㄧㄠˋ ㄐㄩˊ", "ㄧ ㄩㄢˋ", "ㄏㄨˋ ㄕ"],
