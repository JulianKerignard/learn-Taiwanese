...
export const unit42: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "好啊！對啊！是啊！",
          romanization: "hǎo a! duì a! shì a!",
        ...
        },
        {
          type: "example",
          native: "你知道嘛！當然嘛！",
          romanization: "nǐ zhīdào ma! dāngrán ma!",
        ...
        },
        {
          type: "example",
          native: "太好了耶！成功了耶！",
          romanization: "tài hǎo le yē! chénggōng le yē!",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "小美",
        native: "欸，下課了耶！要不要去吃東西啊？",
        romanization: "èi, xiàkè le yē! yào bú yào qù chī dōngxi a?",
      ...
      {
        speaker: "小偉",
        native: "好啊！吃什麼？隨便啦，你決定嘛。",
        romanization: "hǎo a! chī shénme? suíbiàn la, nǐ juédìng ma.",
      ...
      {
        speaker: "小美",
        native: "那去夜市吧？聽說有新的攤位喔。",
        romanization: "nà qù yèshì ba? tīngshuō yǒu xīn de tānwèi ō.",
      ...
      },
      {
        speaker: "小偉",
        native: "真的嗎？哇，那快走啦！",
        romanization: "zhēn de ma? wā, nà kuài zǒu la!",
        french: "Sérieux ? Wow, alors dépêchons-nous !",
        note: "真的嗎 (surprise), 哇 (admiration), 啦 (pression amicale).",
      },
      {
        speaker: "小美",
        native: "等一下啦，我要先換衣服。慢慢來嘛！",
        romanization: "děng yíxià la, wǒ yào xiān huàn yīfu. mànmàn lái ma!",
      ...
      {
        speaker: "小偉",
        native: "好啦好啦，我在樓下等你。不要太久喔！",
        romanization: "hǎo la hǎo la, wǒ zài lóuxià děng nǐ. bú yào tài jiǔ ō!",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "你知道嘛，這很正常。",
        romanization: "nǐ zhīdào ma, zhè hěn zhèngcháng.",
    ...
    },
    {
      ...
      example: {
        sentence: "喔，原來是這樣。",
        romanization: "ō, yuánlái shì zhèyàng.",
    ...
    },
    {
      ...
      example: {
        sentence: "蛤？你說什麼？",
        romanization: "há? nǐ shuō shénme?",
    ...
    },
    {
      ...
      example: {
        sentence: "好啦，我知道了啦。",
        romanization: "hǎo la, wǒ zhīdào le la.",
    ...
    },
    {
      ...
      example: {
        sentence: "好的，我現在去。",
        romanization: "hǎo de, wǒ xiànzài qù.",
    ...
    },
    {
      ...
      example: {
        sentence: "對啊，就是這樣。",
        romanization: "duì a, jiù shì zhèyàng.",
        translation: "Exactement, c'est ça.",
      },
    },
    {
      term: "算了",
      romanization: "suàn le",
      reading: "ㄙㄨㄢˋ ㄌㄜ˙",
      french: "Laisse tomber",
      english: "Forget it",
      example: {
        sentence: "算了，不想了。",
        romanization: "suàn le, bù xiǎng le.",
    ...
    },
    {
      ...
      example: {
        sentence: "隨便你啦。",
        romanization: "suíbiàn nǐ la.",
        translation: "Comme tu veux.",
      },
    },
    {
      term: "差不多",
      romanization: "chàbùduō",
      reading: "ㄔㄚˋ ㄅㄨˋ ㄉㄨㄛ",
      french: "À peu près",
      english: "Almost, about",
      example: {
        sentence: "差不多可以了吧。",
        romanization: "chàbùduō kěyǐ le ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "好啦好啦，我去就是了。",
        romanization: "hǎo la hǎo la, wǒ qù jiù shì le.",
  ...
  exercises: [
    ...
    },
    {
      ...
      options: [
        "Joie et excitation (c'est les vacances !)",
        "Tristesse (les vacances sont finies)",
        "Surprise (je ne savais pas)",
        "Resignation (bon, d'accord...)",
      ],
    },
    {
      id: "unit-42-ex12",
      ...
      options: [
        "好吧 = resignation (bon, d'accord...) / 好啊 = enthousiasme (ouais !)",
        "Les deux expriment la joie",
        "好吧 = question, 好啊 = reponse",
        "好吧 = formel, 好啊 = informel",
      ],
    },
  ],
