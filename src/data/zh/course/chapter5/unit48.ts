...
export const unit48: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我很高興認識你。",
          romanization: "wǒ hěn gāoxìng rènshi nǐ.",
        ...
        },
        {
          type: "example",
          native: "她今天很難過。",
          romanization: "tā jīntiān hěn nánguò.",
        ...
        },
        {
          type: "example",
          native: "我有一點緊張。",
          romanization: "wǒ yǒu yìdiǎn jǐnzhāng.",
        ...
        },
        {
          type: "example",
          native: "他非常興奮！",
          romanization: "tā fēicháng xīngfèn!",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我覺得很開心。",
          romanization: "wǒ juéde hěn kāixīn.",
        ...
        },
        {
          type: "example",
          native: "你覺得怎麼樣？",
          romanization: "nǐ juéde zěnmeyàng?",
        ...
        },
        {
          type: "example",
          native: "我覺得這部電影很感動。",
          romanization: "wǒ juéde zhè bù diànyǐng hěn gǎndòng.",
        ...
        },
        {
          type: "example",
          native: "這件事讓我很擔心。",
          romanization: "zhè jiàn shì ràng wǒ hěn dānxīn.",
        ...
        },
        {
          type: "example",
          native: "你的話讓她很難過。",
          romanization: "nǐ de huà ràng tā hěn nánguò.",
        ...
        },
        {
          type: "example",
          native: "台灣的美食讓我很滿意。",
          romanization: "Táiwān de měishí ràng wǒ hěn mǎnyì.",
        ...
        {
          type: "example",
          native: "因為考試快到了，所以我很緊張。",
          romanization: "yīnwèi kǎoshì kuài dào le, suǒyǐ wǒ hěn jǐnzhāng.",
          translation: "Parce que l'examen approche, je suis nerveux.",
          content: "因為...所以... relie la cause (l'examen) à l'émotion (la nervosité).",
        },
        {
          type: "example",
          native: "因為他很努力，所以成功了，大家都很羨慕他。",
          romanization: "yīnwèi tā hěn nǔlì, suǒyǐ chénggōng le, dàjiā dōu hěn xiànmù tā.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "沒關係，不要擔心。",
          romanization: "méi guānxi, bú yào dānxīn.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "你",
        native: "小美，你今天怎麼了？你看起來不太開心。",
        romanization: "Xiǎo Měi, nǐ jīntiān zěnme le? nǐ kàn qǐlái bú tài kāixīn.",
        french: "Xiao Mei, qu'est-ce qui t'arrive aujourd'hui ? Tu n'as pas l'air très contente.",
      },
      {
        speaker: "小美",
        native: "唉，因為我考試沒考好，所以很失望。",
        romanization: "āi, yīnwèi wǒ kǎoshì méi kǎo hǎo, suǒyǐ hěn shīwàng.",
        french: "Ah, parce que j'ai raté mon examen, je suis très déçue.",
        note: "因為...所以... relie la cause (examen raté) à l'émotion (déception).",
      },
      {
        speaker: "你",
        native: "我了解你的感覺。你覺得很難過吧？",
        romanization: "wǒ liǎojiě nǐ de gǎnjué. nǐ juéde hěn nánguò ba?",
      ...
      {
        speaker: "小美",
        native: "對，而且這讓我爸媽很擔心，我覺得很後悔。",
        romanization: "duì, érqiě zhè ràng wǒ bàmā hěn dānxīn, wǒ juéde hěn hòuhuǐ.",
      ...
      {
        speaker: "你",
        native: "別擔心，一次沒考好沒關係。你平常那麼努力，下次一定會更好的。",
        romanization: "bié dānxīn, yí cì méi kǎo hǎo méi guānxi. nǐ píngcháng nàme nǔlì, xià cì yídìng huì gèng hǎo de.",
      ...
      {
        speaker: "小美",
        native: "謝謝你，你的話讓我覺得好多了。",
        romanization: "xièxie nǐ, nǐ de huà ràng wǒ juéde hǎo duō le.",
        french: "Merci, tes paroles me font me sentir beaucoup mieux.",
        note: "讓 + 覺得 combinés : tes paroles CAUSENT que je RESSENS mieux.",
      },
      {
        speaker: "你",
        native: "加油！我們一起去吃好吃的吧，吃完你就會開心了。",
        romanization: "jiāyóu! wǒmen yìqǐ qù chī hǎochī de ba, chī wán nǐ jiù huì kāixīn le.",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "別難過，會好的。",
        romanization: "bié nánguò, huì hǎo de.",
    ...
    },
    {
      ...
      example: {
        sentence: "他為什麼生氣了？",
        romanization: "tā wèishénme shēngqì le?",
    ...
    },
    {
      ...
      example: {
        sentence: "考試前我很緊張。",
        romanization: "kǎoshì qián wǒ hěn jǐnzhāng.",
    ...
    },
    {
      ...
      example: {
        sentence: "媽媽很擔心我。",
        romanization: "māma hěn dānxīn wǒ.",
    ...
    },
    {
      ...
      example: {
        sentence: "今天我很開心！",
        romanization: "jīntiān wǒ hěn kāixīn!",
    ...
    },
    {
      ...
      example: {
        sentence: "這個週末好無聊。",
        romanization: "zhège zhōumò hǎo wúliáo.",
    ...
    },
    {
      ...
      example: {
        sentence: "工作一天，我好累。",
        romanization: "gōngzuò yì tiān, wǒ hǎo lèi.",
        translation: "Après une journée de travail, je suis épuisé.",
      },
    },
    {
      term: "興奮",
      romanization: "xīngfèn",
      reading: "ㄒㄧㄥ ㄈㄣˋ",
      french: "Excité, enthousiaste",
      english: "Excited",
      example: {
        sentence: "要去台灣了，我好興奮！",
        romanization: "yào qù Táiwān le, wǒ hǎo xīngfèn!",
        translation: "Je vais bientôt aller à Taïwan, je suis trop excité !",
      },
    },
    {
      term: "感動",
      romanization: "gǎndòng",
      reading: "ㄍㄢˇ ㄉㄨㄥˋ",
      french: "Ému, touché",
      english: "Moved, touched",
      example: {
        sentence: "這個故事讓我很感動。",
        romanization: "zhège gùshi ràng wǒ hěn gǎndòng.",
    ...
    },
    {
      ...
      example: {
        sentence: "我很後悔沒去。",
        romanization: "wǒ hěn hòuhuǐ méi qù.",
    ...
    },
    {
      ...
      example: {
        sentence: "他對結果很失望。",
        romanization: "tā duì jiéguǒ hěn shīwàng.",
    ...
    },
    {
      ...
      example: {
        sentence: "老闆對我的工作很滿意。",
        romanization: "lǎobǎn duì wǒ de gōngzuò hěn mǎnyì.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "wǒ hěn xiànmù nǐ kěyǐ zhù zài Táiwān.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄐㄩㄝˊ ㄉㄜ˙", "ㄖㄤˋ", "ㄧㄣ ㄨㄟˋ", "ㄎㄜˇ ㄕˋ"],
      hint: "Quel verbe exprime un ressenti personnel et subjectif ?",
      hintReading: "Quel verbe exprime un ressenti personnel et subjectif ?",
    },
    {
      id: "unit-48-ex3",
      type: "translate",
      ...
      optionsReading: ["ㄋㄧˇ ㄉㄜ˙ ㄏㄨㄚˋ ㄖㄤˋ ㄨㄛˇ ㄏㄣˇ ㄋㄢˊ ㄍㄨㄛˋ", "ㄨㄛˇ ㄐㄩㄝˊ ㄉㄜ˙ ㄋㄧˇ ㄉㄜ˙ ㄏㄨㄚˋ ㄋㄢˊ ㄍㄨㄛˋ", "ㄋㄧˇ ㄉㄜ˙ ㄏㄨㄚˋ ㄨㄛˇ ㄏㄣˇ ㄋㄢˊ ㄍㄨㄛˋ", "ㄨㄛˇ ㄖㄤˋ ㄋㄧˇ ㄉㄜ˙ ㄏㄨㄚˋ ㄏㄣˇ ㄋㄢˊ ㄍㄨㄛˋ"],
    },
    {
      id: "unit-48-ex4",
      type: "fill-blank",
      ...
      optionsReading: ["ㄧㄣ ㄨㄟˋ...ㄙㄨㄛˇ ㄧˇ", "ㄖㄤˋ...ㄐㄩㄝˊ ㄉㄜ˙", "ㄎㄜˇ ㄕˋ...ㄖㄢˊ ㄏㄡˋ", "ㄙㄨㄟ ㄖㄢˊ...ㄉㄢˋ ㄕˋ"],
      hint: "Quelle paire de connecteurs exprime cause et conséquence ?",
      hintReading: "Quelle paire de connecteurs exprime cause et conséquence ?",
    },
    {
      id: "unit-48-ex5",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄏㄣˇ ㄏㄡˋ ㄏㄨㄟˇ ㄇㄟˊ ㄑㄩˋ", "ㄨㄛˇ ㄇㄟˊ ㄏㄡˋ ㄏㄨㄟˇ ㄑㄩˋ ㄌㄜ˙", "ㄨㄛˇ ㄑㄩˋ ㄌㄜ˙ ㄏㄣˇ ㄏㄡˋ ㄏㄨㄟˇ", "ㄨㄛˇ ㄏㄡˋ ㄏㄨㄟˇ ㄌㄜ˙ ㄇㄟˊ ㄑㄩˋ"],
    },
    {
      id: "unit-48-ex7",
      type: "reorder",
      ...
      optionsReading: ["ㄓㄜˋ ㄍㄜ˙ ㄒㄧㄠ ㄒㄧ˙", "ㄖㄤˋ", "ㄨㄛˇ", "ㄏㄣˇ", "ㄒㄧㄥ ㄈㄣˋ"],
      hint: "Structure : cause + 讓 + personne + 很 + émotion",
      hintReading: "Structure : cause + ㄖㄤˋ + personne + ㄏㄣˇ + émotion",
    },
    {
      id: "unit-48-ex8",
      type: "reorder",
      ...
      optionsReading: ["ㄋㄧˇ", "ㄐㄩㄝˊ ㄉㄜ˙", "ㄗㄣˇ ㄇㄜ˙ ㄧㄤˋ"],
      hint: "Structure : sujet + 覺得 + comment",
      hintReading: "Structure : sujet + ㄐㄩㄝˊ ㄉㄜ˙ + comment",
    },
  ],
