  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "雖然很熱，但是我很開心。",
          romanization: "suīrán hěn rè, dànshì wǒ hěn kāixīn.",
        ...
        },
        {
          type: "example",
          native: "如果下雨，我就不去了。",
          romanization: "rúguǒ xià yǔ, wǒ jiù bú qù le.",
        ...
        {
          type: "example",
          native: "因為颱風來了，所以學校放假。",
          romanization: "yīnwèi táifēng lái le, suǒyǐ xuéxiào fàngjià.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "今天天氣很好，出太陽了。",
          romanization: "jīntiān tiānqì hěn hǎo, chū tàiyáng le.",
        ...
        },
        {
          type: "example",
          native: "好熱喔！有三十五度。",
          romanization: "hǎo rè ō! yǒu sānshíwǔ dù.",
        ...
        },
        {
          type: "example",
          native: "外面下雨了，記得帶傘。",
          romanization: "wàimiàn xià yǔ le, jìde dài sǎn.",
        ...
        },
        {
          type: "example",
          native: "颱風要來了，大家要小心。",
          romanization: "táifēng yào lái le, dàjiā yào xiǎoxīn.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "梅雨季又來了，每天都下雨。",
          romanization: "méiyǔ jì yòu lái le, měitiān dōu xià yǔ.",
          translation:
        ...
        },
        {
          type: "example",
          native: "我需要買一台除濕機",
          romanization: "wǒ xūyào mǎi yì tái chúshī jī",
        ...
        },
        {
          type: "example",
          native: "明天颱風假，不用上班",
          romanization: "míngtiān táifēng jià, bú yòng shàngbān",
    ...
    lines: [
      {
        speaker: "Paul",
        native: "這個週末要不要去九份？",
        romanization: "zhège zhōumò yào bú yào qù Jiǔfèn?",
        french: "On va à Jiufen ce weekend ?",
      },
      {
        speaker: "小美",
        native: "我看一下天氣預報...雖然星期六下雨，但是星期天會出太陽。",
        romanization:
      ...
      {
        speaker: "Paul",
        native: "那我們星期天去吧。如果下雨，就改天。",
        romanization: "nà wǒmen xīngqītiān qù ba. rúguǒ xià yǔ, jiù gǎitiān.",
        french: "Alors allons-y dimanche. S'il pleut, on repousse.",
        note: "改天 = un autre jour / repousser.",
      },
      {
        speaker: "小美",
        native: "好，但是記得帶傘，九份的天氣很不穩定。",
        romanization: "hǎo, dànshì jìde dài sǎn, Jiǔfèn de tiānqì hěn bù wěndìng.",
        french:
      ...
      },
      {
        speaker: "Paul",
        native: "溫度多少？需要帶外套嗎？",
        romanization: "wēndù duōshǎo? xūyào dài wàitào ma?",
        french: "Il fait combien ? Je dois prendre une veste ?",
      },
      {
        speaker: "小美",
        native: "大概二十度，山上比較涼，應該帶一件外套。",
        romanization: "dàgài èrshí dù, shānshàng bǐjiào liáng, yīnggāi dài yí jiàn wàitào.",
        french:
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "今天天氣怎麼樣？",
        romanization: "jīntiān tiānqì zěnmeyàng?",
    ...
    },
    {
      ...
      example: {
        sentence: "台北的夏天很熱。",
        romanization: "Táiběi de xiàtiān hěn rè.",
    ...
    },
    {
      ...
      example: {
        sentence: "今天好冷喔。",
        romanization: "jīntiān hǎo lěng ō.",
    ...
    },
    {
      ...
      example: {
        sentence: "外面在下雨。",
        romanization: "wàimiàn zài xià yǔ.",
        translation: "Il pleut dehors.",
      },
    },
    {
      term: "颱風",
      romanization: "táifēng",
      reading: "ㄊㄞˊ ㄈㄥ",
      french: "Typhon",
      english: "Typhoon",
      example: {
        sentence: "颱風來了，不要出門。",
        romanization: "táifēng lái le, bú yào chūmén.",
        translation: "Le typhon arrive, ne sors pas.",
      },
    },
    {
      term: "太陽",
      romanization: "tàiyáng",
      reading: "ㄊㄞˋ ㄧㄤˊ",
      french: "Soleil",
      english: "Sun",
      example: {
        sentence: "太陽好大，戴帽子吧。",
        romanization: "tàiyáng hǎo dà, dài màozi ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "今天溫度有三十八度。",
        romanization: "jīntiān wēndù yǒu sānshíbā dù.",
    ...
    },
    {
      ...
      example: {
        sentence: "冬天大概十度左右。",
        romanization: "dōngtiān dàgài shí dù zuǒyòu.",
    ...
    },
    {
      ...
      example: {
        sentence: "台灣的夏天又熱又濕。",
        romanization: "Táiwān de xiàtiān yòu rè yòu shī.",
    ...
    },
    {
      ...
      example: {
        sentence: "山上比較涼快。",
        romanization: "shānshàng bǐjiào liángkuai.",
    ...
    },
    {
      ...
      example: {
        sentence: "雖然很累，但是很開心。",
        romanization: "suīrán hěn lèi, dànshì hěn kāixīn.",
    ...
    },
    {
      ...
      example: {
        sentence: "如果你有空，我們去吧。",
        romanization: "rúguǒ nǐ yǒu kòng, wǒmen qù ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "你來了，我們就走吧。",
        romanization: "nǐ lái le, wǒmen jiù zǒu ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "你有帶傘嗎？",
        romanization: "nǐ yǒu dài sǎn ma?",
  ...
  exercises: [
    {
      ...
      hintReading: "Quelle structure exprime la concession ?",
    },
    {
      id: "unit-24-ex2",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄒㄧㄚˋ ㄩˇ", "ㄒㄧㄚˋ ㄒㄩㄝˇ", "ㄔㄨ ㄊㄞˋ ㄧㄤˊ", "ㄊㄞˊ ㄈㄥ"],
      hint: "Quel verbe signifie « pleuvoir » ?",
      hintReading: "Quel verbe signifie « pleuvoir » ?",
    },
    {
      id: "unit-24-ex5",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄐㄧㄣ ㄊㄧㄢ ㄊㄧㄢ ㄑㄧˋ ㄗㄣˇ ㄇㄜ˙ ㄧㄤˋ？", "ㄐㄧㄣ ㄊㄧㄢ ㄐㄧˇ ㄉㄨˋ？", "ㄐㄧㄣ ㄊㄧㄢ ㄏㄨㄟˋ ㄒㄧㄚˋ ㄩˇ ㄇㄚ˙？", "ㄐㄧㄣ ㄊㄧㄢ ㄔㄨ ㄊㄞˋ ㄧㄤˊ ㄇㄚ˙？"],
    },
  ],
