...
export const unit27: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "我先去了市場，然後回家做飯，最後看了電視。",
          romanization: "wǒ xiān qù le shìchǎng, ránhòu huíjiā zuòfàn, zuìhòu kàn le diànshì.",
        ...
        {
          type: "example",
          native: "早上我去了學校，中午跟同學吃了飯，下午上了三堂課，晚上回家休息。",
          romanization: "zǎoshang wǒ qù le xuéxiào, zhōngwǔ gēn tóngxué chī le fàn, xiàwǔ shàng le sān táng kè, wǎnshang huíjiā xiūxi.",
        ...
        {
          type: "example",
          native: "我昨天先去了銀行，然後買了東西，最後去朋友家吃晚餐。",
          romanization: "wǒ zuótiān xiān qù le yínháng, ránhòu mǎi le dōngxi, zuìhòu qù péngyǒu jiā chī wǎncān.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我正在吃飯。",
          romanization: "wǒ zhèngzài chīfàn.",
        ...
        },
        {
          type: "example",
          native: "你在做什麼？我正在寫功課。",
          romanization: "nǐ zài zuò shénme? wǒ zhèngzài xiě gōngkè.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "我早上去早餐店買了蛋餅，然後去上班。",
          romanization: "wǒ zǎoshang qù zǎocāndiàn mǎi le dàn bǐng, ránhòu qù shàngbān.",
        ...
        },
        {
          type: "example",
          native: "我一邊走路一邊聽音樂",
          romanization: "wǒ yìbiān zǒulù yìbiān tīng yīnyuè",
        ...
        {
          type: "example",
          native: "我一到台灣就愛上了這裡的食物",
          romanization: "wǒ yī dào Táiwān jiù ài shàng le zhèlǐ de shíwù",
        ...
        },
        {
          type: "example",
          native: "我在台北住了半年了",
          romanization: "wǒ zài Táiběi zhù le bàn nián le",
        ...
        },
        {
          type: "example",
          native: "去哪裡？出去走走。",
          romanization: "qù nǎlǐ? chūqù zǒuzǒu.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "小華",
        native: "你來台灣一個星期了！怎麼樣？",
        romanization: "nǐ lái Táiwān yí ge xīngqī le! zěnmeyàng?",
        french: "Ca fait une semaine que tu es a Taiwan ! C'est comment ?",
      },
      {
        speaker: "你",
        native: "很好！我先去了台北101，然後去了夜市，最後還去了九份。",
        romanization: "hěn hǎo! wǒ xiān qù le Táiběi yī-líng-yī, ránhòu qù le yèshì, zuìhòu hái qù le Jiǔfèn.",
        french: "Super ! D'abord je suis alle a Taipei 101, puis au marche de nuit, et enfin j'ai meme ete a Jiufen.",
      },
      {
        speaker: "小華",
        native: "你吃過臭豆腐嗎？",
        romanization: "nǐ chī guò chòudòufu ma?",
        french: "Tu as deja goute le tofu puant ?",
      },
      {
        speaker: "你",
        native: "吃過了！因為很特別，所以我很喜歡。我正在學怎麼用筷子夾它。",
        romanization: "chī guò le! yīnwèi hěn tèbié, suǒyǐ wǒ hěn xǐhuān. wǒ zhèngzài xué zěnme yòng kuàizi jiā tā.",
      ...
      {
        speaker: "小華",
        native: "太好了！你聽懂台灣人說的中文嗎？",
        romanization: "tài hǎo le! nǐ tīng dǒng Táiwānrén shuō de Zhōngwén ma?",
        french: "Super ! Tu comprends le chinois que parlent les Taiwanais ?",
        note: "聽懂 est un complement resultatif : ecouter + comprendre.",
      },
      {
        speaker: "你",
        native: "有時候聽懂，有時候聽不懂。可是我每天都在學！",
        romanization: "yǒu shíhòu tīng dǒng, yǒu shíhòu tīng bù dǒng. kěshì wǒ měitiān dōu zài xué!",
      ...
      {
        speaker: "小華",
        native: "這個週末我會帶你去吃早餐店，先吃蛋餅，然後喝豆漿。",
        romanization: "zhège zhōumò wǒ huì dài nǐ qù chī zǎocāndiàn, xiān chī dàn bǐng, ránhòu hē dòujiāng.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "先洗手，然後吃飯。",
        romanization: "xiān xǐ shǒu, ránhòu chīfàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "先吃飯，然後去看電影。",
        romanization: "xiān chīfàn, ránhòu qù kàn diànyǐng.",
    ...
    },
    {
      ...
      example: {
        sentence: "最後我們回家了。",
        romanization: "zuìhòu wǒmen huíjiā le.",
    ...
    },
    {
      ...
      example: {
        sentence: "太晚了，所以我回家了。",
        romanization: "tài wǎn le, suǒyǐ wǒ huí jiā le.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "yīnwèi hěn lèi, suǒyǐ wǒ xiǎng xiūxi.",
    ...
    },
    {
      ...
      example: {
        sentence: "好吃，可是太辣了。",
        romanization: "hǎochī, kěshì tài là le.",
        translation: "C'est bon, mais trop epice.",
      },
    },
    {
      term: "早上",
      romanization: "zǎoshang",
      reading: "ㄗㄠˇ ㄕㄤˋ",
      french: "Le matin",
      english: "Morning",
      example: {
        sentence: "我早上七點起床。",
        romanization: "wǒ zǎoshang qī diǎn qǐchuáng.",
    ...
    },
    {
      ...
      example: {
        sentence: "下午我去圖書館。",
        romanization: "xiàwǔ wǒ qù túshūguǎn.",
        translation: "L'apres-midi je vais a la bibliotheque.",
      },
    },
    {
      term: "晚上",
      romanization: "wǎnshang",
      reading: "ㄨㄢˇ ㄕㄤˋ",
      french: "Le soir",
      english: "Evening, night",
      example: {
        sentence: "晚上我們去夜市。",
        romanization: "wǎnshang wǒmen qù yèshì.",
    ...
    },
    {
      ...
      example: {
        sentence: "我五點回家。",
        romanization: "wǒ wǔ diǎn huíjiā.",
    ...
    },
    {
      ...
      example: {
        sentence: "下雨了，我不想出門。",
        romanization: "xiàyǔ le, wǒ bù xiǎng chūmén.",
    ...
    },
    {
      ...
      example: {
        sentence: "我正在吃飯，等一下。",
        romanization: "wǒ zhèngzài chīfàn, děng yīxià.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "wǒ xiān xǐ le liǎn, ránhòu chī zǎocān.",
    ...
    },
    {
      ...
      example: {
        sentence: "今天很熱，穿短褲吧。",
        romanization: "jīntiān hěn rè, chuān duǎnkù ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "他送了我一個禮物。",
        romanization: "tā sòng le wǒ yí ge lǐwù.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄍㄨㄛˋ", "ㄌㄜ˙", "ㄏㄨㄟˋ", "ㄏㄣˇ"],
      hint: "Quelle particule indique une experience de vie ?",
      hintReading: "Quelle particule indique une experience de vie ?",
    },
    {
      id: "unit-27-ex2",
      type: "translate",
      ...
      optionsReading: ["ㄇㄧㄥˊ ㄊㄧㄢ ㄨㄛˇ ㄏㄨㄟˋ ㄑㄩˋ ㄧㄝˋ ㄕˋ", "ㄇㄧㄥˊ ㄊㄧㄢ ㄨㄛˇ ㄑㄩˋ ㄌㄜ˙ ㄧㄝˋ ㄕˋ", "ㄇㄧㄥˊ ㄊㄧㄢ ㄨㄛˇ ㄑㄩˋ ㄍㄨㄛˋ ㄧㄝˋ ㄕˋ", "ㄇㄧㄥˊ ㄊㄧㄢ ㄨㄛˇ ㄒㄧㄤˇ ㄌㄜ˙ ㄧㄝˋ ㄕˋ"],
    },
    {
      id: "unit-27-ex3",
      type: "fill-blank",
      ...
      optionsReading: ["ㄧㄣ ㄨㄟˋ...ㄙㄨㄛˇ ㄧˇ", "ㄎㄜˇ ㄕˋ...ㄖㄢˊ ㄏㄡˋ", "ㄖㄢˊ ㄏㄡˋ...ㄙㄨㄛˇ ㄧˇ", "ㄏㄞˊ ㄕˋ...ㄎㄜˇ ㄕˋ"],
      hint: "Quelle paire de connecteurs exprime cause et consequence ?",
      hintReading: "Quelle paire de connecteurs exprime cause et consequence ?",
    },
    {
      id: "unit-27-ex4",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄓㄥˋ ㄗㄞˋ", "ㄧˇ ㄐㄧㄥ", "ㄎㄨㄞˋ ㄧㄠˋ", "ㄍㄤ ㄘㄞˊ"],
      hint: "Quelle expression signifie « etre en train de » ?",
      hintReading: "Quelle expression signifie « etre en train de » ?",
    },
    {
      id: "unit-27-ex6",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄒㄧㄢ", "ㄔ ㄈㄢˋ", "ㄖㄢˊ ㄏㄡˋ", "ㄑㄩˋ", "ㄎㄢˋ ㄉㄧㄢˋ ㄧㄥˇ"],
      hint: "Structure : 先 + action1，然後 + action2",
      hintReading: "Structure : ㄒㄧㄢ + action1，ㄖㄢˊ ㄏㄡˋ + action2",
    },
    {
      id: "unit-27-ex8",
      type: "reorder",
      ...
      optionsReading: ["ㄨㄛˇ", "ㄓㄥˋ ㄗㄞˋ", "ㄎㄢˋ ㄕㄨ", "ㄋㄜ˙"],
      hint: "Structure : Sujet + 正在 + Verbe + 呢",
      hintReading: "Structure : Sujet + ㄓㄥˋ ㄗㄞˋ + Verbe + ㄋㄜ˙",
    },
  ],
