...
export const unit49: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我打算明年去台灣留學。",
          romanization: "wǒ dǎsuàn míngnián qù Táiwān liúxué.",
        ...
        },
        {
          type: "example",
          native: "你畢業以後打算做什麼？",
          romanization: "nǐ bìyè yǐhòu dǎsuàn zuò shénme?",
        ...
        },
        {
          type: "example",
          native: "我希望有一天能環遊世界。",
          romanization: "wǒ xīwàng yǒu yì tiān néng huányóu shìjiè.",
        ...
        },
        {
          type: "example",
          native: "爸媽希望我找到好工作。",
          romanization: "bàmā xīwàng wǒ zhǎodào hǎo gōngzuò.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "如果明天下雨，我就不出門。",
          romanization: "rúguǒ míngtiān xiàyǔ, wǒ jiù bù chūmén.",
          translation: "S'il pleut demain, je ne sortirai pas.",
          content: "如果 + condition，就 + conséquence. Structure de base.",
        },
        {
          type: "example",
          native: "如果你有機會去台灣，你想去哪裡？",
          romanization: "rúguǒ nǐ yǒu jīhuì qù Táiwān, nǐ xiǎng qù nǎlǐ?",
        ...
        {
          type: "example",
          native: "要是考試通過了，我就請你吃飯。",
          romanization: "yàoshi kǎoshì tōngguò le, wǒ jiù qǐng nǐ chīfàn.",
        ...
        },
        {
          type: "example",
          native: "如果你努力，就一定會成功。",
          romanization: "rúguǒ nǐ nǔlì, jiù yídìng huì chénggōng.",
        ...
        {
          type: "example",
          native: "如果失敗了也沒關係，重要的是不要放棄。",
          romanization: "rúguǒ shībài le yě méi guānxi, zhòngyào de shì bú yào fàngqì.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "我的夢想是開一家自己的咖啡店。",
          romanization: "wǒ de mèngxiǎng shì kāi yì jiā zìjǐ de kāfēidiàn.",
        ...
        },
        {
          type: "example",
          native: "她決定去國外繼續念書。",
          romanization: "tā juédìng qù guówài jìxù niànshū.",
        ...
        {
          type: "example",
          native: "不管結果怎麼樣，我都會繼續努力。",
          romanization: "bùguǎn jiéguǒ zěnmeyàng, wǒ dōu huì jìxù nǔlì.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "阿明",
        native: "你在台灣學中文，以後打算做什麼？",
        romanization: "nǐ zài Táiwān xué Zhōngwén, yǐhòu dǎsuàn zuò shénme?",
        french: "Tu apprends le chinois à Taïwan, qu'est-ce que tu comptes faire après ?",
      },
      {
        speaker: "你",
        native: "我打算學好中文，然後希望能在台灣找到工作。",
        romanization: "wǒ dǎsuàn xué hǎo Zhōngwén, ránhòu xīwàng néng zài Táiwān zhǎodào gōngzuò.",
      ...
      },
      {
        speaker: "阿明",
        native: "好棒！你想做什麼工作？",
        romanization: "hǎo bàng! nǐ xiǎng zuò shénme gōngzuò?",
        french: "Super ! Quel type de travail tu voudrais faire ?",
      },
      {
        speaker: "你",
        native: "我的夢想是當翻譯。如果能力夠，就去翻譯公司工作。",
        romanization: "wǒ de mèngxiǎng shì dāng fānyì. rúguǒ nénglì gòu, jiù qù fānyì gōngsī gōngzuò.",
      ...
      {
        speaker: "阿明",
        native: "你中文已經很不錯了！如果繼續努力，一定會成功的。",
        romanization: "nǐ Zhōngwén yǐjīng hěn búcuò le! rúguǒ jìxù nǔlì, yídìng huì chénggōng de.",
        french: "Ton chinois est déjà pas mal ! Si tu continues tes efforts, tu réussiras certainement.",
      },
      {
        speaker: "你",
        native: "謝謝！你呢？你有什麼計劃？",
        romanization: "xièxie! nǐ ne? nǐ yǒu shénme jìhuà?",
        french: "Merci ! Et toi ? Quels sont tes projets ?",
      },
      {
        speaker: "阿明",
        native: "我準備明年去日本念研究所。雖然有點緊張，但是我已經決定了。",
        romanization: "wǒ zhǔnbèi míngnián qù Rìběn niàn yánjiūsuǒ. suīrán yǒudiǎn jǐnzhāng, dànshì wǒ yǐjīng juédìng le.",
      ...
      {
        speaker: "你",
        native: "太好了！我們都加油吧！不管結果怎麼樣，經驗最重要。",
        romanization: "tài hǎo le! wǒmen dōu jiāyóu ba! bùguǎn jiéguǒ zěnmeyàng, jīngyàn zuì zhòngyào.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "你週末有什麼計劃？",
        romanization: "nǐ zhōumò yǒu shénme jìhuà?",
    ...
    },
    {
      ...
      example: {
        sentence: "你打算什麼時候回國？",
        romanization: "nǐ dǎsuàn shénme shíhòu huíguó?",
    ...
    },
    {
      ...
      example: {
        sentence: "我希望你每天都開心。",
        romanization: "wǒ xīwàng nǐ měitiān dōu kāixīn.",
    ...
    },
    {
      ...
      example: {
        sentence: "每個人都有自己的夢想。",
        romanization: "měi ge rén dōu yǒu zìjǐ de mèngxiǎng.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "wǒ de mùbiāo shì xuéhuì sānqiān ge hànzì.",
    ...
    },
    {
      ...
      example: {
        sentence: "他有很多工作經驗。",
        romanization: "tā yǒu hěn duō gōngzuò jīngyàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "結果比我想像的好。",
        romanization: "jiéguǒ bǐ wǒ xiǎngxiàng de hǎo.",
    ...
    },
    {
      ...
      example: {
        sentence: "他終於成功了！",
        romanization: "tā zhōngyú chénggōng le!",
    ...
    },
    {
      ...
      example: {
        sentence: "失敗是成功之母。",
        romanization: "shībài shì chénggōng zhī mǔ.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "zhǐyào nǔlì, jiù yǒu kěnéng chénggōng.",
    ...
    },
    {
      ...
      example: {
        sentence: "請繼續說，我在聽。",
        romanization: "qǐng jìxù shuō, wǒ zài tīng.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄉㄚˇ ㄙㄨㄢˋ", "ㄒㄧ ㄨㄤˋ", "ㄖㄨˊ ㄍㄨㄛˇ", "ㄧㄣ ㄨㄟˋ"],
      hint: "Quel verbe exprime une intention concrète, un plan réfléchi ?",
      hintReading: "Quel verbe exprime une intention concrète, un plan réfléchi ?",
    },
    {
      id: "unit-49-ex2",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄖㄨˊ ㄍㄨㄛˇ ㄇㄧㄥˊ ㄊㄧㄢ ㄒㄧㄚˋ ㄩˇ，ㄨㄛˇ ㄐㄧㄡˋ ㄅㄨˋ ㄔㄨ ㄇㄣˊ", "ㄇㄧㄥˊ ㄊㄧㄢ ㄒㄧㄚˋ ㄩˇ，ㄖㄨˊ ㄍㄨㄛˇ ㄨㄛˇ ㄅㄨˋ ㄔㄨ ㄇㄣˊ", "ㄨㄛˇ ㄐㄧㄡˋ ㄅㄨˋ ㄔㄨ ㄇㄣˊ，ㄖㄨˊ ㄍㄨㄛˇ ㄇㄧㄥˊ ㄊㄧㄢ ㄒㄧㄚˋ ㄩˇ", "ㄇㄧㄥˊ ㄊㄧㄢ ㄖㄨˊ ㄍㄨㄛˇ ㄒㄧㄚˋ ㄩˇ ㄅㄨˋ ㄔㄨ ㄇㄣˊ ㄨㄛˇ ㄐㄧㄡˋ"],
    },
    {
      id: "unit-49-ex4",
      type: "fill-blank",
      ...
      optionsReading: ["ㄒㄧ ㄨㄤˋ", "ㄉㄚˇ ㄙㄨㄢˋ", "ㄐㄩㄝˊ ㄉㄧㄥˋ", "ㄓㄨㄣˇ ㄅㄟˋ"],
      hint: "Quel verbe exprime un souhait, un espoir ?",
      hintReading: "Quel verbe exprime un souhait, un espoir ?",
    },
    {
      id: "unit-49-ex5",
      type: "translate",
      ...
      optionsReading: ["ㄕ ㄅㄞˋ ㄕˋ ㄔㄥˊ ㄍㄨㄥ ㄓ ㄇㄨˇ", "ㄔㄥˊ ㄍㄨㄥ ㄕˋ ㄕ ㄅㄞˋ ㄓ ㄇㄨˇ", "ㄕ ㄅㄞˋ ㄍㄣ ㄔㄥˊ ㄍㄨㄥ ㄧˊ ㄧㄤˋ", "ㄔㄥˊ ㄍㄨㄥ ㄧˇ ㄏㄡˋ ㄏㄨㄟˋ ㄕ ㄅㄞˋ"],
    },
    {
      id: "unit-49-ex6",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄖㄨˊ ㄍㄨㄛˇ", "ㄋㄧˇ", "ㄋㄨˇ ㄌㄧˋ", "ㄐㄧㄡˋ", "ㄧˊ ㄉㄧㄥˋ", "ㄏㄨㄟˋ", "ㄔㄥˊ ㄍㄨㄥ"],
      hint: "Structure : 如果 + condition，就 + conséquence",
      hintReading: "Structure : ㄖㄨˊ ㄍㄨㄛˇ + condition，ㄐㄧㄡˋ + conséquence",
    },
    {
      id: "unit-49-ex8",
      type: "reorder",
      ...
      optionsReading: ["ㄋㄧˇ", "ㄧˇ ㄏㄡˋ", "ㄉㄚˇ ㄙㄨㄢˋ", "ㄗㄨㄛˋ", "ㄕㄣˊ ㄇㄜ˙"],
      hint: "Structure : sujet + temps + 打算 + verbe + quoi",
      hintReading: "Structure : sujet + temps + ㄉㄚˇ ㄙㄨㄢˋ + verbe + quoi",
    },
  ],
