...
export const unit44: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "比以前貴了吧？",
          romanization: "bǐ yǐqián guì le ba?",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "你去過日本嗎？去過，可是我覺得台灣比日本好玩。",
          romanization: "nǐ qù guò Rìběn ma? qù guò, kěshì wǒ juéde Táiwān bǐ Rìběn hǎowán.",
        ...
        {
          type: "example",
          native: "不好意思，這個比那個便宜嗎？",
          romanization: "bù hǎo yìsi, zhège bǐ nàge piányi ma?",
          translation: "Excusez-moi, celui-ci est moins cher que celui-la ?",
          content: "Combine : politesse 不好意思 + comparaison 比 + question 嗎.",
        },
        {
          type: "example",
          native: "我已經學了六個月的中文了，可是還聽不懂。",
          romanization: "wǒ yǐjīng xué le liù ge yuè de Zhōngwén le, kěshì hái tīng bù dǒng.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我吃過臭豆腐，很好吃！",
          romanization: "wǒ chī guò chòudòufu, hěn hǎochī!",
        ...
        {
          type: "example",
          native: "這件比那件貴，可是比較好看。",
          romanization: "zhè jiàn bǐ nà jiàn guì, kěshì bǐjiào hǎokàn.",
        ...
        {
          type: "example",
          native: "不好意思，我不會說中文，你會說英文嗎？",
          romanization: "bù hǎo yìsi, wǒ bú huì shuō Zhōngwén, nǐ huì shuō Yīngwén ma?",
        ...
        },
        {
          type: "example",
          native: "我來台灣以後，天氣變熱了。",
          romanization: "wǒ lái Táiwān yǐhòu, tiānqì biàn rè le.",
        ...
        {
          type: "example",
          native: "我覺得台灣的夜市是最好玩的。",
          romanization: "wǒ juéde Táiwān de yèshì shì zuì hǎowán de.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄗㄨㄟˋ", "ㄅㄧˇ", "ㄍㄥˋ", "ㄏㄣˇ"],
      hint: "Quel mot exprime le superlatif ?",
      hintReading: "Quel mot exprime le superlatif ?",
    },
    {
      id: "unit-44-ex8",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄇㄟˊ ㄑㄩˋ ㄍㄨㄛˋ ㄖˋ ㄅㄣˇ", "ㄨㄛˇ ㄅㄨˊ ㄑㄩˋ ㄍㄨㄛˋ ㄖˋ ㄅㄣˇ", "ㄨㄛˇ ㄇㄟˊ ㄑㄩˋ ㄌㄜ˙ ㄖˋ ㄅㄣˇ", "ㄨㄛˇ ㄅㄨˊ ㄏㄨㄟˋ ㄑㄩˋ ㄖˋ ㄅㄣˇ"],
    },
    {
      id: "unit-44-ex9",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄋㄧˇ ㄏㄨㄟˋ ㄕㄨㄛ ㄧㄥ ㄨㄣˊ ㄇㄚ˙？", "ㄋㄧˇ ㄕㄨㄛ ㄏㄨㄟˋ ㄧㄥ ㄨㄣˊ ㄇㄚ˙？", "ㄏㄨㄟˋ ㄋㄧˇ ㄕㄨㄛ ㄧㄥ ㄨㄣˊ ㄇㄚ˙？", "ㄋㄧˇ ㄧㄥ ㄨㄣˊ ㄏㄨㄟˋ ㄕㄨㄛ ㄇㄚ˙？"],
    },
    {
      id: "unit-44-ex11",
      type: "fill-blank",
      ...
      hintReading: "La formule la plus courante pour deranger poliment.",
    },
    {
      id: "unit-44-ex12",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄓㄨˋ ㄗㄞˋ ㄊㄞˊ ㄨㄢ ㄧˇ ㄏㄡˋ，ㄐㄧㄡˋ ㄒㄧˇ ㄏㄨㄢ ㄓㄣ ㄓㄨ ㄋㄞˇ ㄔㄚˊ ㄌㄜ˙", "ㄨㄛˇ ㄓㄨˋ ㄊㄞˊ ㄨㄢ ㄌㄜ˙，ㄒㄧˇ ㄏㄨㄢ ㄌㄜ˙ ㄓㄣ ㄓㄨ ㄋㄞˇ ㄔㄚˊ", "ㄊㄞˊ ㄨㄢ ㄓㄨˋ ㄧˇ ㄏㄡˋ，ㄓㄣ ㄓㄨ ㄋㄞˇ ㄔㄚˊ ㄒㄧˇ ㄏㄨㄢ ㄌㄜ˙", "ㄨㄛˇ ㄏㄨㄟˋ ㄓㄨˋ ㄊㄞˊ ㄨㄢ ㄒㄧˇ ㄏㄨㄢ ㄓㄣ ㄓㄨ ㄋㄞˇ ㄔㄚˊ"],
    },
  ],
