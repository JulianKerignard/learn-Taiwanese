  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "他已經走了。/ 下雨了！",
          romanization: "tā yǐjīng zǒu le. / xià yǔ le!",
        ...
        {
          type: "example",
          native: "你看過這部電影嗎？沒有，我沒看過。",
          romanization: "nǐ kàn guò zhè bù diànyǐng ma? méiyǒu, wǒ méi kàn guò.",
        ...
        {
          type: "example",
          native: "他比我高，但是我跑得比他快。",
          romanization: "tā bǐ wǒ gāo, dànshì wǒ pǎo de bǐ tā kuài.",
        ...
        },
        {
          type: "example",
          native: "蛋糕被弟弟吃完了。",
          romanization: "dàngāo bèi dìdi chī wán le.",
        ...
        {
          type: "example",
          native: "這本書你看得懂嗎？有些字我看不懂。",
          romanization: "zhè běn shū nǐ kàn de dǒng ma? yǒuxiē zì wǒ kàn bù dǒng.",
        ...
        {
          type: "example",
          native: "我剛到台灣，快要開始上課了。",
          romanization: "wǒ gāng dào Táiwān, kuài yào kāishǐ shàngkè le.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "雖然我剛來台灣，但是我已經吃過很多台灣小吃了，我覺得比法國的好吃多了。",
          romanization:
        ...
        {
          type: "example",
          native: "只要你把功課做完，就可以出去玩，但是不要太晚回來，因為明天還要上班。",
          romanization:
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄧˇ ㄐㄧㄥ", "ㄓㄥˋ ㄗㄞˋ", "ㄎㄨㄞˋ ㄧㄠˋ", "ㄍㄤ"],
      hint: "Quel mot signifie 'déjà' et s'utilise avec 了 en fin de phrase ?",
      hintReading: "Quel mot signifie 'déjà' et s'utilise avec 了 en fin de phrase ?",
    },
    {
      id: "unit-87-ex2",
      type: "translate",
    ...
    },
    {
      ...
      hintReading: "Quelle préposition place l'objet avant le verbe pour agir dessus ?",
    },
    {
      id: "unit-87-ex5",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄅㄨˋ", "ㄉㄜˊ", "ㄇㄟˊ", "ㄌㄜ˙"],
      hint: "Quel mot insère-t-on entre le verbe et le résultatif pour exprimer l'impossibilité ?",
      hintReading: "Quel mot insère-t-on entre le verbe et le résultatif pour exprimer l'impossibilité ?",
    },
    {
      id: "unit-87-ex8",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄅㄟˋ", "ㄅㄚˇ", "ㄍㄟˇ", "ㄖㄤˋ"],
      hint: "Quel mot introduit le passif en chinois ?",
      hintReading: "Quel mot introduit le passif en chinois ?",
    },
    {
      id: "unit-87-ex12",
      type: "comprehension",
