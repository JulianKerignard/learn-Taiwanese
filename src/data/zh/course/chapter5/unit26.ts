...
export const unit26: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我覺得這個東西很好吃。",
          romanization: "wǒ juéde zhège dōngxi hěn hǎochī.",
    ...
    lines: [
      {
        speaker: "Paul",
        native: "我要一杯綠茶。",
        romanization: "wǒ yào yì bēi lǜchá.",
        french: "Je voudrais un thé vert.",
      },
      {
        speaker: "店員",
        native: "綠茶？還是奶茶？",
        romanization: "lǜchá? háishì nǎichá?",
        french: "Thé vert ? Ou thé au lait ?",
      },
      {
        speaker: "Paul",
        native: "綠茶。嗯...我說的對嗎？我的聲調常常不對。",
        romanization: "lǜchá. en... wǒ shuō de duì ma? wǒ de shēngdiào chángcháng bú duì.",
      ...
      {
        speaker: "店員",
        native: "你說得很好啊！很多外國人分不清「買」和「賣」呢。",
        romanization:
      ...
      {
        speaker: "Paul",
        native: "哈哈，我上次說「我要賣咖啡」，店員嚇一跳！",
        romanization: "hāhā, wǒ shàng cì shuō 'wǒ yào mài kāfēi', diànyuán xià yí tiào!",
        french:
      ...
      {
        speaker: "店員",
        native: "沒關係，多練習就好了。你的綠茶來了！",
        romanization: "méi guānxi, duō liànxí jiù hǎo le. nǐ de lǜchá lái le!",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "他在研究台灣的歷史。",
        romanization: "tā zài yánjiū Táiwān de lìshǐ.",
    ...
    {
      term: "影響",
      romanization: "yǐngxiǎng",
      reading: "ㄧㄥˇ ㄒㄧㄤˇ",
      french: "Influence / influencer",
      english: "Influence / to affect",
      example: {
        sentence: "天氣影響我的心情。",
        romanization: "tiānqì yǐngxiǎng wǒ de xīnqíng.",
    ...
    },
    {
      ...
      example: {
        sentence: "他管理一家公司。",
        romanization: "tā guǎnlǐ yì jiā gōngsī.",
        translation: "Il gère une entreprise.",
      },
    },
    {
      term: "簡單",
      romanization: "jiǎndān",
      reading: "ㄐㄧㄢˇ ㄉㄢ",
      french: "Simple / facile",
      english: "Simple / easy",
      example: {
        sentence: "這個問題很簡單。",
        romanization: "zhège wèntí hěn jiǎndān.",
    ...
    },
    {
      ...
      example: {
        sentence: "中文的聲調很複雜。",
        romanization: "zhōngwén de shēngdiào hěn fùzá.",
    ...
    },
    {
      ...
      example: {
        sentence: "台灣的文化很特別。",
        romanization: "Táiwān de wénhuà hěn tèbié.",
    ...
    },
    {
      ...
      example: {
        sentence: "每天練習聲調很重要。",
        romanization: "měitiān liànxí shēngdiào hěn zhòngyào.",
