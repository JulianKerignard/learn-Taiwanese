...
export const unit55: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我的眼睛不舒服。",
          romanization: "wǒ de yǎnjīng bù shūfu.",
        ...
        },
        {
          type: "example",
          native: "他肚子痛，不想吃東西。",
          romanization: "tā dùzi tòng, bù xiǎng chī dōngxi.",
        ...
        },
        {
          type: "example",
          native: "我的牙齒很癢。",
          romanization: "wǒ de yáchǐ hěn yǎng.",
        ...
        },
        {
          type: "example",
          native: "她一直咳嗽，已經三天了。",
          romanization: "tā yìzhí késòu, yǐjīng sān tiān le.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "醫生問：「你哪裡不舒服？」",
          romanization: "yīshēng wèn: 'nǐ nǎlǐ bù shūfu?'",
        ...
        },
        {
          type: "example",
          native: "我喉嚨痛，而且一直咳嗽。",
          romanization: "wǒ hóulóng tòng, érqiě yìzhí késòu.",
        ...
        },
        {
          type: "example",
          native: "這樣多久了？",
          romanization: "zhèyàng duōjiǔ le?",
        ...
        },
        {
          type: "example",
          native: "大概一個星期了。",
          romanization: "dàgài yí gè xīngqí le.",
        ...
        },
        {
          type: "example",
          native: "你應該多休息。",
          romanization: "nǐ yīnggāi duō xiūxi.",
        ...
        },
        {
          type: "example",
          native: "感冒的時候應該多喝水。",
          romanization: "gǎnmào de shíhòu yīnggāi duō hē shuǐ.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "我先去診所看看，如果沒好再去醫院。",
          romanization: "wǒ xiān qù zhěnsuǒ kànkan, rúguǒ méi hǎo zài qù yīyuàn.",
        ...
        },
        {
          type: "example",
          native: "你可以去藥局買感冒藥。",
          romanization: "nǐ kěyǐ qù yàojú mǎi gǎnmào yào.",
    ...
    lines: [
      {
        speaker: "醫生",
        native: "你好，請坐。你哪裡不舒服？",
        romanization: "nǐ hǎo, qǐng zuò. nǐ nǎlǐ bù shūfu?",
        french: "Bonjour, asseyez-vous. Où avez-vous mal ?",
        note: "哪裡不舒服 est la question standard du médecin.",
      },
      {
        speaker: "你",
        native: "醫生你好，我頭很痛，而且一直咳嗽。",
        romanization: "yīshēng nǐ hǎo, wǒ tóu hěn tòng, érqiě yìzhí késòu.",
      ...
      {
        speaker: "你",
        native: "大概三天了。昨天開始肚子也不舒服。",
        romanization: "dàgài sān tiān le. zuótiān kāishǐ dùzi yě bù shūfu.",
        french: "Environ trois jours. Depuis hier, mon ventre aussi n'est pas bien.",
        note: "三天了 = ça fait trois jours. 開始 = commencer.",
      },
      {
        speaker: "醫生",
        native: "我幫你量一下體溫。嗯，三十八度五，你發燒了。",
        romanization: "wǒ bāng nǐ liáng yíxià tǐwēn. ēn, sānshíbā dù wǔ, nǐ fāshāo le.",
        french: "Je vais prendre votre température. Hmm, 38,5 degrés, vous avez de la fièvre.",
      },
      {
        speaker: "醫生",
        native: "你應該是感冒了。我開一些藥給你。",
        romanization: "nǐ yīnggāi shì gǎnmào le. wǒ kāi yìxiē yào gěi nǐ.",
      ...
      {
        speaker: "你",
        native: "好的，謝謝醫生。我應該注意什麼？",
        romanization: "hǎo de, xièxie yīshēng. wǒ yīnggāi zhùyì shénme?",
        french: "D'accord, merci docteur. À quoi dois-je faire attention ?",
        note: "應該 + verbe pour demander des recommandations.",
      },
      {
        speaker: "醫生",
        native: "你應該多休息，多喝水，這幾天不要吃太油的東西。吃完藥如果還沒好，再來看。",
        romanization: "nǐ yīnggāi duō xiūxi, duō hē shuǐ, zhè jǐ tiān búyào chī tài yóu de dōngxi. chī wán yào rúguǒ hái méi hǎo, zài lái kàn.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我的頭好痛。",
        romanization: "wǒ de tóu hǎo tòng.",
        translation: "J'ai tellement mal à la tête.",
      },
    },
    {
      term: "眼睛",
      romanization: "yǎnjīng",
      reading: "ㄧㄢˇ ㄐㄧㄥ",
      french: "Yeux",
      english: "Eyes",
      example: {
        sentence: "你的眼睛很漂亮。",
        romanization: "nǐ de yǎnjīng hěn piàoliang.",
    ...
    },
    {
      ...
      example: {
        sentence: "我的耳朵不舒服。",
        romanization: "wǒ de ěrduo bù shūfu.",
    ...
    },
    {
      ...
      example: {
        sentence: "請張開嘴巴。",
        romanization: "qǐng zhāngkāi zuǐba.",
    ...
    },
    {
      ...
      example: {
        sentence: "請先洗手。",
        romanization: "qǐng xiān xǐ shǒu.",
    ...
    },
    {
      ...
      example: {
        sentence: "走太多路，腳好酸。",
        romanization: "zǒu tài duō lù, jiǎo hǎo suān.",
    ...
    },
    {
      ...
      example: {
        sentence: "他的牙齒很白。",
        romanization: "tā de yáchǐ hěn bái.",
    ...
    },
    {
      ...
      example: {
        sentence: "她的皮膚很好。",
        romanization: "tā de pífū hěn hǎo.",
    ...
    },
    {
      ...
      example: {
        sentence: "流血了！快拿OK繃。",
        romanization: "liúxiě le! kuài ná OK bēng.",
    ...
    },
    {
      ...
      example: {
        sentence: "被蚊子咬，好癢！",
        romanization: "bèi wénzi yǎo, hǎo yǎng!",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄧㄥ ㄍㄞ", "ㄎㄜˇ ㄧˇ", "ㄒㄧㄤˇ ㄧㄠˋ", "ㄅㄧˋ ㄒㄩ"],
      hint: "Quel mot exprime un conseil, une recommandation (devoir/il faudrait) ?",
      hintReading: "Quel mot exprime un conseil, une recommandation (devoir/il faudrait) ?",
    },
    {
      id: "unit-55-ex3",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄊㄡˊ ㄏㄣˇ ㄊㄨㄥˋ ㄦˊ ㄑㄧㄝˇ ㄧˋ ㄓˊ ㄎㄜˊ ㄙㄡˋ", "ㄨㄛˇ ㄎㄜˊ ㄙㄡˋ ㄏㄣˇ ㄊㄨㄥˋ ㄊㄡˊ ㄧˋ ㄓˊ", "ㄊㄡˊ ㄊㄨㄥˋ ㄎㄜˊ ㄙㄡˋ ㄨㄛˇ ㄦˊ ㄑㄧㄝˇ ㄧˋ ㄓˊ", "ㄨㄛˇ ㄧˋ ㄓˊ ㄊㄡˊ ㄊㄨㄥˋ ㄦˊ ㄑㄧㄝˇ ㄏㄣˇ ㄎㄜˊ ㄙㄡˋ"],
    },
    {
      id: "unit-55-ex4",
      type: "listen",
    ...
    },
    {
      ...
      optionsReading: ["ㄌㄜ˙", "ㄉㄜ˙", "ㄍㄨㄛˋ", "ㄗㄞˋ"],
      hint: "Quelle particule marque une durée écoulée jusqu'au présent ?",
      hintReading: "Quelle particule marque une durée écoulée jusqu'au présent ?",
    },
    {
      id: "unit-55-ex7",
      type: "translate",
      ...
      optionsReading: ["ㄋㄧˇ ㄧㄥ ㄍㄞ ㄑㄩˋ ㄎㄢˋ ㄧ ㄕㄥ", "ㄋㄧˇ ㄧㄠˋ ㄎㄢˋ ㄑㄩˋ ㄧ ㄕㄥ ㄧㄥ ㄍㄞ", "ㄧ ㄕㄥ ㄧㄥ ㄍㄞ ㄎㄢˋ ㄋㄧˇ ㄑㄩˋ", "ㄑㄩˋ ㄎㄢˋ ㄋㄧˇ ㄧㄥ ㄍㄞ ㄧ ㄕㄥ"],
    },
    {
      id: "unit-55-ex8",
      type: "listen",
