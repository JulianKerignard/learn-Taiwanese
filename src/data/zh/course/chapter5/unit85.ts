  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "阿明，這個週末你有空嗎？我想請你吃飯，上次你幫了我很多忙，我想謝謝你。你想吃什麼？日本料理還是火鍋？",
          romanization:
        ...
        {
          type: "example",
          native: "真的很謝謝你的邀請！不過這個週末我已經有事了，我朋友從法國來，我要帶他去九份玩。下個禮拜可以嗎？我請你！",
          romanization:
        ...
        {
          type: "example",
          native: "哇，你做的菜真的太好吃了！這道滷肉飯是你自己做的嗎？比外面賣的還好吃！你一定花了很多時間。可以教我怎麼做嗎？",
          romanization:
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "房東你好，不好意思打擾你。我房間的冷氣壞了，開了以後不會冷，而且有奇怪的聲音。已經兩天了。你可以找人來修嗎？因為現在天氣很熱，晚上都睡不著。謝謝你！",
          romanization:
        ...
        {
          type: "example",
          native: "老闆，這件T恤多少錢？三百九？有點貴耶。如果我買兩件，可不可以算便宜一點？三百九兩件，好不好？拜託拜託！",
          romanization:
        ...
        {
          type: "example",
          native: "我要一杯大杯的珍珠奶茶，半糖少冰。請問可以加椰果嗎？要多少錢？好的，用悠遊卡可以嗎？謝謝！",
          romanization:
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "大家好！我叫朱利安，我是法國人。我是新來的行銷部門的同事。我來台灣已經半年了，我很喜歡台灣。我的中文還不太好，但是我會努力學。如果我說錯了，請大家多多指教。以後請多多關照！",
          romanization:
        ...
        {
          type: "example",
          native: "主管你好，我想跟你請假。下個禮拜三我需要請一天假，因為我要去辦居留證。我會把手上的工作先做完，也會跟小陳交接。不好意思麻煩你了，謝謝主管。",
          romanization:
