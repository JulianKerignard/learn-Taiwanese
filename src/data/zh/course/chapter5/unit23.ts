...
export const unit23: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "你應該早點來。",
          romanization: "nǐ yīnggāi zǎo diǎn lái.",
        ...
        },
        {
          type: "example",
          native: "我需要你的幫忙。",
          romanization: "wǒ xūyào nǐ de bāngmáng.",
        ...
        },
        {
          type: "example",
          native: "我希望可以學好中文。",
          romanization: "wǒ xīwàng kěyǐ xué hǎo zhōngwén.",
        ...
        },
        {
          type: "example",
          native: "你必須帶護照。",
          romanization: "nǐ bìxū dài hùzhào.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "老闆說明天要開會。",
          romanization: "lǎobǎn shuō míngtiān yào kāihuì.",
        ...
        },
        {
          type: "example",
          native: "我的同事人很好。",
          romanization: "wǒ de tóngshì rén hěn hǎo.",
        ...
        },
        {
          type: "example",
          native: "今天要加班到九點。",
          romanization: "jīntiān yào jiābān dào jiǔ diǎn.",
        ...
        },
        {
          type: "example",
          native: "明天有考試，我要複習功課。",
          romanization: "míngtiān yǒu kǎoshì, wǒ yào fùxí gōngkè.",
        ...
        {
          type: "example",
          native: "您好，附件是這次的報告。謝謝，祝好。",
          romanization: "nín hǎo, fùjiàn shì zhè cì de bàogào. xièxie, zhù hǎo.",
          translation:
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "陳經理，這是您要的報告。",
          romanization: "Chén jīnglǐ, zhè shì nín yào de bàogào.",
        ...
        },
        {
          type: "example",
          native: "老闆，這是我的名片",
          romanization: "lǎobǎn, zhè shì wǒ de míngpiàn",
        ...
        },
        {
          type: "example",
          native: "大家辛苦了，下班吧",
          romanization: "dàjiā xīnkǔ le, xiàbān ba",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "Paul",
        native: "王老師好！我希望可以學好中文。",
        romanization: "Wáng lǎoshī hǎo! wǒ xīwàng kěyǐ xué hǎo zhōngwén.",
        french: "Bonjour professeur Wang ! J'espère pouvoir bien apprendre le chinois.",
      },
      {
        speaker: "老師",
        native: "很好！你們每天需要做功課，也應該多練習說。",
        romanization:
      ...
      },
      {
        speaker: "Paul",
        native: "下個月有考試嗎？",
        romanization: "xià ge yuè yǒu kǎoshì ma?",
        french: "Il y a un examen le mois prochain ?",
      },
      {
        speaker: "老師",
        native: "有，你們必須通過考試才能升級。加油！",
        romanization: "yǒu, nǐmen bìxū tōngguò kǎoshì cái néng shēngjí. jiāyóu!",
        french:
      ...
      },
      {
        speaker: "Paul",
        native: "好的，我會努力的！",
        romanization: "hǎo de, wǒ huì nǔlì de!",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "老闆今天心情不好。",
        romanization: "lǎobǎn jīntiān xīnqíng bù hǎo.",
    ...
    },
    {
      ...
      example: {
        sentence: "我和同事一起吃午餐。",
        romanization: "wǒ hé tóngshì yìqǐ chī wǔcān.",
    ...
    },
    {
      ...
      example: {
        sentence: "下午兩點有會議。",
        romanization: "xiàwǔ liǎng diǎn yǒu huìyì.",
    ...
    },
    {
      ...
      example: {
        sentence: "我的報告還沒寫完。",
        romanization: "wǒ de bàogào hái méi xiě wán.",
    ...
    },
    {
      ...
      example: {
        sentence: "我今天要加班到很晚。",
        romanization: "wǒ jīntiān yào jiābān dào hěn wǎn.",
        translation: "Je dois faire des heures sup très tard aujourd'hui.",
      },
    },
    {
      term: "學校",
      romanization: "xuéxiào",
      reading: "ㄒㄩㄝˊ ㄒㄧㄠˋ",
      french: "École",
      english: "School",
      example: {
        sentence: "我的學校在台北。",
        romanization: "wǒ de xuéxiào zài Táiběi.",
    ...
    },
    {
      ...
      example: {
        sentence: "王老師教得很好。",
        romanization: "Wáng lǎoshī jiāo de hěn hǎo.",
    ...
    },
    {
      ...
      example: {
        sentence: "你做完功課了嗎？",
        romanization: "nǐ zuò wán gōngkè le ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "明天的考試很難。",
        romanization: "míngtiān de kǎoshì hěn nán.",
        translation: "L'examen de demain est difficile.",
      },
    },
    {
      term: "應該",
      romanization: "yīnggāi",
      reading: "ㄧㄥ ㄍㄞ",
    ...
    },
    {
      ...
      example: {
        sentence: "我需要一杯咖啡。",
        romanization: "wǒ xūyào yì bēi kāfēi.",
    ...
    },
    {
      ...
      example: {
        sentence: "我希望明天天氣好。",
        romanization: "wǒ xīwàng míngtiān tiānqì hǎo.",
    ...
    },
    {
      ...
      example: {
        sentence: "你最近很忙嗎？",
        romanization: "nǐ zuìjìn hěn máng ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "加班到很晚，好累。",
        romanization: "jiābān dào hěn wǎn, hǎo lèi.",
    ...
    },
    {
      ...
      example: {
        sentence: "週末我想在家休息。",
        romanization: "zhōumò wǒ xiǎng zài jiā xiūxí.",
    ...
    },
    {
      ...
      example: {
        sentence: "你在做什麼？",
        romanization: "nǐ zài zuò shénme?",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄅㄧˋ ㄒㄩ", "ㄧㄥ ㄍㄞ", "ㄒㄧ ㄨㄤˋ", "ㄒㄩ ㄧㄠˋ"],
    },
    {
      id: "unit-23-ex2",
      type: "fill-blank",
      ...
      optionsReading: ["ㄒㄩ ㄧㄠˋ", "ㄒㄧ ㄨㄤˋ", "ㄧㄥ ㄍㄞ", "ㄅㄧˋ ㄒㄩ"],
      hint: "Quel verbe exprime un besoin ?",
      hintReading: "Quel verbe exprime un besoin ?",
    },
    {
      id: "unit-23-ex3",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄔㄣˊ ㄐㄧㄥ ㄌㄧˇ", "ㄒㄧㄠˇ ㄔㄣˊ", "ㄔㄣˊ ㄒㄧㄢ ㄕㄥ", "ㄚ ㄔㄣˊ"],
    },
    {
      id: "unit-23-ex5",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄧㄥ ㄍㄞ", "ㄅㄧˋ ㄒㄩ", "ㄒㄩ ㄧㄠˋ", "ㄒㄧ ㄨㄤˋ"],
      hint: "Quel verbe exprime un conseil ?",
      hintReading: "Quel verbe exprime un conseil ?",
    },
  ],
