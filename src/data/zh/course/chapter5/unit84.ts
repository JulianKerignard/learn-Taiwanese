...
export const unit84: CourseUnit = {
  ...
  vocabulary: [
    {
      term: "垃圾車",
      romanization: "lājī chē",
      reading: "ㄌㄜˋ ㄙㄜˋ ㄔㄜ",
      french: "Camion poubelle",
      english: "Garbage truck",
      example: {
        sentence: "垃圾車快來了，快下去！",
        romanization: "lājī chē kuài lái le, kuài xià qù!",
    ...
    },
    {
      ...
      example: {
        sentence: "牛奶放在冰箱裡。",
        romanization: "niúnǎi fàng zài bīngxiāng lǐ.",
        translation: "Le lait est dans le frigo.",
      },
    },
    {
      term: "套房",
      romanization: "tàofáng",
      reading: "ㄊㄠˋ ㄈㄤˊ",
      french: "Studio (avec salle de bain privée)",
      english: "Studio apartment",
      example: {
        sentence: "我在找一間套房。",
        romanization: "wǒ zài zhǎo yì jiān tàofáng.",
    ...
    },
    {
      ...
      example: {
        sentence: "月租多少錢？",
        romanization: "yuèzū duōshǎo qián?",
    ...
    },
    {
      ...
      example: {
        sentence: "押金要付兩個月。",
        romanization: "yājīn yào fù liǎng gè yuè.",
        translation: "Il faut payer deux mois de caution.",
      },
    },
    {
      term: "牛肉麵",
      romanization: "niúròu miàn",
      reading: "ㄋㄧㄡˊ ㄖㄡˋ ㄇㄧㄢˋ",
      french: "Soupe de nouilles au bœuf",
      english: "Beef noodle soup",
      example: {
        sentence: "台灣的牛肉麵很有名。",
        romanization: "Táiwān de niúròu miàn hěn yǒumíng.",
    ...
    },
    {
      ...
      example: {
        sentence: "這家店要排隊排很久。",
        romanization: "zhè jiā diàn yào páiduì pái hěn jiǔ.",
    ...
    {
      term: "推薦",
      romanization: "tuījiàn",
      reading: "ㄊㄨㄟ ㄐㄧㄢˋ",
      french: "Recommander",
      english: "To recommend",
      example: {
        sentence: "你推薦什麼菜？",
        romanization: "nǐ tuījiàn shénme cài?",
    ...
    },
    {
      ...
      example: {
        sentence: "這部電影很值得看。",
        romanization: "zhè bù diànyǐng hěn zhíde kàn.",
