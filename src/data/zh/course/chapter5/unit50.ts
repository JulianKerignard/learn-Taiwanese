  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "我昨天買了一本書。/ 天氣變冷了。",
          romanization: "wǒ zuótiān mǎi le yì běn shū. / tiānqì biàn lěng le.",
          translation:
        ...
        {
          type: "example",
          native: "你吃過臭豆腐嗎？我吃過，很好吃！",
          romanization: "nǐ chī guò chòu dòufu ma? wǒ chī guò, hěn hǎochī!",
          translation:
        ...
        {
          type: "example",
          native: "你會不會做菜？我會做幾道台灣菜。",
          romanization: "nǐ huì bú huì zuò cài? wǒ huì zuò jǐ dào Táiwān cài.",
          translation:
        ...
        },
        {
          type: "example",
          native: "請把這本書放在桌子上。",
          romanization: "qǐng bǎ zhè běn shū fàng zài zhuōzi shàng.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "台灣的夜市比法國的市場熱鬧多了。",
          romanization: "Táiwān de yèshì bǐ Fǎguó de shìchǎng rènao duō le.",
          translation:
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "如果你有空，我們就一起去吃飯吧！",
          romanization: "rúguǒ nǐ yǒu kòng, wǒmen jiù yìqǐ qù chīfàn ba!",
        ...
        {
          type: "example",
          native: "雖然中文很難，但是我覺得很有趣。",
          romanization: "suīrán Zhōngwén hěn nán, dànshì wǒ juéde hěn yǒuqù.",
          translation:
