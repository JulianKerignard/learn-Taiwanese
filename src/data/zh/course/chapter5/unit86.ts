  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我喜歡吃台灣的小吃。",
          romanization: "wǒ xǐhuān chī Táiwān de xiǎochī.",
        ...
        },
        {
          type: "example",
          native: "你今天晚上想做什麼？",
          romanization: "nǐ jīntiān wǎnshàng xiǎng zuò shénme?",
          translation: "Qu'est-ce que tu veux faire ce soir ?",
          content: "Question avec 什麼 en position objet.",
        },
        {
          type: "example",
          native: "他不是我的同事，他是我的鄰居。",
          romanization: "tā bú shì wǒ de tóngshì, tā shì wǒ de línjū.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "我已經去過日月潭了，但是還沒去過墾丁。",
          romanization: "wǒ yǐjīng qù guò rìyuètán le, dànshì hái méi qù guò Kěndīng.",
        ...
        },
        {
          type: "example",
          native: "台北的房租比高雄貴多了。",
          romanization: "Táiběi de fángzū bǐ Gāoxióng guì duō le.",
          translation: "Le loyer à Taipei est bien plus cher qu'à Kaohsiung.",
          content: "比 + adjectif + 多了 = bien plus que.",
        },
        {
          type: "example",
          native: "請你把窗戶關起來，外面太吵了。",
          romanization: "qǐng nǐ bǎ chuānghù guān qǐlái, wàimiàn tài chǎo le.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "雖然學中文很難，但是我不會放棄，因為我真的很喜歡台灣。",
          romanization: "suīrán xué Zhōngwén hěn nán, dànshì wǒ bú huì fàngqì, yīnwèi wǒ zhēn de hěn xǐhuān Táiwān.",
        ...
        {
          type: "example",
          native: "我的手機被弟弟摔壞了，所以我今天沒辦法打電話。",
          romanization: "wǒ de shǒujī bèi dìdi shuāi huài le, suǒyǐ wǒ jīntiān méi bànfǎ dǎ diànhuà.",
        ...
        {
          type: "example",
          native: "只要你每天練習半個小時，你的中文就會進步很快。",
          romanization: "zhǐyào nǐ měi tiān liànxí bàn ge xiǎoshí, nǐ de Zhōngwén jiù huì jìnbù hěn kuài.",
