  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "把書放在桌子上",
          romanization: "bǎ shū fàng zài zhuōzi shàng",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "寫得很漂亮",
          romanization: "xiě de hěn piàoliang",
    ...
    lines: [
      {
        speaker: "小美",
        native: "請你把這些箱子搬進來。",
        romanization: "qǐng nǐ bǎ zhèxiē xiāngzi bān jìnlái.",
        french: "S'il te plaît, porte ces cartons à l'intérieur.",
        note: "把 + objet + verbe + complément directionnel 進來.",
      },
      {
        speaker: "Paul",
        native: "好，我把書都放在書架上了。你看得到嗎？",
        romanization: "hǎo, wǒ bǎ shū dōu fàng zài shūjià shàng le. nǐ kàn de dào ma?",
        french:
      ...
      {
        speaker: "小美",
        native: "看得到。你做得很快！再把衣服拿上來。",
        romanization: "kàn de dào. nǐ zuò de hěn kuài! zài bǎ yīfu ná shànglái.",
        french:
      ...
      {
        speaker: "Paul",
        native: "衣服太多了，我搬不完。你可以下來幫我嗎？",
        romanization: "yīfu tài duō le, wǒ bān bù wán. nǐ kěyǐ xiàlái bāng wǒ ma?",
        french:
      ...
      {
        speaker: "小美",
        native: "好，我馬上下去。你先把門打開。",
        romanization: "hǎo, wǒ mǎshàng xiàqù. nǐ xiān bǎ mén dǎkāi.",
        french: "OK, je descends tout de suite. Ouvre la porte d'abord.",
        note: "下去 (descendre en s'éloignant), 把 + résultatif 打開.",
      },
      {
        speaker: "Paul",
        native: "都搬完了！我們把家收拾好了。",
        romanization: "dōu bān wán le! wǒmen bǎ jiā shōushi hǎo le.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "請把門關上。",
        romanization: "qǐng bǎ mén guānshàng.",
    ...
    },
    {
      ...
      example: {
        sentence: "把東西放在這裡。",
        romanization: "bǎ dōngxi fàng zài zhèlǐ.",
    ...
    },
    {
      ...
      example: {
        sentence: "請把窗戶關上。",
        romanization: "qǐng bǎ chuānghù guānshàng.",
    ...
    },
    {
      ...
      example: {
        sentence: "我想出去走走。",
        romanization: "wǒ xiǎng chūqù zǒuzǒu.",
    ...
    },
    {
      ...
      example: {
        sentence: "你可以上來嗎？",
        romanization: "nǐ kěyǐ shànglái ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "我先下去等你。",
        romanization: "wǒ xiān xiàqù děng nǐ.",
    ...
    },
    {
      ...
      example: {
        sentence: "他什麼時候回來？",
        romanization: "tā shénme shíhòu huílái?",
    ...
    },
    {
      ...
      example: {
        sentence: "我明天要回去法國。",
        romanization: "wǒ míngtiān yào huíqù Fǎguó.",
    ...
    },
    {
      ...
      example: {
        sentence: "你中文說得真好！",
        romanization: "nǐ zhōngwén shuō de zhēn hǎo!",
    ...
    },
    {
      ...
      example: {
        sentence: "我找到鑰匙了！",
        romanization: "wǒ zhǎodào yàoshi le!",
    ...
    },
    {
      ...
      example: {
        sentence: "這篇文章我看不懂。",
        romanization: "zhè piān wénzhāng wǒ kàn bù dǒng.",
    ...
    },
    {
      ...
      example: {
        sentence: "作業寫完了嗎？",
        romanization: "zuòyè xiěwán le ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "我終於學會騎腳踏車了。",
        romanization: "wǒ zhōngyú xuéhuì qí jiǎotàchē le.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄅㄚˇ ㄋㄧˇ ㄉㄜ˙ ㄒㄧㄝˊ ㄗ˙ ㄈㄤˋ ㄗㄞˋ ㄇㄣˊ ㄎㄡˇ。", "ㄋㄧˇ ㄉㄜ˙ ㄒㄧㄝˊ ㄗ˙ ㄗㄞˋ ㄇㄣˊ ㄎㄡˇ。", "ㄅㄚˇ ㄒㄧㄝˊ ㄗ˙ ㄔㄨㄢ ㄕㄤˋ。", "ㄇㄣˊ ㄎㄡˇ ㄧㄡˇ ㄋㄧˇ ㄉㄜ˙ ㄒㄧㄝˊ ㄗ˙。"],
    },
    {
      id: "unit-38-ex2",
      type: "comprehension",
      ...
      optionsReading: ["ㄑㄧㄥˇ ㄋㄧˇ ㄅㄚˇ ㄅㄟ ㄗ˙ ㄈㄤˋ ㄗㄞˋ ㄓㄨㄛ ㄗ˙ ㄕㄤˋ", "ㄑㄧㄥˇ ㄅㄚˇ ㄋㄧˇ ㄓㄨㄛ ㄗ˙ ㄕㄤˋ ㄅㄟ ㄗ˙ ㄈㄤˋ ㄗㄞˋ", "ㄋㄧˇ ㄑㄧㄥˇ ㄅㄚˇ ㄈㄤˋ ㄗㄞˋ ㄓㄨㄛ ㄗ˙ ㄕㄤˋ ㄅㄟ ㄗ˙", "ㄅㄚˇ ㄅㄟ ㄗ˙ ㄑㄧㄥˇ ㄋㄧˇ ㄈㄤˋ ㄗㄞˋ ㄓㄨㄛ ㄗ˙ ㄕㄤˋ"],
    },
    {
      id: "unit-38-ex3",
      type: "fill-blank",
      ...
      optionsReading: ["ㄉㄜ˙", "ㄉㄜ˙", "ㄉㄜ˙", "ㄌㄜ˙"],
      hint: "Complément de degré : verbe + __ + adjectif.",
      hintReading: "Complément ㄉㄜ˙ degré : verbe + __ + adjectif.",
    },
    {
      id: "unit-38-ex4",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄐㄧㄣˋ ㄌㄞˊ", "ㄔㄨ ㄑㄩˋ", "ㄕㄤˋ ㄌㄞˊ", "ㄏㄨㄟˊ ㄑㄩˋ"],
      hint: "Entrer vers le locuteur.",
      hintReading: "Entrer vers le locuteur.",
    },
    {
      id: "unit-38-ex6",
      type: "comprehension",
      ...
      optionsReading: ["ㄊㄚ ㄅㄚˇ ㄈㄢˋ ㄔ ㄨㄢˊ ㄌㄜ˙", "ㄊㄚ ㄔ ㄨㄢˊ ㄅㄚˇ ㄈㄢˋ ㄌㄜ˙", "ㄅㄚˇ ㄊㄚ ㄈㄢˋ ㄔ ㄨㄢˊ ㄌㄜ˙", "ㄊㄚ ㄈㄢˋ ㄅㄚˇ ㄔ ㄨㄢˊ ㄌㄜ˙"],
    },
    {
      id: "unit-38-ex7",
      type: "fill-blank",
      ...
      optionsReading: ["ㄉㄜ˙ ㄉㄨㄥˇ", "ㄅㄨˋ ㄉㄨㄥˇ", "ㄉㄜ˙ ㄉㄠˋ", "ㄅㄨˊ ㄉㄠˋ"],
      hint: "Forme potentielle positive : verbe + 得 + résultatif.",
      hintReading: "Forme potentielle positive : verbe + ㄉㄜ˙ + résultatif.",
    },
    {
      id: "unit-38-ex8",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄇㄚˇ ㄕㄤˋ ㄒㄧㄚˋ ㄑㄩˋ，ㄉㄥˇ ㄨㄛˇ。", "ㄨㄛˇ ㄇㄚˇ ㄕㄤˋ ㄕㄤˋ ㄌㄞˊ，ㄉㄥˇ ㄨㄛˇ。", "ㄨㄛˇ ㄇㄚˇ ㄕㄤˋ ㄏㄨㄟˊ ㄌㄞˊ，ㄉㄥˇ ㄨㄛˇ。", "ㄨㄛˇ ㄇㄚˇ ㄕㄤˋ ㄔㄨ ㄑㄩˋ，ㄉㄥˇ ㄨㄛˇ。"],
    },
  ],
