...
export const unit37: CourseUnit = {
  ...
  vocabulary: [
    ...
    {
      term: "飯類",
      romanization: "fàn lèi",
      reading: "ㄈㄢˋ ㄌㄟˋ",
      french: "Catégorie riz / plats de riz",
      english: "Rice dishes (category)",
      example: {
        sentence: "飯類有滷肉飯和雞腿飯。",
        romanization: "fàn lèi yǒu lǔròufàn hé jītuǐfàn.",
        translation:
    ...
    {
      term: "麵類",
      romanization: "miàn lèi",
      reading: "ㄇㄧㄢˋ ㄌㄟˋ",
      french: "Catégorie nouilles",
      english: "Noodle dishes (category)",
      example: {
        sentence: "麵類最便宜的是陽春麵。",
        romanization: "miàn lèi zuì piányi de shì yángchūnmiàn.",
        translation:
    ...
    {
      term: "飲料",
      romanization: "yǐnliào",
      reading: "ㄧㄣˇ ㄌㄧㄠˋ",
      french: "Boisson",
      english: "Beverage / drink",
      example: {
        sentence: "你要什麼飲料？",
        romanization: "nǐ yào shénme yǐnliào?",
    ...
    },
    {
      ...
      example: {
        sentence: "你的車次是幾號？",
        romanization: "nǐ de chēcì shì jǐ hào?",
        translation: "C'est quel numéro de train ?",
      },
    },
    {
      term: "票價",
      romanization: "piàojià",
      reading: "ㄆㄧㄠˋ ㄐㄧㄚˋ",
      french: "Prix du billet",
      english: "Ticket price",
      example: {
        sentence: "票價是一千四百九十元。",
        romanization: "piàojià shì yìqiān sìbǎi jiǔshí yuán.",
