...
export const unit40: CourseUnit = {
      ...
      content: [
        {
          type: "example",
          native: "你真的很棒！加油！",
          romanization: "nǐ zhēn de hěn bàng! jiāyóu!",
        ...
        },
        {
          type: "example",
          native: "祝你在台灣生活愉快！",
          romanization: "zhù nǐ zài Táiwān shēnghuó yúkuài!",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "小偉",
        native: "太棒了！你有沒有去考TOCFL？",
        romanization: "tài bàng le! nǐ yǒu méiyǒu qù kǎo TOCFL?",
      ...
      },
      {
        speaker: "小偉",
        native: "你在台灣最喜歡什麼？",
        romanization: "nǐ zài Táiwān zuì xǐhuān shénme?",
  ...
  vocabulary: [
    {
      ...
      example: {
        ...
        romanization: "zhǐyào jiānchí, jiù yídìng huì chénggōng.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "gōngxǐ nǐ cóng zhège kèchéng bìyè le!",
    ...
    },
    {
      ...
      example: {
        sentence: "未來你想做什麼？",
        romanization: "wèilái nǐ xiǎng zuò shénme?",
    ...
    },
    {
      ...
      example: {
        sentence: "不要放棄你的夢想。",
        romanization: "bú yào fàngqì nǐ de mèngxiǎng.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "jiānchí xiàqù, nǐ huì kàndào jiéguǒ de.",
    ...
    },
    {
      ...
      example: {
        sentence: "你的中文真的很棒！",
        romanization: "nǐ de zhōngwén zhēn de hěn bàng!",
    ...
    },
    {
      ...
      example: {
        sentence: "祝你旅途愉快！",
        romanization: "zhù nǐ lǚtú yúkuài!",
        translation: "Bon voyage !",
      },
    },
    {
      term: "生活",
      romanization: "shēnghuó",
      reading: "ㄕㄥ ㄏㄨㄛˊ",
      french: "Vie / vivre",
      english: "Life / to live",
      example: {
        sentence: "在台灣的生活很方便。",
        romanization: "zài Táiwān de shēnghuó hěn fāngbiàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "這些都是美好的回憶。",
        romanization: "zhèxiē dōu shì měihǎo de huíyì.",
  ...
  exercises: [
    ...
    // --- 5 exercices "fill-blank" (grammaire avancée) ---
    {
      ...
      optionsReading: ["ㄏㄠˇ", "ㄨㄢˊ", "ㄉㄠˋ", "ㄌㄜ˙"],
      hint: "Résultatif indiquant que l'action est bien faite.",
      hintReading: "Résultatif indiquant que l'action est bien faite.",
    },
    {
      id: "unit-40-ex12",
      type: "fill-blank",
      ...
      hintReading: "Particule de complément de degré entre le verbe et l'évaluation.",
    },
    {
      id: "unit-40-ex13",
      type: "fill-blank",
      ...
      optionsReading: ["ㄌㄜ˙", "ㄉㄜ˙", "ㄍㄨㄛˋ", "ㄅㄚˇ"],
      hint: "了₁ : action accomplie (chercher → fait).",
      hintReading: "ㄌㄜ˙₁ : action accomplie (chercher → fait).",
    },
    {
      id: "unit-40-ex14",
      type: "fill-blank",
      ...
      optionsReading: ["ㄅㄨˋ ㄉㄨㄥˇ", "ㄉㄜ˙ ㄉㄨㄥˇ", "ㄅㄨˊ ㄉㄠˋ", "ㄅㄨˋ ㄨㄢˊ"],
      hint: "Résultatif négatif : impossible de comprendre.",
      hintReading: "Résultatif négatif : impossible de comprendre.",
    },
    {
      id: "unit-40-ex15",
      type: "fill-blank",
      ...
      optionsReading: ["ㄌㄞˊ", "ㄑㄩˋ", "ㄉㄠˋ", "ㄗㄞˋ"],
      hint: "Verbe de mouvement vers Taiwan (perspective du locuteur sur place).",
      hintReading: "Verbe de mouvement vers Taiwan (perspective du locuteur sur place).",
    },
