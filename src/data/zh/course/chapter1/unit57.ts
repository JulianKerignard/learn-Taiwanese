...
export const unit57: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "學校、教室、圖書館",
          romanization: "xuéxiào, jiàoshì, túshūguǎn",
        ...
        },
        {
          type: "example",
          native: "桌子上有一本書和一枝筆。",
          romanization: "zhuōzi shàng yǒu yì běn shū hé yì zhī bǐ.",
        ...
        },
        {
          type: "example",
          native: "老師在黑板上寫字。",
          romanization: "lǎoshī zài hēibǎn shàng xiě zì.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我在教室上課。",
          romanization: "wǒ zài jiàoshì shàngkè.",
        ...
        },
        {
          type: "example",
          native: "他在圖書館讀書。",
          romanization: "tā zài túshūguǎn dúshū.",
        ...
        },
        {
          type: "example",
          native: "學生在學校吃午飯。",
          romanization: "xuéshēng zài xuéxiào chī wǔfàn.",
        ...
        },
        {
          type: "example",
          native: "八點上課，十二點下課。",
          romanization: "bā diǎn shàngkè, shí'èr diǎn xiàkè.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "台灣的學生很用功。",
          romanization: "táiwān de xuéshēng hěn yònggōng.",
        ...
        },
        {
          type: "example",
          native: "很多學生下課後去補習班。",
          romanization: "hěn duō xuéshēng xiàkè hòu qù bǔxíbān.",
        ...
        },
        {
          type: "example",
          native: "同學們一起在圖書館讀書。",
          romanization: "tóngxuémen yìqǐ zài túshūguǎn dúshū.",
    ...
    lines: [
      {
        speaker: "Wei",
        native: "下課了！你下一節課是什麼？",
        romanization: "xiàkè le! nǐ xià yí jié kè shì shénme?",
      ...
      {
        speaker: "Emma",
        native: "我下一節在教室上中文課。你呢？",
        romanization: "wǒ xià yí jié zài jiàoshì shàng zhōngwén kè. nǐ ne?",
        french: "Mon prochain cours est le cours de chinois, en salle de classe. Et toi ?",
        note: "中文課 (zhōngwén kè) = cours de chinois.",
      },
      {
        speaker: "Wei",
        native: "我也是！我們是同學。你的功課寫了嗎？",
        romanization: "wǒ yě shì! wǒmen shì tóngxué. nǐ de gōngkè xiě le ma?",
        french: "Moi aussi ! Nous sommes camarades de classe. Tu as fait tes devoirs ?",
        note: "寫了嗎 = as-tu écrit/fait ?",
      },
      {
        speaker: "Emma",
        native: "寫了！可是考試我很緊張。中文的考試難不難？",
        romanization: "xiě le! kěshì kǎoshì wǒ hěn jǐnzhāng. zhōngwén de kǎoshì nán bù nán?",
      ...
      {
        speaker: "Wei",
        native: "不會太難。你可以在圖書館多讀書。",
        romanization: "bú huì tài nán. nǐ kěyǐ zài túshūguǎn duō dúshū.",
      ...
      },
      {
        speaker: "Emma",
        native: "好主意！圖書館幾點開門？",
        romanization: "hǎo zhǔyì! túshūguǎn jǐ diǎn kāimén?",
        french: "Bonne idée ! À quelle heure ouvre la bibliothèque ?",
        note: "開門 (kāimén) = ouvrir la porte / ouvrir.",
      },
      {
        speaker: "Wei",
        native: "早上八點開門，晚上十點關門。下課後我們一起去吧！",
        romanization: "zǎoshàng bā diǎn kāimén, wǎnshàng shí diǎn guānmén. xiàkè hòu wǒmen yìqǐ qù ba!",
      ...
      {
        speaker: "Emma",
        native: "太好了！桌子上的書和筆是你的嗎？上課了，快走吧！",
        romanization: "tài hǎo le! zhuōzi shàng de shū hé bǐ shì nǐ de ma? shàngkè le, kuài zǒu ba!",
  ...
  vocabulary: [
    ...
    {
      term: "教室",
      romanization: "jiàoshì",
      reading: "ㄐㄧㄠˋ ㄕˋ",
      french: "Salle de classe",
      english: "Classroom",
      example: {
        sentence: "學生在教室裡上課。",
        romanization: "xuéshēng zài jiàoshì lǐ shàngkè.",
    ...
    },
    {
      ...
      example: {
        sentence: "這本書很好看。",
        romanization: "zhè běn shū hěn hǎokàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "請給我一張紙。",
        romanization: "qǐng gěi wǒ yì zhāng zhǐ.",
    ...
    },
    {
      ...
      example: {
        sentence: "書在桌子上。",
        romanization: "shū zài zhuōzi shàng.",
    ...
    },
    {
      ...
      example: {
        sentence: "教室裡有三十張椅子。",
        romanization: "jiàoshì lǐ yǒu sānshí zhāng yǐzi.",
    ...
    },
    {
      ...
      example: {
        sentence: "下課了，我們去吃飯吧！",
        romanization: "xiàkè le, wǒmen qù chīfàn ba!",
    ...
    },
    {
      ...
      example: {
        sentence: "明天有考試。",
        romanization: "míngtiān yǒu kǎoshì.",
    ...
    },
    {
      ...
      example: {
        sentence: "你的作業寫完了嗎？",
        romanization: "nǐ de zuòyè xiě wán le ma?",
        translation: "Tu as fini tes devoirs ?",
      },
    },
    {
      term: "圖書館",
      romanization: "túshūguǎn",
      reading: "ㄊㄨˊ ㄕㄨ ㄍㄨㄢˇ",
      french: "Bibliothèque",
      english: "Library",
      example: {
        sentence: "我在圖書館讀書。",
        romanization: "wǒ zài túshūguǎn dúshū.",
    ...
    },
    {
      ...
      example: {
        sentence: "他是我的同學。",
        romanization: "tā shì wǒ de tóngxué.",
    ...
    },
    {
      ...
      example: {
        sentence: "你的功課寫了沒？",
        romanization: "nǐ de gōngkè xiě le méi?",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄎㄠˇ ㄕˋ", "ㄕㄤˋ ㄎㄜˋ", "ㄍㄨㄥ ㄎㄜˋ", "ㄗㄨㄛˋ ㄧㄝˋ"],
