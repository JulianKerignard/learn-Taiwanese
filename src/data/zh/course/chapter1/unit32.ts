...
export const unit32: CourseUnit = {
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "Vous",
        native: "請問，有沒有練習寫字的本子？",
        romanization: "qǐngwèn, yǒu méiyǒu liànxí xiězì de běnzi?",
        french: "Excusez-moi, vous avez des cahiers pour pratiquer l'écriture ?",
      },
      {
        speaker: "Vendeur",
        native: "有，你要什麼樣的？有九宮格的，也有田字格的。",
        romanization: "yǒu, nǐ yào shénme yàng de? yǒu jiǔgōnggé de, yě yǒu tiánzìgé de.",
        french:
          "Oui, quel type voulez-vous ? On a des grilles à neuf cases et des grilles à quatre cases.",
      },
      {
        speaker: "Vous",
        native: "田字格的好了。我剛開始學寫中文字。",
        romanization: "tiánzìgé de hǎo le. wǒ gāng kāishǐ xué xiě Zhōngwén zì.",
        french:
          "Les grilles à quatre cases, ça ira. Je viens de commencer à apprendre à écrire les caractères chinois.",
      },
      {
        speaker: "Vendeur",
        native: "那你可以先練習基本的筆畫，像是橫、豎、撇、捺。",
        romanization: "nà nǐ kěyǐ xiān liànxí jīběn de bǐhuà, xiàng shì héng, shù, piě, nà.",
        french:
      ...
      },
      {
        speaker: "Vous",
        native: "筆順很重要嗎？",
        romanization: "bǐshùn hěn zhòngyào ma?",
        french: "L'ordre des traits, c'est important ?",
      },
      {
        speaker: "Vendeur",
        native: "很重要！筆順對了，字才會好看。",
        romanization: "hěn zhòngyào! bǐshùn duì le, zì cái huì hǎokàn.",
        french:
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "你會寫自己的名字嗎？",
        romanization: "nǐ huì xiě zìjǐ de míngzì ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "這個字怎麼念？",
        romanization: "zhège zì zěnme niàn?",
    ...
    },
    {
      ...
      example: {
        sentence: "可以借我一枝筆嗎？",
        romanization: "kěyǐ jiè wǒ yì zhī bǐ ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "我買了一本練習本子。",
        romanization: "wǒ mǎi le yì běn liànxí běnzi.",
    ...
    },
    {
      ...
      example: {
        sentence: "每天練習寫十個字。",
        romanization: "měitiān liànxí xiě shí ge zì.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個字的部首是什麼？",
        romanization: "zhège zì de bùshǒu shì shénme?",
    ...
    },
    {
      ...
      example: {
        sentence: "「大」有三個筆畫。",
        romanization: "'dà' yǒu sān ge bǐhuà.",
    ...
    },
    {
      ...
      example: {
        sentence: "筆畫的順序很重要。",
        romanization: "bǐhuà de shùnxù hěn zhòngyào.",
    ...
    },
    {
      ...
      example: {
        sentence: "中文字的結構很有意思。",
        romanization: "Zhōngwén zì de jiégòu hěn yǒu yìsi.",
    ...
    },
    {
      ...
      example: {
        sentence: "部首在左邊。",
        romanization: "bùshǒu zài zuǒbiān.",
    ...
    },
    {
      ...
      example: {
        sentence: "聲旁在右邊。",
        romanization: "shēngpáng zài yòubiān.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個字是什麼意思？",
        romanization: "zhège zì shì shénme yìsi?",
  ...
  exercises: [
    ...
    },
    {
      ...
      hintReading: "Le radical 女 (femme) est à gauche.",
    },
    {
      id: "unit-32-ex4",
      type: "comprehension",
    ...
    },
    {
      ...
      hintReading: "Le radical est à gauche du caractère 錢.",
    },
  ],
