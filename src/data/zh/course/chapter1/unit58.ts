...
export const unit58: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "客廳、廚房、浴室",
          romanization: "kètīng, chúfáng, yùshì",
        ...
        },
        {
          type: "example",
          native: "臥室是睡覺的地方。",
          romanization: "wòshì shì shuìjiào de dìfāng.",
        ...
        },
        {
          type: "example",
          native: "我家有三個房間。",
          romanization: "wǒ jiā yǒu sān ge fángjiān.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "貓在沙發上面。",
          romanization: "māo zài shāfā shàngmiàn.",
        ...
        },
        {
          type: "example",
          native: "電視在客廳裡面。",
          romanization: "diànshì zài kètīng lǐmiàn.",
        ...
        },
        {
          type: "example",
          native: "鞋子在門外面。",
          romanization: "xiézi zài mén wàimiàn.",
        ...
        },
        {
          type: "example",
          native: "書在桌子下面。",
          romanization: "shū zài zhuōzi xiàmiàn.",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "台灣的房子很小，但是很方便。",
          romanization: "táiwān de fángzi hěn xiǎo, dànshì hěn fāngbiàn.",
    ...
    lines: [
      {
        speaker: "小美",
        native: "歡迎來我家！請進，請進。",
        romanization: "huānyíng lái wǒ jiā! qǐng jìn, qǐng jìn.",
        french: "Bienvenue chez moi ! Entre, entre.",
        note: "歡迎 (huānyíng) = bienvenue. 請進 (qǐng jìn) = veuillez entrer.",
      },
      {
        speaker: "Marie",
        native: "謝謝！你的家好漂亮。這是客廳嗎？",
        romanization: "xièxiè! nǐ de jiā hǎo piàoliang. zhè shì kètīng ma?",
        french: "Merci ! Ta maison est très jolie. C'est le salon ?",
        note: "好 + adjectif = très (exprime l'admiration, comme 真).",
      },
      {
        speaker: "小美",
        native: "對，這是客廳。沙發在這裡，電視在沙發前面。",
        romanization: "duì, zhè shì kètīng. shāfā zài zhèlǐ, diànshì zài shāfā qiánmiàn.",
      ...
      },
      {
        speaker: "Marie",
        native: "廚房在哪裡？",
        romanization: "chúfáng zài nǎlǐ?",
        french: "Où est la cuisine ?",
      },
      {
        speaker: "小美",
        native: "廚房在客廳旁邊。很小，但是冰箱和桌子都有。",
        romanization: "chúfáng zài kètīng pángbiān. hěn xiǎo, dànshì bīngxiāng hé zhuōzi dōu yǒu.",
      ...
      },
      {
        speaker: "Marie",
        native: "浴室在哪裡？",
        romanization: "yùshì zài nǎlǐ?",
        french: "Où est la salle de bain ?",
      },
      {
        speaker: "小美",
        native: "浴室在臥室裡面。我的床在窗戶旁邊，燈在床上面。",
        romanization: "yùshì zài wòshì lǐmiàn. wǒ de chuáng zài chuānghù pángbiān, dēng zài chuáng shàngmiàn.",
      ...
      {
        speaker: "Marie",
        native: "你家很舒服！我很喜歡。樓梯在外面嗎？",
        romanization: "nǐ jiā hěn shūfú! wǒ hěn xǐhuān. lóutī zài wàimiàn ma?",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我家在台北。",
        romanization: "wǒ jiā zài táiběi.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個房間很大。",
        romanization: "zhège fángjiān hěn dà.",
    ...
    },
    {
      ...
      example: {
        sentence: "我們在客廳看電視。",
        romanization: "wǒmen zài kètīng kàn diànshì.",
    ...
    },
    {
      ...
      example: {
        sentence: "媽媽在廚房做飯。",
        romanization: "māmā zài chúfáng zuòfàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "我的臥室有一個窗戶。",
        romanization: "wǒ de wòshì yǒu yí ge chuānghù.",
    ...
    },
    {
      ...
      example: {
        sentence: "請關門。",
        romanization: "qǐng guānmén.",
        translation: "Veuillez fermer la porte.",
      },
    },
    {
      term: "窗戶",
      romanization: "chuānghù",
      reading: "ㄔㄨㄤ ㄏㄨˋ",
      french: "Fenêtre",
      english: "Window",
      example: {
        sentence: "請打開窗戶。",
        romanization: "qǐng dǎkāi chuānghù.",
    ...
    },
    {
      ...
      example: {
        sentence: "我的床很舒服。",
        romanization: "wǒ de chuáng hěn shūfú.",
    ...
    },
    {
      ...
      example: {
        sentence: "他坐在沙發上。",
        romanization: "tā zuò zài shāfā shàng.",
        translation: "Il est assis sur le canapé.",
      },
    },
    {
      term: "電視",
      romanization: "diànshì",
      reading: "ㄉㄧㄢˋ ㄕˋ",
      french: "Télévision",
      english: "Television / TV",
      example: {
        sentence: "我們一起看電視吧。",
        romanization: "wǒmen yìqǐ kàn diànshì ba.",
        translation: "Regardons la télé ensemble.",
      },
    },
    {
      term: "冰箱",
      romanization: "bīngxiāng",
      reading: "ㄅㄧㄥ ㄒㄧㄤ",
      french: "Réfrigérateur",
      english: "Refrigerator",
      example: {
        sentence: "水在冰箱裡面。",
        romanization: "shuǐ zài bīngxiāng lǐmiàn.",
    ...
    },
    {
      ...
      example: {
        sentence: "樓梯在門的旁邊。",
        romanization: "lóutī zài mén de pángbiān.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄒㄧㄚˋ ㄇㄧㄢˋ", "ㄕㄤˋ ㄇㄧㄢˋ", "ㄌㄧˇ ㄇㄧㄢˋ", "ㄨㄞˋ ㄇㄧㄢˋ"],
