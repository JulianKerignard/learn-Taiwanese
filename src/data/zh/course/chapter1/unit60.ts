...
export const unit60: CourseUnit = {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "台灣的天氣很熱。",
          romanization: "táiwān de tiānqì hěn rè.",
        ...
        },
        {
          type: "example",
          native: "法國比台灣冷。",
          romanization: "fǎguó bǐ táiwān lěng.",
        ...
        },
        {
          type: "example",
          native: "台北的東西比台南貴。",
          romanization: "táiběi de dōngxi bǐ táinán guì.",
        ...
        },
        {
          type: "example",
          native: "這個比那個便宜多了。",
          romanization: "zhège bǐ nàge piányi duō le.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "還可以，不過有一點貴。",
          romanization: "hái kěyǐ, búguò yǒu yìdiǎn guì.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "小明",
        native: "Sophie，你覺得台灣的天氣怎麼樣？",
        romanization: "Sophie, nǐ juéde táiwān de tiānqì zěnmeyàng?",
        french: "Sophie, comment tu trouves le temps à Taiwan ?",
        note: "覺得 (juéde) = penser/trouver, 怎麼樣 (zěnmeyàng) = comment.",
      },
      {
        speaker: "Sophie",
        native: "很熱！法國比台灣冷很多。不過台灣的冬天不冷，我很喜歡。",
        romanization:
      ...
      },
      {
        speaker: "小明",
        native: "那法國的東西貴不貴？",
        romanization: "nà fǎguó de dōngxi guì bú guì?",
        french: "Et les choses en France, c'est cher ?",
        note: "貴不貴 est la forme A-不-A pour poser une question.",
      },
      {
        speaker: "Sophie",
        native: "比台灣貴多了！台灣的吃的很便宜，而且很好吃。",
        romanization: "bǐ táiwān guì duō le! táiwān de chī de hěn piányi, érqiě hěn hǎochī.",
        french:
      ...
      {
        speaker: "小明",
        native: "台灣的交通方便嗎？你覺得容易還是難？",
        romanization: "táiwān de jiāotōng fāngbiàn ma? nǐ juéde róngyì háishì nán?",
        french:
      ...
      {
        speaker: "Sophie",
        native: "台北的捷運很方便，也很乾淨。比巴黎的地鐵乾淨多了！",
        romanization:
      ...
      {
        speaker: "小明",
        native: "哈哈，巴黎的地鐵不太乾淨嗎？",
        romanization: "hāhā, bālí de dìtiě bú tài gānjìng ma?",
        french: "Haha, le métro de Paris n'est pas très propre ?",
      },
      {
        speaker: "Sophie",
        native: "有一點髒……不過巴黎很漂亮，也很安全。我覺得台灣也很安全！",
        romanization:
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "這個手機壞了。",
        romanization: "zhège shǒujī huài le.",
    ...
    },
    {
      ...
      example: {
        sentence: "台灣的夏天很熱。",
        romanization: "táiwān de xiàtiān hěn rè.",
    ...
    },
    {
      ...
      example: {
        sentence: "冬天法國很冷。",
        romanization: "dōngtiān fǎguó hěn lěng.",
    ...
    },
    {
      ...
      example: {
        sentence: "車站很遠嗎？",
        romanization: "chēzhàn hěn yuǎn ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "學校離我家很近。",
        romanization: "xuéxiào lí wǒ jiā hěn jìn.",
    ...
    },
    {
      ...
      example: {
        sentence: "夜市的東西很便宜。",
        romanization: "yèshì de dōngxi hěn piányi.",
    ...
    },
    {
      ...
      example: {
        sentence: "中文的聲調很難。",
        romanization: "zhōngwén de shēngdiào hěn nán.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個很容易學。",
        romanization: "zhège hěn róngyì xué.",
    ...
    },
    {
      ...
      example: {
        sentence: "你的手很髒，去洗手。",
        romanization: "nǐ de shǒu hěn zāng, qù xǐ shǒu.",
    ...
    },
    {
      ...
      example: {
        sentence: "台灣很安全。",
        romanization: "táiwān hěn ānquán.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄅㄨˋ", "ㄇㄟˊ", "ㄏㄣˇ", "ㄅㄧˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄅㄧˇ", "ㄏㄣˇ", "ㄅㄨˋ", "ㄏㄜˊ"],
