...
export const unit05: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "十一 二十 二十五 九十九 一百",
          romanization: "shíyī èrshí èrshíwǔ jiǔshíjiǔ yìbǎi",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "一個人 / 兩個朋友 / 三個問題",
          romanization: "yí ge rén / liǎng ge péngyǒu / sān ge wèntí",
          translation:
        ...
        },
        {
          type: "example",
          native: "一杯咖啡 / 兩杯茶 / 一碗飯",
          romanization: "yì bēi kāfēi / liǎng bēi chá / yì wǎn fàn",
        ...
        },
        {
          ...
          native: "我不喝酒 vs 我沒喝酒",
          romanization: "wǒ bù hē jiǔ vs wǒ méi hē jiǔ",
          translation:
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "星期一 星期二 星期三 星期四 星期五 星期六 星期天",
          romanization:
        ...
        },
        {
          type: "example",
          native: "現在三點半。",
          romanization: "xiànzài sān diǎn bàn.",
        ...
        },
        {
          type: "example",
          native: "明天星期五，下午兩點見。",
          romanization: "míngtiān xīngqīwǔ, xiàwǔ liǎng diǎn jiàn.",
    ...
    lines: [
      {
        speaker: "Vous",
        native: "你好，我想看房子。",
        romanization: "nǐ hǎo, wǒ xiǎng kàn fángzi.",
        french: "Bonjour, je voudrais visiter l'appartement.",
      },
      {
        speaker: "Proprio",
        native: "好，你什麼時候方便？",
        romanization: "hǎo, nǐ shénme shíhòu fāngbiàn?",
        french: "D'accord, quand est-ce que ça t'arrange ?",
      },
      {
        speaker: "Vous",
        native: "明天可以嗎？星期六。",
        romanization: "míngtiān kěyǐ ma? xīngqīliù.",
        french: "Demain, c'est possible ? Samedi.",
      },
      {
        speaker: "Proprio",
        native: "可以。下午兩點好不好？",
        romanization: "kěyǐ. xiàwǔ liǎng diǎn hǎo bù hǎo?",
      ...
      },
      {
        speaker: "Vous",
        native: "好，兩點見！",
        romanization: "hǎo, liǎng diǎn jiàn!",
        french: "D'accord, à 14h !",
      },
      {
        speaker: "Proprio",
        native: "好，明天見！",
        romanization: "hǎo, míngtiān jiàn!",
        french: "OK, à demain !",
      },
    ],
  },
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "今天星期幾？",
        romanization: "jīntiān xīngqī jǐ?",
        translation: "On est quel jour aujourd'hui ?",
      },
    },
    {
      term: "明天",
      romanization: "míngtiān",
      reading: "ㄇㄧㄥˊ ㄊㄧㄢ",
      french: "Demain",
      english: "Tomorrow",
      example: {
    ...
    },
    {
      ...
      example: {
        sentence: "今天星期三。",
        romanization: "jīntiān xīngqīsān.",
    ...
    },
    {
      ...
      example: {
        sentence: "三點十五分。",
        romanization: "sān diǎn shíwǔ fēn.",
        translation: "Trois heures quinze.",
      },
    },
    {
      term: "現在",
      romanization: "xiànzài",
      reading: "ㄒㄧㄢˋ ㄗㄞˋ",
      french: "Maintenant",
      english: "Now",
      example: {
    ...
    },
    {
      ...
      example: {
        sentence: "我沒去過台灣。",
        romanization: "wǒ méi qù guò Táiwān.",
    ...
    },
    {
      ...
      example: {
        sentence: "你有時間嗎？",
        romanization: "nǐ yǒu shíjiān ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "今年是二〇二六年。",
        romanization: "jīnnián shì èr líng èr liù nián.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄦˋ ㄕˊ ㄨˇ", "ㄦˋ ㄨˇ", "ㄕˊ ㄦˋ ㄨˇ", "ㄌㄧㄤˇ ㄕˊ ㄨˇ"],
    },
    {
      id: "unit-05-ex2",
      type: "fill-blank",
      ...
      optionsReading: ["ㄌㄧㄤˇ", "ㄦˋ", "ㄕㄨㄤ", "ㄌㄧㄚˇ"],
      hint: "Devant un classificateur, on utilise 兩, pas 二.",
      hintReading: "Devant un classificateur, on utilise 兩, pas 二.",
    },
    {
      id: "unit-05-ex3",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄇㄧㄥˊ ㄊㄧㄢ ㄌㄧㄤˇ ㄉㄧㄢˇ ㄐㄧㄢˋ", "ㄌㄧㄤˇ ㄉㄧㄢˇ ㄇㄧㄥˊ ㄊㄧㄢ ㄐㄧㄢˋ", "ㄐㄧㄢˋ ㄇㄧㄥˊ ㄊㄧㄢ ㄌㄧㄤˇ ㄉㄧㄢˇ", "ㄇㄧㄥˊ ㄊㄧㄢ ㄐㄧㄢˋ ㄌㄧㄤˇ ㄉㄧㄢˇ"],
    },
  ],
