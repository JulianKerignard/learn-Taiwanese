...
export const unit04: CourseUnit = {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          native: "你好！我叫朱利安，我是法國人。我在學中文。你呢？",
          romanization:
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          native: "我的名字、你的電話、他的朋友",
          romanization: "wǒ de míngzì, nǐ de diànhuà, tā de péngyǒu",
        ...
        },
        {
          ...
          native: "台灣的食物、法國的紅酒",
          romanization: "Táiwān de shíwù, Fǎguó de hóngjiǔ",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "你叫什麼名字？",
          romanization: "nǐ jiào shénme míngzì?",
          translation:
        ...
        },
        {
          type: "example",
          native: "你做什麼工作？",
          romanization: "nǐ zuò shénme gōngzuò?",
          translation:
    ...
    lines: [
      {
        speaker: "Coloc",
        native: "你好！你是新室友嗎？",
        romanization: "nǐ hǎo! nǐ shì xīn shìyǒu ma?",
        french: "Salut ! Tu es le nouveau coloc ?",
      },
      {
        speaker: "Vous",
        native: "是，我是。我叫 Julian，很高興認識你！",
        romanization: "shì, wǒ shì. wǒ jiào Julian, hěn gāoxìng rènshì nǐ!",
        french: "Oui, c'est moi. Je m'appelle Julian, enchanté !",
      },
      {
        speaker: "Coloc",
        native: "我叫小美。你是哪裡人？",
        romanization: "wǒ jiào Xiǎo Měi. nǐ shì nǎlǐ rén?",
        french: "Je m'appelle Xiao Mei. Tu viens d'où ?",
      },
      {
        speaker: "Vous",
        native: "我是法國人。你呢？",
        romanization: "wǒ shì Fǎguó rén. nǐ ne?",
      ...
      },
      {
        speaker: "Coloc",
        native: "我是台灣人。你做什麼工作？",
        romanization: "wǒ shì Táiwān rén. nǐ zuò shénme gōngzuò?",
        french: "Je suis taiwanaise. Tu fais quoi comme travail ?",
      },
      {
        speaker: "Vous",
        native: "我是學生。你也是學生嗎？",
        romanization: "wǒ shì xuéshēng. nǐ yě shì xuéshēng ma?",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "你的名字很好聽。",
        romanization: "nǐ de míngzì hěn hǎo tīng.",
    ...
    },
    {
      ...
      example: {
        sentence: "她是中文老師。",
        romanization: "tā shì zhōngwén lǎoshī.",
        translation: "Elle est professeur de chinois.",
      },
    },
    {
      term: "法國人",
      romanization: "Fǎguó rén",
      reading: "ㄈㄚˇ ㄍㄨㄛˊ ㄖㄣˊ",
    ...
    {
      term: "很高興",
      romanization: "hěn gāoxìng",
      reading: "ㄏㄣˇ ㄍㄠ ㄒㄧㄥˋ",
      french: "Très content / enchanté",
      english: "Very happy / pleased",
      example: {
        sentence: "很高興認識你！",
        romanization: "hěn gāoxìng rènshì nǐ!",
    ...
    },
    {
      ...
      example: {
        sentence: "我也是學生。",
        romanization: "wǒ yě shì xuéshēng.",
    ...
    },
    {
      ...
      example: {
        sentence: "我們是朋友。",
        romanization: "wǒmen shì péngyǒu.",
    ...
    },
    {
      ...
      example: {
        sentence: "他們是台灣人。",
        romanization: "tāmen shì Táiwān rén.",
    ...
    },
    {
      ...
      example: {
        sentence: "再見，明天見！",
        romanization: "zàijiàn, míngtiān jiàn!",
    ...
    },
    {
      ...
      example: {
        sentence: "對，我是法國人。",
        romanization: "duì, wǒ shì Fǎguó rén.",
    ...
    },
    {
      ...
      example: {
        sentence: "你的中文真好！",
        romanization: "nǐ de zhōngwén zhēn hǎo!",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄐㄧㄠˋ ㄇㄚ ㄖ ㄜ", "ㄨㄛˇ ㄕˋ ㄇㄚ ㄖ ㄜ", "ㄇㄚ ㄖ ㄜ ㄐㄧㄠˋ ㄨㄛˇ", "ㄨㄛˇ ㄉㄜ ㄇㄚ ㄖ ㄜ"],
    },
    {
      id: "unit-04-ex2",
      type: "fill-blank",
      ...
      optionsReading: ["ㄐㄧㄠˋ", "ㄕˋ", "ㄗㄨㄛˋ", "ㄧㄡˇ"],
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄛˇ ㄧㄝˇ ㄕˋ ㄒㄩㄝˊ ㄕㄥ", "ㄨㄛˇ ㄕˋ ㄧㄝˇ ㄒㄩㄝˊ ㄕㄥ", "ㄧㄝˇ ㄨㄛˇ ㄕˋ ㄒㄩㄝˊ ㄕㄥ", "ㄨㄛˇ ㄒㄩㄝˊ ㄕㄥ ㄧㄝˇ ㄕˋ"],
    },
  ],
