...
export const unit02: CourseUnit = {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "不是",
          romanization: "bù shì → (prononcé) bú shì",
    ...
    lines: [
      {
        speaker: "Vous",
        native: "我要四杯水。",
        romanization: "wǒ yào sì bēi shuǐ.",
        french: "Je veux quatre verres d'eau.",
      },
      {
        speaker: "Employé",
        native: "四杯？四個人嗎？",
        romanization: "sì bēi? sì ge rén ma?",
        french: "Quatre verres ? Vous êtes quatre ?",
      },
      {
        speaker: "Vous",
        native: "不是，一杯！一杯水。",
        romanization: "bú shì, yì bēi! yì bēi shuǐ.",
      ...
      },
      {
        speaker: "Employé",
        native: "好，一杯水。大杯還是小杯？",
        romanization: "hǎo, yì bēi shuǐ. dà bēi háishì xiǎo bēi?",
        french: "D'accord, un verre d'eau. Grand ou petit ?",
      },
      {
        speaker: "Vous",
        native: "小杯，謝謝！",
        romanization: "xiǎo bēi, xièxiè!",
        french: "Petit, merci !",
      },
    ],
  },
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我的媽媽是老師。",
        romanization: "wǒ de māma shì lǎoshī.",
    ...
    },
    {
      ...
      example: {
        sentence: "台灣有很多馬。",
        romanization: "Táiwān yǒu hěn duō mǎ.",
    ...
    },
    {
      ...
      example: {
        sentence: "我要一杯水。",
        romanization: "wǒ yào yì bēi shuǐ.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個湯很好喝。",
        romanization: "zhège tāng hěn hǎo hē.",
    ...
    },
    {
      ...
      example: {
        sentence: "你要加糖嗎？",
        romanization: "nǐ yào jiā táng ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "大杯還是小杯？",
        romanization: "dà bēi háishì xiǎo bēi?",
    ...
    },
    {
      ...
      example: {
        sentence: "你聽得懂嗎？",
        romanization: "nǐ tīng de dǒng ma?",
  ...
  exercises: [
    ...
    },
    {
      ...
      hintReading: "一 devant les tons 1, 2 et 3 se prononce en ton 4.",
    },
    {
      id: "unit-02-ex7",
      type: "listen",
    ...
    },
    {
      ...
      hintReading: "睡覺 (tons 4-4) = dormir. 水餃 (tons 3-3) = raviolis. Ne pas confondre !",
    },
    {
      id: "unit-02-ex11",
      type: "fill-blank",
