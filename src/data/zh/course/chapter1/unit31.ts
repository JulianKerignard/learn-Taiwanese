...
export const unit31: CourseUnit = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "ㄅ = b (爸), ㄆ = p (怕), ㄇ = m (媽), ㄈ = f (法)",
          romanization: "bà, pà, mā, fǎ",
        ...
        {
          type: "example",
          native: "ㄉ = d (大), ㄊ = t (他), ㄋ = n (你), ㄌ = l (來)",
          romanization: "dà, tā, nǐ, lái",
        ...
        {
          type: "example",
          native: "ㄍ = g (國), ㄎ = k (可), ㄏ = h (好)",
          romanization: "guó, kě, hǎo",
        ...
        {
          type: "example",
          native: "ㄐ = j (家), ㄑ = q (去), ㄒ = x (謝)",
          romanization: "jiā, qù, xiè",
        ...
        {
          type: "example",
          native: "ㄓ = zh (中), ㄔ = ch (吃), ㄕ = sh (是), ㄖ = r (人)",
          romanization: "zhōng, chī, shì, rén",
        ...
        {
          type: "example",
          native: "ㄗ = z (在), ㄘ = c (次), ㄙ = s (三)",
          romanization: "zài, cì, sān",
        ...
        {
          type: "example",
          native: "ㄚ = a (大), ㄛ = o (多), ㄜ = e (的), ㄞ = ai (愛), ㄟ = ei (美)",
          romanization: "dà, duō, de, ài, měi",
        ...
        },
        {
          ...
          romanization: "hǎo, dōu, kàn, hěn, xiǎng, néng",
        ...
        {
          type: "example",
          native: "ㄧ = i (一), ㄨ = u (五), ㄩ = ü (去), ㄦ = er (二)",
          romanization: "yī, wǔ, qù, èr",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "text",
          content:
            "Les marques de ton en reading: Ton 1 → aucune marque (le ton 1 est le « défaut »). Ton 2 → ˊ (accent aigu en haut à droite). Ton 3 → ˇ (caron en haut à droite). Ton 4 → ˋ (accent grave en haut à droite). Ton léger (neutre) → ˙ (point en haut à gauche, devant la syllabe).",
        },
        {
          type: "warning",
          content:
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "Pour taper 你 (nǐ) : S(ㄋ) → U(ㄧ) → 3(ˇ ton 3) → Espace → sélectionner 你",
          romanization: "nǐ",
          translation: "tu/toi",
          content:
    ...
    lines: [
      {
        speaker: "Vous",
        native: "小明，「漂亮」的注音怎麼寫？",
        romanization: "Xiǎo Míng, 'piàoliang' de zhùyīn zěnme xiě?",
        french: "Xiao Ming, comment on écrit « piàoliang » en zhuyin ?",
      },
      {
        speaker: "小明",
        native: "ㄆㄧㄠˋ ˙ㄌㄧㄤ。你在學注音嗎？",
        romanization: "ㄆㄧㄠˋ ˙ㄌㄧㄤ. nǐ zài xué zhùyīn ma?",
        french: "ㄆㄧㄠˋ ˙ㄌㄧㄤ. Tu apprends le zhuyin ?",
      },
      {
        speaker: "Vous",
        native: "對，我想用注音打字。拼音太慢了。",
        romanization: "duì, wǒ xiǎng yòng zhùyīn dǎzì. pīnyīn tài màn le.",
        french: "Oui, je veux taper en zhuyin. Le pinyin c'est trop lent.",
      },
      {
        speaker: "小明",
        native: "很好！你可以先練習ㄅㄆㄇㄈ，慢慢來。",
        romanization: "hěn hǎo! nǐ kěyǐ xiān liànxí ㄅㄆㄇㄈ, mànmàn lái.",
        french: "Très bien ! Tu peux d'abord pratiquer ㄅㄆㄇㄈ, doucement.",
      },
      {
        speaker: "Vous",
        native: "你們小時候怎麼學的？",
        romanization: "nǐmen xiǎoshíhòu zěnme xué de?",
        french: "Comment vous avez appris quand vous étiez petits ?",
      },
      {
        speaker: "小明",
        native: "我們小學一年級就開始學了，每天都要練習念。",
        romanization: "wǒmen xiǎoxué yī niánjí jiù kāishǐ xué le, měitiān dōu yào liànxí niàn.",
        french:
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "台灣人都用注音打字。",
        romanization: "Táiwān rén dōu yòng zhùyīn dǎzì.",
    ...
    },
    {
      ...
      example: {
        sentence: "注音有三十七個符號。",
        romanization: "zhùyīn yǒu sānshíqī ge fúhào.",
    ...
    },
    {
      ...
      example: {
        sentence: "外國人常用拼音學中文。",
        romanization: "wàiguó rén cháng yòng pīnyīn xué Zhōngwén.",
        translation: "Les étrangers utilisent souvent le pinyin pour apprendre le chinois.",
      },
    },
    {
      term: "鍵盤",
      romanization: "jiànpán",
      reading: "ㄐㄧㄢˋ ㄆㄢˊ",
      french: "Clavier",
      english: "Keyboard",
      example: {
        sentence: "台灣的鍵盤上面有注音。",
        romanization: "Táiwān de jiànpán shàngmiàn yǒu zhùyīn.",
    ...
    },
    {
      ...
      example: {
        sentence: "你會用注音打字嗎？",
        romanization: "nǐ huì yòng zhùyīn dǎzì ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "請輸入你的名字。",
        romanization: "qǐng shūrù nǐ de míngzì.",
    ...
    },
    {
      ...
      example: {
        sentence: "你的發音很標準。",
        romanization: "nǐ de fāyīn hěn biāozhǔn.",
        translation: "Ta prononciation est très standard.",
      },
    },
    {
      term: "聲調",
      romanization: "shēngdiào",
      reading: "ㄕㄥ ㄉㄧㄠˋ",
      french: "Ton (en phonétique)",
      english: "Tone",
      example: {
        sentence: "中文有四個聲調。",
        romanization: "Zhōngwén yǒu sì ge shēngdiào.",
    ...
    },
    {
      ...
      example: {
        sentence: "老師叫我們念課文。",
        romanization: "lǎoshī jiào wǒmen niàn kèwén.",
        translation: "Le professeur nous demande de lire le texte à voix haute.",
      },
    },
    {
      term: "標準",
      romanization: "biāozhǔn",
      reading: "ㄅㄧㄠ ㄓㄨㄣˇ",
      french: "Standard, normé",
      english: "Standard",
      example: {
        sentence: "注音是台灣的標準拼音系統。",
        romanization: "zhùyīn shì Táiwān de biāozhǔn pīnyīn xìtǒng.",
    ...
    },
    {
      ...
      example: {
        sentence: "每天練習十分鐘就好。",
        romanization: "měitiān liànxí shí fēnzhōng jiù hǎo.",
    ...
    },
    {
      ...
      example: {
        sentence: "請唸一下這個字。",
        romanization: "qǐng niàn yíxià zhège zì.",
  ...
  exercises: [
    ...
    },
    {
      id: "unit-31-ex4",
      type: "translate",
      question: "Convertissez en romanization: ㄋㄧˇ ㄏㄠˇ",
    ...
    },
    {
      id: "unit-31-ex5",
      type: "translate",
      question: "Convertissez en romanization: ㄒㄧㄝˋ ˙ㄒㄧㄝ",
    ...
    },
    {
      id: "unit-31-ex8",
      type: "translate",
      question: "Convertissez en reading: Táiwān (台灣)",
