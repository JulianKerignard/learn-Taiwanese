...
export const unit52: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "紅色、藍色、白色",
          romanization: "hóngsè, lánsè, báisè",
        ...
        },
        {
          type: "example",
          native: "黑色、綠色、黃色",
          romanization: "hēisè, lǜsè, huángsè",
        ...
        },
        {
          type: "example",
          native: "這件衣服是藍色的。",
          romanization: "zhè jiàn yīfú shì lánsè de.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "這個很大，那個很小。",
          romanization: "zhège hěn dà, nàge hěn xiǎo.",
        ...
        {
          type: "example",
          native: "她的頭髮很長，他的頭髮很短。",
          romanization: "tā de tóufǎ hěn cháng, tā de tóufǎ hěn duǎn.",
        ...
        },
        {
          type: "example",
          native: "他很高，我很矮。",
          romanization: "tā hěn gāo, wǒ hěn ǎi.",
        ...
        },
        {
          type: "example",
          native: "她真漂亮！",
          romanization: "tā zhēn piàoliang!",
        ...
        },
        {
          type: "example",
          native: "這件衣服太好看了！",
          romanization: "zhè jiàn yīfú tài hǎokàn le!",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "紅色代表好運。",
          romanization: "hóngsè dàibiǎo hǎoyùn.",
        ...
        },
        {
          type: "example",
          native: "白色是喪事的顏色。",
          romanization: "báisè shì sāngshì de yánsè.",
        ...
        },
        {
          type: "example",
          native: "黃色以前是皇帝的顏色。",
          romanization: "huángsè yǐqián shì huángdì de yánsè.",
  ...
  dialogue: {
    ...
    lines: [
      ...
      {
        speaker: "Sophie",
        native: "真好看！可是太大了。有沒有小一點的？",
        romanization: "zhēn hǎokàn! kěshì tài dà le. yǒu méiyǒu xiǎo yìdiǎn de?",
      ...
      {
        speaker: "老闆",
        native: "有，你看這件。大小剛好，顏色也很好看。",
        romanization: "yǒu, nǐ kàn zhè jiàn. dàxiǎo gānghǎo, yánsè yě hěn hǎokàn.",
        french: "Oui, regarde celle-ci. La taille est parfaite, et la couleur est belle aussi.",
        note: "剛好 (gānghǎo) = juste bien, parfait.",
      },
      {
        speaker: "Sophie",
        native: "這是送給我台灣朋友的禮物。紅色好不好？",
        romanization: "zhè shì sòng gěi wǒ táiwān péngyǒu de lǐwù. hóngsè hǎo bù hǎo?",
        french: "C'est un cadeau pour mon amie taiwanaise. Le rouge, c'est bien ?",
      },
      {
        speaker: "老闆",
        native: "紅色很好！在台灣，紅色代表好運。你的朋友一定很開心！",
        romanization:
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "她喜歡紅色的花。",
        romanization: "tā xǐhuān hóngsè de huā.",
    ...
    },
    {
      ...
      example: {
        sentence: "他穿白色的衣服。",
        romanization: "tā chuān báisè de yīfú.",
    ...
    },
    {
      ...
      example: {
        sentence: "我的包包是黑色的。",
        romanization: "wǒ de bāobāo shì hēisè de.",
    ...
    },
    {
      ...
      example: {
        sentence: "我喜歡喝綠茶。",
        romanization: "wǒ xǐhuān hē lǜchá.",
        translation: "J'aime boire du thé vert.",
      },
    },
    {
      term: "黃色",
      romanization: "huángsè",
      reading: "ㄏㄨㄤˊ ㄙㄜˋ",
      french: "Jaune",
      english: "Yellow",
      example: {
        sentence: "這朵花是黃色的。",
        romanization: "zhè duǒ huā shì huángsè de.",
    ...
    },
    {
      ...
      example: {
        sentence: "他的狗很小。",
        romanization: "tā de gǒu hěn xiǎo.",
    ...
    },
    {
      ...
      example: {
        sentence: "她的頭髮很短。",
        romanization: "tā de tóufǎ hěn duǎn.",
    ...
    },
    {
      ...
      example: {
        sentence: "台北101很高。",
        romanization: "táiběi yī líng yī hěn gāo.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個地方很漂亮。",
        romanization: "zhège dìfāng hěn piàoliang.",
    ...
    },
    {
      ...
      example: {
        sentence: "這是我的新手機。",
        romanization: "zhè shì wǒ de xīn shǒujī.",
    ...
    },
    {
      ...
      example: {
        sentence: "這件衣服太舊了。",
        romanization: "zhè jiàn yīfú tài jiù le.",
