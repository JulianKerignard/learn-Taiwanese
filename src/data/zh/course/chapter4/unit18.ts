...
export const unit18: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "你來台灣多久了？",
          romanization: "nǐ lái Táiwān duōjiǔ le?",
        ...
        },
        {
          type: "example",
          native: "我來了三個月了",
          romanization: "wǒ lái le sān ge yuè le",
        ...
        },
        {
          type: "example",
          native: "你為什麼來台灣？",
          romanization: "nǐ wèishénme lái Táiwān?",
        ...
        },
        {
          type: "example",
          native: "我越來越喜歡台灣",
          romanization: "wǒ yuè lái yuè xǐhuān Táiwān",
        ...
        },
        {
          type: "example",
          native: "中文越來越難",
          romanization: "Zhōngwén yuè lái yuè nán",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我喜歡看電影和聽音樂",
          romanization: "wǒ xǐhuān kàn diànyǐng hé tīng yīnyuè",
        ...
        },
        {
          type: "example",
          native: "我的興趣是旅行和拍照",
          romanization: "wǒ de xìngqù shì lǚxíng hé pāi zhào",
        ...
        },
        {
          type: "example",
          native: "週末我常去爬山",
          romanization: "zhōumò wǒ cháng qù pá shān",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "你有男朋友嗎？",
          romanization: "nǐ yǒu nán péngyǒu ma?",
        ...
        },
        {
          type: "example",
          native: "我們可以做語言交換嗎？",
          romanization: "wǒmen kěyǐ zuò yǔyán jiāohuàn ma?",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "美玲",
        native: "嗨！你好，我叫美玲。你來台灣多久了？",
        romanization: "hāi! nǐ hǎo, wǒ jiào Měilíng. nǐ lái Táiwān duōjiǔ le?",
        french: "Salut ! Je m'appelle Meiling. Tu es à Taiwan depuis combien de temps ?",
      },
      {
        speaker: "你",
        native: "我來了兩個月了。我是法國人，我來台灣學中文。",
        romanization: "wǒ lái le liǎng ge yuè le. wǒ shì Fǎguó rén, wǒ lái Táiwān xué Zhōngwén.",
        french: "Ça fait deux mois. Je suis français, je suis venu à Taiwan pour apprendre le chinois.",
      },
      {
        speaker: "美玲",
        native: "太好了！台灣怎麼樣？你習慣了嗎？",
        romanization: "tài hǎo le! Táiwān zěnmeyàng? nǐ xíguàn le ma?",
        french: "Super ! C'est comment Taiwan ? Tu t'es habitué ?",
      },
      {
        speaker: "你",
        native: "我越來越喜歡！你的興趣是什麼？",
        romanization: "wǒ yuè lái yuè xǐhuān! nǐ de xìngqù shì shénme?",
        french: "J'aime de plus en plus ! Tes centres d'intérêt, c'est quoi ?",
      },
      {
        speaker: "美玲",
        native: "我喜歡旅行和拍照。你呢？你為什麼想學中文？",
        romanization: "wǒ xǐhuān lǚxíng hé pāi zhào. nǐ ne? nǐ wèishénme xiǎng xué Zhōngwén?",
        french: "J'aime voyager et prendre des photos. Et toi ? Pourquoi tu veux apprendre le chinois ?",
      },
      {
        speaker: "你",
        native: "因為我覺得中文很有意思，而且台灣人很開心。",
        romanization: "yīnwèi wǒ juéde Zhōngwén hěn yǒu yìsi, érqiě Táiwān rén hěn kāixīn.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "你學中文多久了？",
        romanization: "nǐ xué Zhōngwén duōjiǔ le?",
    ...
    },
    {
      ...
      example: {
        sentence: "認識你很開心。",
        romanization: "rènshì nǐ hěn kāixīn.",
    ...
    },
    {
      ...
      example: {
        sentence: "台灣的文化很有趣。",
        romanization: "Táiwān de wénhuà hěn yǒuqù.",
    ...
    },
    {
      ...
      example: {
        sentence: "你會說幾種語言？",
        romanization: "nǐ huì shuō jǐ zhǒng yǔyán?",
        translation: "Tu parles combien de langues ?",
      },
    },
    {
      term: "交換",
      romanization: "jiāohuàn",
      reading: "ㄐㄧㄠ ㄏㄨㄢˋ",
      french: "Échanger",
      english: "To exchange",
      example: {
        sentence: "我們做語言交換吧。",
        romanization: "wǒmen zuò yǔyán jiāohuàn ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "我喜歡聽台灣的音樂。",
        romanization: "wǒ xǐhuān tīng Táiwān de yīnyuè.",
    ...
    },
    {
      ...
      example: {
        sentence: "你喜歡什麼運動？",
        romanization: "nǐ xǐhuān shénme yùndòng?",
    ...
    },
    {
      ...
      example: {
        sentence: "我想去日本旅行。",
        romanization: "wǒ xiǎng qù Rìběn lǚxíng.",
    ...
    },
    {
      ...
      example: {
        sentence: "我可以拍照嗎？",
        romanization: "wǒ kěyǐ pāi zhào ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "你習慣台灣的天氣嗎？",
        romanization: "nǐ xíguàn Táiwān de tiānqì ma?",
        translation: "Tu t'es habitué au climat de Taiwan ?",
      },
    },
    {
      term: "適應",
      romanization: "shìyìng",
      reading: "ㄕˋ ㄧㄥˋ",
      french: "S'adapter",
      english: "To adapt",
      example: {
        sentence: "我還在適應這裡的生活。",
        romanization: "wǒ hái zài shìyìng zhèlǐ de shēnghuó.",
    ...
    },
    {
      ...
      example: {
        sentence: "你的興趣是什麼？",
        romanization: "nǐ de xìngqù shì shénme?",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄉㄨㄛ ㄐㄧㄡˇ", "ㄉㄨㄛ ㄕㄠˇ", "ㄗㄣˇ ㄇㄜ˙", "ㄕㄣˊ ㄇㄜ˙"],
      hint: "Quel mot signifie « combien de temps » ?",
      hintReading: "Quel mot signifie « combien de temps » ?",
    },
    {
      id: "unit-18-ex2",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄩㄝˋ ㄌㄞˊ ㄩㄝˋ ㄒㄧˇ ㄏㄨㄢ ㄊㄞˊ ㄨㄢ", "ㄨㄛˇ ㄏㄣˇ ㄒㄧˇ ㄏㄨㄢ ㄊㄞˊ ㄨㄢ", "ㄨㄛˇ ㄗㄨㄟˋ ㄒㄧˇ ㄏㄨㄢ ㄊㄞˊ ㄨㄢ", "ㄨㄛˇ ㄅㄧˇ ㄐㄧㄠˋ ㄒㄧˇ ㄏㄨㄢ ㄊㄞˊ ㄨㄢ"],
    },
    {
      id: "unit-18-ex3",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄨㄟˋ ㄕㄣˊ ㄇㄜ˙", "ㄗㄣˇ ㄇㄜ˙ ㄧㄤˋ", "ㄕㄣˊ ㄇㄜ˙ ㄕˊ ㄏㄡˋ", "ㄉㄨㄛ ㄐㄧㄡˇ"],
      hint: "Quel mot interrogatif signifie « pourquoi » ?",
      hintReading: "Quel mot interrogatif signifie « pourquoi » ?",
    },
    {
      id: "unit-18-ex5",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄒㄧㄥˋ ㄑㄩˋ", "ㄒㄧˇ ㄏㄨㄢ", "ㄒㄧㄤˇ ㄈㄚˇ", "ㄩˇ ㄧㄢˊ"],
      hint: "Quel mot signifie « centres d'intérêt / hobbies » ?",
      hintReading: "Quel mot signifie « centres d'intérêt / hobbies » ?",
    },
  ],
