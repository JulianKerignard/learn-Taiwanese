...
export const unit54: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我想去台灣旅行。",
          romanization: "wǒ xiǎng qù Táiwān lǚxíng.",
        ...
        },
        {
          type: "example",
          native: "你的護照帶了嗎？",
          romanization: "nǐ de hùzhào dài le ma?",
        ...
        },
        {
          type: "example",
          native: "我已經買好機票了。",
          romanization: "wǒ yǐjīng mǎi hǎo jīpiào le.",
        ...
        },
        {
          type: "example",
          native: "行李太多了，怎麼辦？",
          romanization: "xíngli tài duō le, zěnme bàn?",
        ...
        },
        {
          type: "example",
          native: "這個飯店的房間很大。",
          romanization: "zhège fàndiàn de fángjiān hěn dà.",
        ...
        },
        {
          type: "example",
          native: "我要訂房，兩個晚上。",
          romanization: "wǒ yào dìngfáng, liǎng gè wǎnshàng.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我們先去花蓮，再去墾丁。",
          romanization: "wǒmen xiān qù Huālián, zài qù Kěndīng.",
        ...
        },
        {
          type: "example",
          native: "先訂房，再買機票。",
          romanization: "xiān dìngfáng, zài mǎi jīpiào.",
        ...
        },
        {
          type: "example",
          native: "先吃早餐，再出發。",
          romanization: "xiān chī zǎocān, zài chūfā.",
        ...
        {
          type: "example",
          native: "從台北到花蓮坐火車要兩個小時。",
          romanization: "cóng Táiběi dào Huālián zuò huǒchē yào liǎng gè xiǎoshí.",
        ...
        },
        {
          type: "example",
          native: "從機場到飯店怎麼去？",
          romanization: "cóng jīchǎng dào fàndiàn zěnme qù?",
        ...
        },
        {
          type: "example",
          native: "從這裡到日月潭要多久？",
          romanization: "cóng zhèlǐ dào Rìyuètán yào duōjiǔ?",
        ...
        },
        {
          type: "example",
          native: "坐高鐵只要一個半小時。",
          romanization: "zuò gāotiě zhǐ yào yí gè bàn xiǎoshí.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我想坐高鐵去高雄。",
          romanization: "wǒ xiǎng zuò gāotiě qù Gāoxióng.",
        ...
        {
          type: "example",
          native: "花蓮的太魯閣很漂亮，一定要去看看。",
          romanization: "Huālián de Tàilǔgé hěn piàoliang, yídìng yào qù kànkan.",
        ...
        },
        {
          type: "example",
          native: "日月潭是台灣最有名的湖。",
          romanization: "Rìyuètán shì Táiwān zuì yǒumíng de hú.",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "你",
        native: "小明，這個週末我們去花蓮玩，好不好？",
        romanization: "Xiǎo Míng, zhège zhōumò wǒmen qù Huālián wán, hǎo bù hǎo?",
        french: "Xiao Ming, ce week-end on va s'amuser à Hualien, d'accord ?",
      },
      {
        speaker: "小明",
        native: "好啊！從台北到花蓮要多久？",
        romanization: "hǎo a! cóng Táiběi dào Huālián yào duōjiǔ?",
        french: "D'accord ! De Taipei à Hualien, ça prend combien de temps ?",
        note: "從A到B + 要多久 pour demander la durée d'un trajet.",
      },
      {
        speaker: "你",
        native: "坐火車大概要兩個小時。我已經買好機票...不對，火車票了！",
        romanization: "zuò huǒchē dàgài yào liǎng gè xiǎoshí. wǒ yǐjīng mǎi hǎo jīpiào... búduì, huǒchē piào le!",
        french: "En train ça prend environ deux heures. J'ai déjà acheté les billets d'av... non, les billets de train !",
      },
      {
        speaker: "小明",
        native: "太好了！那飯店訂了嗎？",
        romanization: "tài hǎo le! nà fàndiàn dìng le ma?",
        french: "Super ! Et l'hôtel, c'est réservé ?",
        note: "訂了嗎 = est-ce que c'est réservé ? 了 marque l'accomplissement.",
      },
      {
        speaker: "你",
        native: "還沒，我們先訂房，再想去哪裡玩。",
        romanization: "hái méi, wǒmen xiān dìngfáng, zài xiǎng qù nǎlǐ wán.",
      ...
      {
        speaker: "小明",
        native: "我想去太魯閣看風景，還想去夜市吃東西。",
        romanization: "wǒ xiǎng qù Tàilǔgé kàn fēngjǐng, hái xiǎng qù yèshì chī dōngxi.",
        french: "Je veux aller voir les paysages à Taroko, et aussi aller au marché de nuit manger.",
      },
      {
        speaker: "你",
        native: "沒問題！先去太魯閣，再去夜市，這樣最好。別忘了帶相機拍照片！",
        romanization: "méi wèntí! xiān qù Tàilǔgé, zài qù yèshì, zhèyàng zuì hǎo. bié wàng le dài xiàngjī pāi zhàopiàn!",
      ...
      {
        speaker: "小明",
        native: "好，我也要買一些紀念品回來送朋友。出發吧！",
        romanization: "hǎo, wǒ yě yào mǎi yìxiē jìniànpǐn huílái sòng péngyou. chūfā ba!",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "機票多少錢？",
        romanization: "jīpiào duōshǎo qián?",
    ...
    },
    {
      ...
      example: {
        sentence: "請給我看你的護照。",
        romanization: "qǐng gěi wǒ kàn nǐ de hùzhào.",
    ...
    },
    {
      ...
      example: {
        sentence: "你有台灣的地圖嗎？",
        romanization: "nǐ yǒu Táiwān de dìtú ma?",
        translation: "Tu as une carte de Taïwan ?",
      },
    },
    {
      term: "照片",
      romanization: "zhàopiàn",
      reading: "ㄓㄠˋ ㄆㄧㄢˋ",
      french: "Photo",
      english: "Photo",
      example: {
        sentence: "我們一起拍照片吧！",
        romanization: "wǒmen yìqǐ pāi zhàopiàn ba!",
        translation: "Prenons une photo ensemble !",
      },
    },
    {
      term: "紀念品",
      romanization: "jìniànpǐn",
      reading: "ㄐㄧˋ ㄋㄧㄢˋ ㄆㄧㄣˇ",
      french: "Souvenir (objet)",
      english: "Souvenir",
      example: {
        sentence: "我買了一些紀念品。",
        romanization: "wǒ mǎi le yìxiē jìniànpǐn.",
    ...
    },
    {
      ...
      example: {
        sentence: "這個導遊說中文和法文。",
        romanization: "zhège dǎoyóu shuō Zhōngwén hé Fǎwén.",
    ...
    },
    {
      ...
      example: {
        sentence: "你什麼時候回來？",
        romanization: "nǐ shénme shíhòu huílái?",
    ...
    },
    {
      ...
      example: {
        sentence: "我們明天早上八點出發。",
        romanization: "wǒmen míngtiān zǎoshang bā diǎn chūfā.",
    ...
    },
    {
      ...
      example: {
        sentence: "我們下午三點到達花蓮。",
        romanization: "wǒmen xiàwǔ sān diǎn dàodá Huālián.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄒㄧㄢ...ㄗㄞˋ", "ㄘㄨㄥˊ...ㄉㄠˋ", "ㄧㄣ ㄨㄟˋ...ㄙㄨㄛˇ ㄧˇ", "ㄙㄨㄟ ㄖㄢˊ...ㄉㄢˋ ㄕˋ"],
      hint: "Quelle paire de mots exprime une séquence « d'abord... ensuite... » ?",
      hintReading: "Quelle paire de mots exprime une séquence « d'abord... ensuite... » ?",
    },
    {
      id: "unit-54-ex3",
      type: "translate",
      ...
      optionsReading: ["ㄘㄨㄥˊ ㄐㄧ ㄔㄤˇ ㄉㄠˋ ㄈㄢˋ ㄉㄧㄢˋ ㄧㄠˋ ㄉㄨㄛ ㄐㄧㄡˇ", "ㄐㄧ ㄔㄤˇ ㄈㄢˋ ㄉㄧㄢˋ ㄉㄨㄛ ㄐㄧㄡˇ ㄉㄠˋ", "ㄘㄨㄥˊ ㄈㄢˋ ㄉㄧㄢˋ ㄉㄠˋ ㄐㄧ ㄔㄤˇ ㄉㄨㄛ ㄐㄧㄡˇ ㄧㄠˋ", "ㄧㄠˋ ㄉㄨㄛ ㄐㄧㄡˇ ㄘㄨㄥˊ ㄐㄧ ㄔㄤˇ ㄉㄠˋ ㄈㄢˋ ㄉㄧㄢˋ"],
    },
    {
      id: "unit-54-ex4",
      type: "listen",
    ...
    },
    {
      ...
      optionsReading: ["ㄘㄨㄥˊ...ㄉㄠˋ", "ㄒㄧㄢ...ㄗㄞˋ", "ㄗㄞˋ...ㄌㄧˇ", "ㄍㄣ...ㄧˋ ㄑㄧˇ"],
      hint: "Quelle paire de mots exprime un trajet « de... à... » ?",
      hintReading: "Quelle paire de mots exprime un trajet « de... à... » ?",
    },
    {
      id: "unit-54-ex7",
      type: "translate",
      ...
      optionsReading: ["ㄒㄧㄢ ㄔ ㄗㄠˇ ㄘㄢ ㄗㄞˋ ㄔㄨ ㄈㄚ", "ㄗㄞˋ ㄔ ㄗㄠˇ ㄘㄢ ㄒㄧㄢ ㄔㄨ ㄈㄚ", "ㄘㄨㄥˊ ㄗㄠˇ ㄘㄢ ㄉㄠˋ ㄔㄨ ㄈㄚ", "ㄔ ㄗㄠˇ ㄘㄢ ㄧˇ ㄏㄡˋ ㄔㄨ ㄈㄚ ㄌㄜ˙"],
    },
    {
      id: "unit-54-ex8",
      type: "listen",
