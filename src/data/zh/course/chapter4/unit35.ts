  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "這裡有房間出租嗎？",
        romanization: "zhèlǐ yǒu fángjiān chūzū ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "這間房間大概十坪。",
        romanization: "zhè jiān fángjiān dàgài shí píng.",
        translation: "Cette chambre fait environ 10 ping.",
      },
    },
    {
      term: "寵物",
      romanization: "chǒngwù",
      reading: "ㄔㄨㄥˇ ㄨˋ",
      french: "Animal de compagnie",
      english: "Pet",
      example: {
        sentence: "你可以養寵物嗎？",
        romanization: "nǐ kěyǐ yǎng chǒngwù ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "淡水的夕陽很漂亮。",
        romanization: "Dànshuǐ de xīyáng hěn piàoliang.",
    ...
    },
    {
      ...
      example: {
        sentence: "我想請一天假。",
        romanization: "wǒ xiǎng qǐng yì tiān jià.",
