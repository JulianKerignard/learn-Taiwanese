...
export const unit20: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "對不起，我遲到了。",
          romanization: "duìbuqǐ, wǒ chídào le.",
        ...
        },
        {
          type: "example",
          native: "非常抱歉，給您帶來不便。",
          romanization: "fēicháng bàoqiàn, gěi nín dàilái búbiàn.",
        ...
        },
        {
          type: "example",
          native: "麻煩你幫我拿一下。",
          romanization: "máfan nǐ bāng wǒ ná yíxià.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "您好，請問貴姓？",
          romanization: "nín hǎo, qǐngwèn guìxìng?",
        ...
        },
        {
          type: "example",
          native: "沒關係，不客氣。",
          romanization: "méi guānxi, bú kèqi.",
        ...
        },
        {
          type: "example",
          native: "辛苦了！你做得很好。",
          romanization: "xīnkǔ le! nǐ zuò de hěn hǎo.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我再想想。",
          romanization: "wǒ zài xiǎngxiang.",
        ...
        },
        {
          type: "example",
          native: "哪裡哪裡，沒有啦。",
          romanization: "nǎlǐ nǎlǐ, méiyǒu la.",
        ...
        {
          type: "example",
          native: "這個想法不錯，不過我們也可以考慮另一個方法",
          romanization: "zhège xiǎngfǎ búcuò, búguò wǒmen yě kěyǐ kǎolǜ lìng yí ge fāngfǎ",
        ...
        },
        {
          type: "example",
          native: "那下次我請你",
          romanization: "nà xià cì wǒ qǐng nǐ",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "Paul (formel)",
        native: "您好，不好意思，請問辦簽證在哪裡？",
        romanization: "nín hǎo, bù hǎo yìsi, qǐngwèn bàn qiānzhèng zài nǎlǐ?",
        french:
      ...
      },
      {
        speaker: "Paul",
        native: "好，沒關係，下次吧！",
        romanization: "hǎo, méi guānxi, xià cì ba!",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      example: {
        sentence: "麻煩你了，謝謝。",
        romanization: "máfan nǐ le, xièxie.",
    ...
    },
    {
      ...
      example: {
        sentence: "沒關係，別擔心。",
        romanization: "méi guānxi, bié dānxīn.",
        translation: "Ce n'est rien, ne t'inquiète pas.",
      },
    },
    {
      term: "不客氣",
      romanization: "bú kèqi",
      reading: "ㄅㄨˊ ㄎㄜˋ ㄑㄧˋ",
      french: "De rien / je t'en prie",
      english: "You're welcome",
      example: {
        sentence: "不客氣，這是應該的。",
        romanization: "bú kèqi, zhè shì yīnggāi de.",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "jīntiān xīnkǔ le, huíjiā xiūxi ba.",
    ...
    },
    {
      ...
      example: {
        sentence: "不要讓他丟面子。",
        romanization: "bú yào ràng tā diū miànzi.",
    ...
    },
    {
      ...
      example: {
        sentence: "他很有禮貌。",
        romanization: "tā hěn yǒu lǐmào.",
        translation: "Il est très poli.",
      },
    },
    {
      term: "尊重",
      romanization: "zūnzhòng",
      reading: "ㄗㄨㄣ ㄓㄨㄥˋ",
      french: "Respecter / respect",
      english: "To respect / respect",
      example: {
        sentence: "我們要尊重別人。",
        romanization: "wǒmen yào zūnzhòng biérén.",
    ...
    },
    {
      ...
      example: {
        sentence: "讓我想一下。",
        romanization: "ràng wǒ xiǎng yíxià.",
    ...
    },
    {
      ...
      example: {
        sentence: "請給我一杯水。",
        romanization: "qǐng gěi wǒ yì bēi shuǐ.",
    ...
    },
    {
      ...
      example: {
        sentence: "我跟朋友一起去。",
        romanization: "wǒ gēn péngyǒu yìqǐ qù.",
  ...
  exercises: [
    {
      ...
      optionsReading: ["ㄅㄨˋ ㄏㄠˇ ㄧˋ ㄙ˙", "ㄉㄨㄟˋ ㄅㄨˋ ㄑㄧˇ", "ㄅㄠˋ ㄑㄧㄢˋ", "ㄍㄢˋ ㄇㄚˊ"],
    },
    {
      id: "unit-20-ex2",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄅㄨˋ ㄏㄠˇ ㄧˋ ㄙ˙", "ㄉㄨㄟˋ ㄅㄨˋ ㄑㄧˇ", "ㄅㄠˋ ㄑㄧㄢˋ", "ㄒㄧㄝˋ ㄒㄧㄝˋ"],
      hint: "Quelle expression pour déranger poliment quelqu'un ?",
      hintReading: "Quelle expression pour déranger poliment quelqu'un ?",
    },
    {
      id: "unit-20-ex4",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄋㄚˇ ㄌㄧˇ ㄋㄚˇ ㄌㄧˇ", "ㄒㄧㄝˋ ㄒㄧㄝˋ", "ㄉㄨㄟˋ ㄚ˙", "ㄨㄛˇ ㄓ ㄉㄠˋ"],
    },
    {
      id: "unit-20-ex6",
      type: "comprehension",
    ...
    },
    {
      ...
      options: [
        "不好意思，請問洗手間在哪裡？ (gene legere + formule polie)",
        "欸，洗手間在哪裡？ (trop informel pour un inconnu)",
        "對不起，洗手間在哪裡？ (trop grave, c'est une vraie excuse)",
        "抱歉，洗手間在哪裡？ (trop formel pour la rue)",
      ],
    },
    {
      id: "unit-20-ex8",
      ...
      options: [
        "對不起 — c'est une vraie faute qui merite une excuse sincere",
        "不好意思 — c'est juste une gene legere",
        "算了 — laissez tomber",
        "沒關係 — ce n'est pas grave",
      ],
    },
    {
      id: "unit-20-ex9",
