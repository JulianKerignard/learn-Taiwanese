...
export const unit81: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "他長得很高。",
          romanization: "tā zhǎng de hěn gāo.",
        ...
        },
        {
          type: "example",
          native: "她長得很漂亮，頭髮很長。",
          romanization: "tā zhǎng de hěn piàoliang, tóufa hěn cháng.",
        ...
        },
        {
          type: "example",
          native: "他以前很瘦，現在比較胖了。",
          romanization: "tā yǐqián hěn shòu, xiànzài bǐjiào pàng le.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我想買一件衣服。",
          romanization: "wǒ xiǎng mǎi yí jiàn yīfu.",
        ...
        },
        {
          type: "example",
          native: "這條褲子多少錢？",
          romanization: "zhè tiáo kùzi duōshǎo qián?",
        ...
        },
        {
          type: "example",
          native: "我需要一雙新鞋子。",
          romanization: "wǒ xūyào yì shuāng xīn xiézi.",
        ...
        },
        {
          type: "example",
          native: "你穿紅色的衣服很好看！",
          romanization: "nǐ chuān hóngsè de yīfu hěn hǎokàn!",
        ...
        },
        {
          type: "example",
          native: "我喜歡藍色的帽子。",
          romanization: "wǒ xǐhuan lánsè de màozi.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "這件衣服很合適！",
          romanization: "zhè jiàn yīfu hěn héshì!",
        ...
        {
          type: "example",
          native: "有沒有大一點的？這個太小了。",
          romanization: "yǒu méiyǒu dà yìdiǎn de? zhège tài xiǎo le.",
        ...
        },
        {
          type: "example",
          native: "這件裙子的顏色好漂亮！",
          romanization: "zhè jiàn qúnzi de yánsè hǎo piàoliang!",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "你",
        native: "小玲，你覺得這件衣服怎麼樣？",
        romanization: "Xiǎo Líng, nǐ juéde zhè jiàn yīfu zěnmeyàng?",
        french: "Xiao Ling, tu penses quoi de ce vêtement ?",
      },
      {
        speaker: "小玲",
        native: "顏色很好看！你穿白色的很合適。",
        romanization: "yánsè hěn hǎokàn! nǐ chuān báisè de hěn héshì.",
        french: "La couleur est jolie ! Le blanc te va bien.",
        note: "白色 = blanc. 合適 = convenir.",
      },
      {
        speaker: "你",
        native: "可是我覺得太小了，有沒有大一點的？",
        romanization: "kěshì wǒ juéde tài xiǎo le, yǒu méiyǒu dà yìdiǎn de?",
        french: "Mais je trouve que c'est trop petit, vous avez un peu plus grand ?",
        note: "太小了 = trop petit. 大一點 = un peu plus grand.",
      },
      {
        speaker: "老闆",
        native: "有，L號的在這裡。你可以試穿看看。",
        romanization: "yǒu, L hào de zài zhèlǐ. nǐ kěyǐ shìchuān kànkan.",
      ...
      },
      {
        speaker: "你",
        native: "這件多少錢？",
        romanization: "zhè jiàn duōshǎo qián?",
        french: "Combien coûte celui-ci ?",
      },
      {
        speaker: "老闆",
        native: "三百元。你買兩件的話，五百就好。",
        romanization: "sānbǎi yuán. nǐ mǎi liǎng jiàn de huà, wǔbǎi jiù hǎo.",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "你今天穿的衣服很好看！",
        romanization: "nǐ jīntiān chuān de yīfu hěn hǎokàn!",
    ...
    },
    {
      ...
      example: {
        sentence: "她穿了一條紅裙子。",
        romanization: "tā chuān le yì tiáo hóng qúnzi.",
    ...
    },
    {
      ...
      example: {
        sentence: "你的鞋子好好看！",
        romanization: "nǐ de xiézi hǎo hǎokàn!",
    ...
    },
    {
      ...
      example: {
        sentence: "出門記得戴帽子。",
        romanization: "chūmén jìde dài màozi.",
    ...
    },
    {
      ...
      example: {
        sentence: "我不矮，你太高了！",
        romanization: "wǒ bù ǎi, nǐ tài gāo le!",
    ...
    },
    {
      ...
      example: {
        sentence: "你最近胖了一點。",
        romanization: "nǐ zuìjìn pàng le yìdiǎn.",
    ...
    },
    {
      ...
      example: {
        sentence: "她很瘦，要多吃一點。",
        romanization: "tā hěn shòu, yào duō chī yìdiǎn.",
    ...
    },
    {
      ...
      example: {
        sentence: "她的頭髮很長。",
        romanization: "tā de tóufa hěn cháng.",
    ...
    },
    {
      ...
      example: {
        sentence: "我喜歡短頭髮。",
        romanization: "wǒ xǐhuan duǎn tóufa.",
    ...
    },
    {
      ...
      example: {
        sentence: "你喜歡什麼顏色？",
        romanization: "nǐ xǐhuan shénme yánsè?",
    ...
    },
    {
      ...
      example: {
        ...
        romanization: "hóngsè shì Táiwān rén zuì xǐhuan de yánsè.",
    ...
    },
    {
      ...
      example: {
        sentence: "天空是藍色的。",
        romanization: "tiānkōng shì lánsè de.",
    ...
    },
    {
      ...
      example: {
        sentence: "白色的鞋子很容易髒。",
        romanization: "báisè de xiézi hěn róngyì zāng.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄓㄤˇ", "ㄍㄠ", "ㄔㄨㄢ", "ㄎㄢˋ"],
      hint: "Le verbe utilisé dans la structure de description physique : ...得很...",
      hintReading: "Le verbe utilisé dans la structure de description physique : ...得很...",
    },
    {
      id: "unit-81-ex3",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄊㄧㄠˊ", "ㄐㄧㄢˋ", "ㄕㄨㄤ", "ㄉㄧㄥˇ"],
    },
    {
      id: "unit-81-ex5",
      type: "fill-blank",
      ...
      optionsReading: ["ㄏㄨㄥˊ", "ㄌㄢˊ", "ㄅㄞˊ", "ㄏㄟ"],
      hint: "La couleur porte-bonheur en Chine et à Taiwan.",
      hintReading: "La couleur porte-bonheur en Chine et à Taiwan.",
    },
    {
      id: "unit-81-ex6",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄕㄨㄤ", "ㄐㄧㄢˋ", "ㄊㄧㄠˊ", "ㄉㄧㄥˇ"],
      hint: "Le classificateur pour les objets qui vont par deux (chaussures, gants...).",
      hintReading: "Le classificateur pour les objets qui vont par deux (chaussures, gants...).",
    },
  ],
