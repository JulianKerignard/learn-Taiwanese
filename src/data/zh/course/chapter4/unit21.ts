...
export const unit21: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我不想去了",
          romanization: "wǒ bù xiǎng qù le",
        ...
        },
        {
          type: "example",
          native: "春天到了，花開了",
          romanization: "chūntiān dào le, huā kāi le",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "太晚了，我要回家了",
          romanization: "tài wǎn le, wǒ yào huíjiā le",
        ...
        },
        {
          type: "example",
          native: "太遠了，我們坐計程車吧",
          romanization: "tài yuǎn le, wǒmen zuò jìchéngchē ba",
        ...
        },
        {
          type: "example",
          native: "台灣的珍珠奶茶太好喝了",
          romanization: "Táiwān de zhēnzhū nǎichá tài hǎohē le",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我吃了三碗飯了",
          romanization: "wǒ chī le sān wǎn fàn le",
        ...
        },
        {
          type: "example",
          native: "我等了你半個小時了",
          romanization: "wǒ děng le nǐ bàn ge xiǎoshí le",
        ...
        },
        {
          type: "example",
          native: "他們結婚了十年了",
          romanization: "tāmen jiéhūn le shí nián le",
        ...
        {
          type: "example",
          native: "我學了三個月 vs 我學了三個月了",
          romanization: "wǒ xué le sān ge yuè vs wǒ xué le sān ge yuè le",
          translation:
    ...
    lines: [
      {
        speaker: "小美",
        native: "Paul，你來台灣多久了？",
        romanization: "Paul, nǐ lái Táiwān duōjiǔ le?",
        french: "Paul, ça fait combien de temps que tu es à Taiwan ?",
        note: "多久了 = depuis combien de temps (了₂ = situation en cours).",
      },
      {
        speaker: "Paul",
        native: "我來了五個月了。很多事情都變了！",
        romanization: "wǒ lái le wǔ ge yuè le. hěn duō shìqíng dōu biàn le!",
        french:
      ...
      },
      {
        speaker: "小美",
        native: "是嗎？什麼變了？",
        romanization: "shì ma? shénme biàn le?",
        french: "Ah bon ? Qu'est-ce qui a changé ?",
      },
      {
        speaker: "Paul",
        native: "我越來越喜歡台灣的食物了，現在太辣的我也敢吃了！",
        romanization:
      ...
      {
        speaker: "Paul",
        native: "謝謝！可是我不習慣台灣的天氣，太熱了！",
        romanization: "xièxie! kěshì wǒ bù xíguàn Táiwān de tiānqì, tài rè le!",
        french:
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "天氣變冷了。",
        romanization: "tiānqì biàn lěng le.",
    ...
    },
    {
      ...
      example: {
        sentence: "他改變了想法。",
        romanization: "tā gǎibiàn le xiǎngfǎ.",
        translation: "Il a changé d'avis.",
      },
    },
    {
      term: "越來越",
      romanization: "yuèláiyuè",
      reading: "ㄩㄝˋ ㄌㄞˊ ㄩㄝˋ",
      french: "De plus en plus",
      english: "More and more",
      example: {
        sentence: "天氣越來越熱了。",
        romanization: "tiānqì yuèláiyuè rè le.",
    ...
    },
    {
      ...
      example: {
        sentence: "我不再遲到了。",
        romanization: "wǒ bú zài chídào le.",
    ...
    },
    {
      ...
      example: {
        sentence: "開始上課了。",
        romanization: "kāishǐ shàngkè le.",
    ...
    },
    {
      ...
      example: {
        sentence: "電影結束了。",
        romanization: "diànyǐng jiéshù le.",
    ...
    },
    {
      ...
      example: {
        sentence: "突然下雨了。",
        romanization: "tūrán xiàyǔ le.",
        translation: "Il s'est soudain mis à pleuvoir.",
      },
    },
    {
      term: "漸漸",
      romanization: "jiànjiàn",
      reading: "ㄐㄧㄢˋ ㄐㄧㄢˋ",
      french: "Progressivement, petit à petit",
      english: "Gradually",
      example: {
        sentence: "我漸漸習慣了。",
        romanization: "wǒ jiànjiàn xíguàn le.",
    ...
    },
    {
      ...
      example: {
        sentence: "他十點才來。",
        romanization: "tā shí diǎn cái lái.",
    ...
    },
    {
      ...
      example: {
        sentence: "我吃了飯就去。",
        romanization: "wǒ chī le fàn jiù qù.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄌㄜ˙", "ㄍㄨㄛˋ", "ㄏㄨㄟˋ", "ㄉㄜ˙"],
      hint: "Quelle particule signale un changement de situation ?",
      hintReading: "Quelle particule signale un changement de situation ?",
    },
    {
      id: "unit-21-ex3",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄌㄚˋ", "ㄌㄚˋ ㄌㄜ˙", "ㄏㄣˇ ㄌㄚˋ", "ㄏㄠˇ ㄌㄚˋ"],
      hint: "Structure 太 + adjectif + 了. Quel mot va entre 太 et 了 ?",
      hintReading: "Structure ㄊㄞˋ + adjectif + ㄌㄜ˙. Quel mot va entre ㄊㄞˋ et ㄌㄜ˙ ?",
    },
    {
      id: "unit-21-ex6",
      type: "translate",
      ...
      optionsReading: ["ㄨㄛˇ ㄗㄞˋ ㄊㄞˊ ㄨㄢ ㄓㄨˋ ㄌㄜ˙ ㄌㄧㄤˇ ㄋㄧㄢˊ ㄌㄜ˙", "ㄨㄛˇ ㄗㄞˋ ㄊㄞˊ ㄨㄢ ㄓㄨˋ ㄌㄜ˙ ㄌㄧㄤˇ ㄋㄧㄢˊ", "ㄨㄛˇ ㄗㄞˋ ㄊㄞˊ ㄨㄢ ㄓㄨˋ ㄍㄨㄛˋ ㄌㄧㄤˇ ㄋㄧㄢˊ", "ㄨㄛˇ ㄏㄨㄟˋ ㄗㄞˋ ㄊㄞˊ ㄨㄢ ㄓㄨˋ ㄌㄧㄤˇ ㄋㄧㄢˊ"],
      hint: "Double 了 pour indiquer une durée toujours en cours.",
      hintReading: "Double ㄌㄜ˙ pour indiquer une durée toujours en cours.",
    },
    {
      id: "unit-21-ex7",
      type: "comprehension",
    ...
    },
    {
      ...
      optionsReading: ["ㄊㄧㄢ ㄑㄧˋ", "ㄩㄝˋ ㄌㄞˊ ㄩㄝˋ", "ㄌㄥˇ", "ㄌㄜ˙"],
      hint: "Structure : Sujet + 越來越 + Adjectif + 了",
      hintReading: "Structure : Sujet + ㄩㄝˋ ㄌㄞˊ ㄩㄝˋ + Adjectif + ㄌㄜ˙",
    },
    {
      id: "unit-21-ex10",
      type: "reorder",
      ...
      optionsReading: ["ㄨㄛˇ", "ㄅㄨˋ", "ㄒㄧㄤˇ", "ㄑㄩˋ", "ㄌㄜ˙"],
      hint: "Structure : Sujet + 不 + Verbe + 了 (ne plus vouloir)",
      hintReading: "Structure : Sujet + ㄅㄨˋ + Verbe + ㄌㄜ˙ (ne plus vouloir)",
    },
  ],
