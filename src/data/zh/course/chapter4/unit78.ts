...
export const unit78: CourseUnit = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "我在蝦皮下單了一個東西。",
          romanization: "wǒ zài xiāpí xiàdān le yí gè dōngxi.",
        ...
        },
        {
          type: "example",
          native: "運費多少？有免運嗎？",
          romanization: "yùnfèi duōshǎo? yǒu miǎnyùn ma?",
        ...
        },
        {
          type: "example",
          native: "我選超商取貨，比較方便。",
          romanization: "wǒ xuǎn chāoshāng qǔhuò, bǐjiào fāngbiàn.",
        ...
        },
        {
          type: "example",
          native: "你的訂單已經寄出了。",
          romanization: "nǐ de dìngdān yǐjīng jìchū le.",
        ...
        },
        {
          type: "example",
          native: "請問怎麼付款？",
          romanization: "qǐngwèn zěnme fùkuǎn?",
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: "example",
          native: "這個東西的評價很好，我想買。",
          romanization: "zhège dōngxi de píngjià hěn hǎo, wǒ xiǎng mǎi.",
        ...
        },
        {
          type: "example",
          native: "今天有折扣，打八折！",
          romanization: "jīntiān yǒu zhékòu, dǎ bā zhé!",
        ...
        {
          type: "example",
          native: "我有一張優惠券，可以折五十元。",
          romanization: "wǒ yǒu yì zhāng yōuhuìquàn, kěyǐ zhé wǔshí yuán.",
        ...
        },
        {
          type: "example",
          native: "雙十一的時候東西都很便宜。",
          romanization: "shuāng shíyī de shíhòu dōngxi dōu hěn piányi.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: "example",
          native: "這個東西壞了，我要退貨。",
          romanization: "zhège dōngxi huài le, wǒ yào tuìhuò.",
        ...
        },
        {
          type: "example",
          native: "尺寸不對，可以換貨嗎？",
          romanization: "chǐcùn búduì, kěyǐ huànhuò ma?",
        ...
        },
        {
          type: "example",
          native: "我想聯繫客服，怎麼辦？",
          romanization: "wǒ xiǎng liánxì kèfú, zěnme bàn?",
        ...
        },
        {
          type: "example",
          native: "我還沒收貨，包裹在哪裡？",
          romanization: "wǒ hái méi shōuhuò, bāoguǒ zài nǎlǐ?",
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "你",
        native: "小美，我在蝦皮買了一件衣服，可是尺寸不對。",
        romanization: "Xiǎo Měi, wǒ zài xiāpí mǎi le yí jiàn yīfu, kěshì chǐcùn búduì.",
        french: "Xiao Mei, j'ai acheté un vêtement sur Shopee, mais la taille n'est pas bonne.",
      },
      {
        speaker: "小美",
        native: "那你可以退貨或換貨啊，你看一下評價怎麼說。",
        romanization: "nà nǐ kěyǐ tuìhuò huò huànhuò a, nǐ kàn yíxià píngjià zěnme shuō.",
      ...
      {
        speaker: "你",
        native: "評價都說尺寸偏小，我應該早點看的。",
        romanization: "píngjià dōu shuō chǐcùn piān xiǎo, wǒ yīnggāi zǎodiǎn kàn de.",
      ...
      {
        speaker: "小美",
        native: "你先聯繫客服，再申請退貨，很簡單的。",
        romanization: "nǐ xiān liánxì kèfú, zài shēnqǐng tuìhuò, hěn jiǎndān de.",
      ...
      },
      {
        speaker: "你",
        native: "好，運費要自己付嗎？",
        romanization: "hǎo, yùnfèi yào zìjǐ fù ma?",
        french: "D'accord, est-ce que les frais de port sont à ma charge ?",
      },
      {
        speaker: "小美",
        native: "如果是賣家的問題，運費免費。下次記得用優惠券，還可以省錢！",
        romanization: "rúguǒ shì màijiā de wèntí, yùnfèi miǎnfèi. xiàcì jìde yòng yōuhuìquàn, hái kěyǐ shěng qián!",
  ...
  vocabulary: [
    {
      ...
      example: {
        sentence: "我已經下單了。",
        romanization: "wǒ yǐjīng xiàdān le.",
    ...
    },
    {
      ...
      example: {
        sentence: "請選擇付款方式。",
        romanization: "qǐng xuǎnzé fùkuǎn fāngshì.",
        translation: "Veuillez choisir un mode de paiement.",
      },
    },
    {
      term: "訂單",
      romanization: "dìngdān",
      reading: "ㄉㄧㄥˋ ㄉㄢ",
      french: "Commande, bon de commande",
      english: "Order",
      example: {
        sentence: "你的訂單已經送出了。",
        romanization: "nǐ de dìngdān yǐjīng sòngchū le.",
    ...
    },
    {
      ...
      example: {
        sentence: "今天有折扣嗎？",
        romanization: "jīntiān yǒu zhékòu ma?",
    ...
    },
    {
      ...
      example: {
        sentence: "這個很優惠，快買！",
        romanization: "zhège hěn yōuhuì, kuài mǎi!",
        translation: "C'est une bonne affaire, achète vite !",
      },
    },
    {
      term: "購物車",
      romanization: "gòuwùchē",
      reading: "ㄍㄡˋ ㄨˋ ㄔㄜ",
      french: "Panier (en ligne)",
      english: "Shopping cart",
      example: {
        sentence: "我先放進購物車。",
        romanization: "wǒ xiān fàng jìn gòuwùchē.",
    ...
    },
    {
      ...
      example: {
        sentence: "這件衣服的尺寸是M號。",
        romanization: "zhè jiàn yīfu de chǐcùn shì M hào.",
    ...
    },
    {
      ...
      example: {
        sentence: "包裹已經寄出了。",
        romanization: "bāoguǒ yǐjīng jìchū le.",
  ...
  exercises: [
    ...
    },
    {
      ...
      optionsReading: ["ㄒㄧㄚˋ ㄉㄢ", "ㄈㄨˋ ㄎㄨㄢˇ", "ㄊㄨㄟˋ ㄏㄨㄛˋ", "ㄕㄡ ㄏㄨㄛˋ"],
      hint: "Quelle action correspond à « passer commande » ?",
      hintReading: "Quelle action correspond à « passer commande » ?",
    },
    {
      id: "unit-78-ex3",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄆㄧㄥˊ ㄐㄧㄚˋ", "ㄓㄜˊ ㄎㄡˋ", "ㄩㄣˋ ㄈㄟˋ", "ㄔˇ ㄘㄨㄣˋ"],
      hint: "Les commentaires et notes des acheteurs.",
      hintReading: "Les commentaires et notes des acheteurs.",
    },
    {
      id: "unit-78-ex6",
      type: "translate",
    ...
    },
    {
      ...
      optionsReading: ["ㄎㄜˋ ㄈㄨˊ", "ㄇㄞˋ ㄐㄧㄚ", "ㄩㄣˋ ㄈㄟˋ", "ㄍㄡˋ ㄨˋ ㄔㄜ"],
      hint: "Le département qui aide les clients en cas de problème.",
      hintReading: "Le département qui aide les clients en cas de problème.",
    },
  ],
