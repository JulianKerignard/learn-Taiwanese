...
/**
 * One themed lesson. The lesson itself arrives as a prop: the page above is a
 * server component precisely so that no lesson module reaches the browser
 * bundle — see src/data/server.ts.
 */
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="chinese text-lg text-stone-500" lang={language.contentLang}>
              {lesson.titleNative}
            </p>
          ...
          {lesson.phrases.map((phrase) => (
            <div key={phrase.native} className="card flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="chinese text-2xl font-medium text-stone-800" lang={language.contentLang}>
                  {phrase.native}
                </p>
